...
<datasource-configuration xmlns:this="http://xmlns.opennms.org/xsd/config/opennms-datasources"
  ...
  <jdbc-data-source name="opennms"
                    ...
                    url="jdbc:postgresql://{{getv "/postgres/host" "database"}}:{{getv "/postgres/port" "5432"}}/{{getv "/opennms/dbname" "opennms"}}?sslmode={{getv "/postgres/ssl/mode" "disable"}}&amp;sslfactory={{getv "/postgres/ssl/factory" "org.postgresql.ssl.NonValidatingFactory"}}"
  ...
  <jdbc-data-source name="opennms-admin"
                    ...
                    class-name="org.postgresql.Driver"
                    url="jdbc:postgresql://{{getv "/postgres/host" "database"}}:{{getv "/postgres/port" "5432"}}/template1?sslmode={{getv "/postgres/ssl/mode" "disable"}}&amp;sslfactory={{getv "/postgres/ssl/factory" "org.postgresql.ssl.NonValidatingFactory"}}"
  ...
  <jdbc-data-source name="opennms-monitor"
                    ...
                    class-name="org.postgresql.Driver"
                    url="jdbc:postgresql://{{getv "/postgres/host" "database"}}:{{getv "/postgres/port" "5432"}}/postgres?sslmode={{getv "/postgres/ssl/mode" "disable"}}&amp;sslfactory={{getv "/postgres/ssl/factory" "org.postgresql.ssl.NonValidatingFactory"}}"
                    user-name="{{getv "/postgres/user" "postgres"}}"
                    password="{{getv "/postgres/password" "postgres"}}">
    <connection-pool idleTimeout="{{getv "/opennms/database/connection/idletimeout" "600"}}"
                     minPool="{{getv "/opennms/database/connection/minpool" "0"}}"
