...
public class FeaturesBootKarafIT extends OnmsKarafTestCase {
	...
	public void testInstallAllOpenNMSFeatures() {
		addFeaturesUrl(maven().groupId("org.opennms.container").artifactId("org.opennms.container.karaf").version("2017.1.20").type("xml").classifier("features").getURL());
		addFeaturesUrl(maven().groupId("org.opennms.karaf").artifactId("opennms").version("2017.1.20").type("xml").classifier("features").getURL());
