        ...
        return Arrays.asList(new Object[][] {
                {
                    ...
                    "<northbound-alarm xmlns=\"http://xmlns.opennms.org/xsd/alarms\" id=\"1\">\n" +
                     ...
                     "<ack-time>" + getLocalDateString(1) + "</ack-time>\n" +
                     ...
                     "<first-occurrence>" + getLocalDateString(2) + "</first-occurrence>\n" +
                     "<ip-address>127.0.0.127</ip-address>\n" +
                     "<last-occurrence>" + getLocalDateString(4) + "</last-occurrence>\n" +
                     ...
                     "<suppressed>" + getLocalDateString(5) + "</suppressed>\n" +
                     "<suppressed-until>" + getLocalDateString(6) + "</suppressed-until>\n" +
