 ...
 */
public class EmailNorthbounderConfigDao extends AbstractJaxbConfigDao<EmailTrapNorthbounderConfig, EmailTrapNorthbounderConfig> {
    ...
    public EmailNorthbounderConfigDao() {
        super(EmailTrapNorthbounderConfig.class, "Config for E-mail Northbounder");
    }
     ...
     */
    @Override
    protected EmailTrapNorthbounderConfig translateConfig(EmailTrapNorthbounderConfig config) {
        return config;
    }
