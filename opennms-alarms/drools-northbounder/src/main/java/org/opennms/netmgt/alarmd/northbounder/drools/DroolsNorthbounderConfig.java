 ...
 */
@XmlRootElement(name = "drools-northbounder-config")
@XmlAccessorType(XmlAccessType.FIELD)
public class DroolsNorthbounderConfig implements Serializable {
    ...
    private List<DroolsEngine> m_engines = new ArrayList<DroolsEngine>();
     ...
     * @return the Engines
     */
    public List<DroolsEngine> getEngines() {
        return m_engines;
    }
     ...
     */
    public void setEngines(List<DroolsEngine> engines) {
        m_engines = engines;
    }
     ...
     */
    public DroolsEngine getEngine(String engineName) {
