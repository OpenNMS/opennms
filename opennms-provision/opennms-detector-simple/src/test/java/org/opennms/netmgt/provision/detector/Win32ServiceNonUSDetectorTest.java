...
@JUnitSnmpAgent(host = Win32ServiceNonUSDetectorTest.TEST_IP_ADDRESS, resource = "classpath:/org/opennms/netmgt/provision/detector/non-us-windows.properties")
public class Win32ServiceNonUSDetectorTest implements InitializingBean {
    static final String TEST_IP_ADDRESS = "10.106.181.161";
    ...
    @Test(timeout = 20000)
    public void testNonUS() throws UnknownHostException {
        m_detector.setWin32ServiceName("Virtueller Datenträger");
