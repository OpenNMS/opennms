...
public class OmsaStorageDetectorTest {
    ...
    @Test
    @JUnitSnmpAgent(resource="classpath:org/opennms/netmgt/provision/detector/omsaStorageDetector.properties", host=TEST_IP_ADDRESS, port=TEST_PORT, useMockSnmpStrategy=true)
