...
public class BaseDetectorHandler<Request, Response> {
    ...
    private DetectFutureNettyImpl m_future;
     ...
     */
    public void setFuture(DetectFutureNettyImpl future) {
        m_future = future;
    }
     ...
     */
    public DetectFutureNettyImpl getFuture() {
        return m_future;
    }

    public static class SomeSession {
    ...
    public void sessionOpened(SomeSession session) throws Exception {
