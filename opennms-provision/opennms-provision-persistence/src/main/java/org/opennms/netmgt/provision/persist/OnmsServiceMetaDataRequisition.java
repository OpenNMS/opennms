...
public class OnmsServiceMetaDataRequisition {

    private RequisitionMetaData metaData;

    public OnmsServiceMetaDataRequisition(RequisitionMetaData metaData) {
    ...
    public void visit(RequisitionVisitor visitor) {
        visitor.visitServiceMetaData(this);
        visitor.completeServiceMetaData(this);
    }
