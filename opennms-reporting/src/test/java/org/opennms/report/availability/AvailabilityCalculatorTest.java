...
public class AvailabilityCalculatorTest extends TestCase {
    ...
    private Report buildReport(Calendar calendar, String calFormat){
        ...
        try {
            ...
            calculator.setStartDate("18");
            calculator.setStartMonth("04");
            calculator.setStartYear("2005");
...
//      assertEquals("outages DB count", 3, m_db.countRows("select * from outages"));
        assertEquals("ip interface DB count where ipaddr = 192.168.100.1", 1, m_db.countRows("select * from ipinterface where ipaddr = '192.168.100.1'"));
    ...
    public void testBuiltCalendarReport () {
        ...
        assertTrue("day 0,5 visiblity", day.getVisible());
