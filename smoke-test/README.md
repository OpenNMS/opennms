...
Locate the target path of the .jar: `/opt/opennms/lib/opennms-services-2020.1.8-SNAPSHOT.jar`
...
mkdir -p $TARGET_PATH
cp target/opennms-services-2020.1.8-SNAPSHOT.jar $TARGET_PATH/lib
```
