...
public class EventSinkIT {
    ...
    private boolean sendEventFromMinion() {
        try (final SshClient sshClient = stack.minion().ssh()) {
            ...
            pipe.println("opennms-events:send -u 'uei.opennms.org/alarms/trigger'");
            pipe.println("logout");
