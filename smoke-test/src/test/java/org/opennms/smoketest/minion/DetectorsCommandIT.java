 ...
 * of the 'opennms-provision:list-detectors' command issued in the Karaf shell.
 *
...
public class DetectorsCommandIT {
    ...
    public List<String> listAndVerifyDetectors(String host, InetSocketAddress sshAddr) throws Exception {
        ...
        try (final SshClient sshClient = new SshClient(sshAddr, "admin", "admin")) {
            ...
            pipe.println("opennms-provision:list-detectors");
            pipe.println("logout");
            ...
            shellOutput = StringUtils.substringAfter(shellOutput, "opennms-provision:list-detectors");
