...
public class KafkaProducerLocalTest {
    ...
    public void checkForDocker() {
        final InetSocketAddress opennmsHttp = InetSocketAddress.createUnresolved("127.0.0.1", 8980);
        restClient = new RestClient(opennmsHttp);
        opennmsKarafSshAddr = InetSocketAddress.createUnresolved("127.0.0.1", 8101);
    }
