...
public class MinionHealthCheckIT extends AbstractHealthCheckIT {

    @Override
    protected void applyTestEnvironment(TestEnvironmentBuilder builder) {
        builder.opennms().minion();
    }

    @Override
    public InetSocketAddress getSshAddress() {
        return testEnvironment.getServiceAddress(NewTestEnvironment.ContainerAlias.MINION, 8201);
    }
