...
public class OpenNMSHealthCheckIT extends AbstractHealthCheckIT {
    ...
    public InetSocketAddress getSshAddress() {
        return testEnvironment.getServiceAddress(NewTestEnvironment.ContainerAlias.OPENNMS, 8101);
    }
