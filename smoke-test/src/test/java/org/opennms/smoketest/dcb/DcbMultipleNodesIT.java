...
public class DcbMultipleNodesIT {
    ...
    private static final OpenNMSProfile OPENNMS_PROFILE = OpenNMSProfile.newBuilder()
            ...
            .withFile("device-config/SmokeTests.xml", "etc/foreign-sources/pending/SmokeTests.xml")
            .build();
    ...
    public static void setupClass() throws Exception {
        ...
        // TODO make a loop for creation of at least 1000 nodes
        for (int i = 1; i < 101; i++) {
        ...
        localNode = await()
                ...
                .until(DaoUtils.findMatchingCallable(nodeDao, new CriteriaBuilder(OnmsNode.class).eq("foreignId", "local_1").toCriteria()), notNullValue());
    ...
    public void testGetConfigOnSchedule() throws Exception {
        ...
        Assert.assertEquals(restClient.getBackups().size(), 100);
    }
}
