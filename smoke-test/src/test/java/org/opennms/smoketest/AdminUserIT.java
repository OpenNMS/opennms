...
public class AdminUserIT extends OpenNMSSeleniumIT {

    private static final Logger LOG = LoggerFactory.getLogger(AdminUserIT.class);
    ...
    public void testChangeAdminPassword() throws Exception {
        ...
        wait.until(ExpectedConditions.urlContains("newPasswordAction"));
