...
public class GraphRestServiceIT extends OpenNMSSeleniumIT {
    ...
    public void verifyContainerListInfos() {
        ...
        given().accept(ContentType.JSON).get()
                ...
                .body("[2].graphs.size()", Matchers.is(9))
                ...
                .body("[2].graphs[7].namespace", Matchers.is("nodes:Ospf"))
                .body("[2].graphs[8].namespace", Matchers.is("nodes:UserDefined"))
                .body("[2].graphs[8].label", Matchers.is("UserDefined"))
                .body("[2].graphs[8].description", Matchers.is("This Topology Provider displays the User Defined topology information."))
