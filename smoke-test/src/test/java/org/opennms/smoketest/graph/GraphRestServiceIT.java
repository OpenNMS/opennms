...
public class GraphRestServiceIT extends OpenNMSSeleniumIT {
    ...
    public void verifyContainerListInfos() {
        ...
        given().accept(ContentType.JSON).get()
                ...
                .body("[1].id", Matchers.is("enlinkd"))
                .body("[1].label", Matchers.is("Enlinkd Graphs"))
                .body("[1].graphs.size()", Matchers.is(11))
                .body("[1].graphs[0].namespace", Matchers.is("nodes"))
                .body("[1].graphs[0].label", Matchers.is("All"))
                .body("[1].graphs[0].description", Matchers.is("This Topology Provider displays the topology information discovered by the Enhanced Linkd daemon. It uses the SNMP information of several protocols like OSPF, ISIS, LLDP and CDP to generate an overall topology."))
                .body("[1].graphs[1].namespace", Matchers.is("nodes:Bridge"))
                .body("[1].graphs[1].label", Matchers.is("Bridge"))
                .body("[1].graphs[1].description", Matchers.is("This Topology Provider displays the Bridge topology information discovered by Enhanced Linkd daemon."))
                .body("[1].graphs[2].namespace", Matchers.is("nodes:Cdp"))
                .body("[1].graphs[2].label", Matchers.is("Cdp"))
                .body("[1].graphs[2].description", Matchers.is("This Topology Provider displays the Cisco Discovery Protocol topology information discovered by the Enhanced Linkd daemon."))
                .body("[1].graphs[3].namespace", Matchers.is("nodes:Isis"))
                .body("[1].graphs[4].namespace", Matchers.is("nodes:Layer2"))
                .body("[1].graphs[5].namespace", Matchers.is("nodes:Layer3"))
                .body("[1].graphs[6].namespace", Matchers.is("nodes:Lldp"))
                .body("[1].graphs[7].namespace", Matchers.is("nodes:NetworkRouter"))
                .body("[1].graphs[8].namespace", Matchers.is("nodes:Ospf"))
                .body("[1].graphs[9].namespace", Matchers.is("nodes:OspfArea"))
                .body("[1].graphs[10].namespace", Matchers.is("nodes:UserDefined"))
                .body("[1].graphs[10].label", Matchers.is("UserDefined"))
                .body("[1].graphs[10].description", Matchers.is("This Topology Provider displays the User Defined topology information."))

                .body("[2].id", Matchers.is(CONTAINER_ID))
                .body("[2].label", Matchers.is("GraphML Topology Provider (test-graph)"))
                .body("[2].graphs.size()", Matchers.is(2))
                .body("[2].graphs[0].namespace", Matchers.is("acme:markets"))
                .body("[2].graphs[0].label", Matchers.is("Markets"))
                .body("[2].graphs[0].description", Matchers.is("The Markets Layer"))
                .body("[2].graphs[1].namespace", Matchers.is("acme:regions"))

                .body("[3].id", Matchers.is("vmware"))
                .body("[3].label", Matchers.is("VMware Topology Provider"))
                .body("[3].graphs.size()", Matchers.is(1))
                .body("[3].graphs[0].namespace", Matchers.is("vmware"))
                .body("[3].graphs[0].label", Matchers.is("VMware Topology Provider"))
                .body("[3].graphs[0].description", Matchers.is("The VMware Topology Provider displays the infrastructure information gathered by the VMware Provisioning process."))
                ;
    }
