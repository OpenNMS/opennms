...
public class FileEditorIT {
    ...
    /**
     * Test that the File Editor will deny file that is not in the correct format
     */
    @Test
    ...
    /**
     * Test that the File Editor will deny changes that are not in the correct format
     */
    @Test
