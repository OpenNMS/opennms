...
public class FlowElasticSearchIndexIT {

    private final static Logger LOG = LoggerFactory.getLogger(FlowElasticSearchIndexIT.class);
    private final static int NETFLOW5_LISTENER_UDP_PORT = 8877;
    ...
    public void verifyFlowStack() throws Exception {
        ...
        final InetSocketAddress opennmsWebAddress = new InetSocketAddress("127.0.0.1", 8980);

        final InetSocketAddress opennmsNetflow5AdapterAddress = new InetSocketAddress("127.0.0.1", NETFLOW5_LISTENER_UDP_PORT);
        final InetSocketAddress elasticRestAddress = new InetSocketAddress("127.0.0.1", 9200);
        final String elasticRestUrl = String.format("http://%s:%d", "127.0.0.1", elasticRestAddress.getPort());
    ...
    public void main(String[] args) throws Exception {
        new FlowElasticSearchIndexIT().verifyFlowStack();
    }
}
