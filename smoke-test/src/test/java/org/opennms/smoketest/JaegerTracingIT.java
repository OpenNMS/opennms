...
public class JaegerTracingIT {
    ...
    public static OpenNMSStack stack = OpenNMSStack.withModel(StackModel.newBuilder()
            .withOpenNMS(OpenNMSProfile.newBuilder()
                    .withFile("jaeger/jaeger.boot", "etc/featuresBoot.d/jaeger.boot")
                    .withFile("jaeger/jaeger.properties", "etc/opennms.properties.d/jaeger.properties")
                    .build())
            .build());

    @Test
    public void jaegerTracingInit() throws Exception {
