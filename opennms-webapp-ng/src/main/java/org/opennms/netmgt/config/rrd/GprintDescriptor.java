 ...
 * Schema.
 * $Id: GprintDescriptor.java,v 1.2 2005/11/03 20:43:58 brozow Exp $
 */
...
public class GprintDescriptor extends GraphGprintDescriptor {
    ...
    public GprintDescriptor() 
     {
        ...
        xmlName = "gprint";
    } //-- org.opennms.netmgt.config.rrd.GprintDescriptor()
    ...
    {
        return org.opennms.netmgt.config.rrd.Gprint.class;
