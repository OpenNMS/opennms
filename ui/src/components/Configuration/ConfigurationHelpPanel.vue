...
const helpText = computed(() => {
  ...
  let helpVals = {
    title: 'Requisition',
    subTitle: 'A requisition enables periodic inventory synchronization from external sources. Each definition contains a URL, schedule, and setting to specify the nodes to rescan.',
  ...
  if (typeName === RequisitionTypes.File) {
    ...
    helpVals = {
      ...
      subTitle: 'The VMware adapter pulls hosts and/or virtual machines from a vCenter server into OpenNMS. With this adapter, you can automatically add, update, or remove nodes from your inventory based on the status of the VMware entity.',
      help: 'See the online documentation for detailed information on supported options:',
      linkCopy: 'READ FULL ARTICLE',
    ...
    helpVals = {
      title: 'HTTP(S)',
      subTitle: 'The HTTP(S) handler imports a properly formatted requisition definition from an XML file stored on or generated by a web server.',
      help: 'See the online documentation for detailed information on supported options:',
      linkCopy: 'READ FULL ARTICLE',
