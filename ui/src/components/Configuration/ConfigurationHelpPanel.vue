...
const helpText = computed(() => {
  ...
  if (typeName === RequisitionTypes.File) {
    ...
    helpVals = {
      title: 'HTTP(S)',
      subTitle: 'The HTTP(S) handler imports a properly formatted requisition definition from an XML file stored on or generated by a web server. Requires the host and /path parameters to construct the URL OpenNMS uses to locate this external source.',
      help: 'See the online documentation for detailed information on supported options:',
      linkCopy: 'READ FULL ARTICLE',
