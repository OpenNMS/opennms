  ...
  if (typeName === RequisitionTypes.File) {
    ...
    if (subType === '') {
      helpVals = {
        ...
        subTitle: 'OpenNMS provides plugins that can provision nodes from specific platforms, including OpenDaylight, Cisco APIC, AzureIoT, and Zabbix.',
        help: 'See the online documentation for detailed information on supported options:',
        linkCopy: 'READ FULL ARTICLE',
        link: 'https://docs.opennms.com/horizon/29/reference/provisioning/handlers/introduction.html'
      }
      ...
      helpVals = {
        title: 'OpenDaylight',
        subTitle: 'The OpenDaylight handler imports a properly formatted requisition generated by the OpenNMS OpenDaylight plugin. The plugin enables OpenNMS to monitor devices and networks OpenDaylight controllers manage and import inventory from the operational topology.',
        help: 'See the online documentation for detailed information on supported options:',
        linkCopy: 'READ FULL ARTICLE',
        link: 'https://docs.opennms.com/horizon/29/reference/provisioning/handlers/introduction.html'
      }
      ...
      helpVals = {
        title: 'ACI',
        subTitle: 'The ACI handler imports a properly formatted requisition generated by the OpenMMS ACI plugin. The OpenNMS ACI plugin enables OpenNMS to monitor devices and networks Cisco APIC controllers manage and import inventory from the operational topology.',
        help: 'See the online documentation for detailed information on supported options:',
        linkCopy: 'READ FULL ARTICLE',
        link: 'https://docs.opennms.com/horizon/29/reference/provisioning/handlers/introduction.html'
      }
      ...
      helpVals = {
        title: 'Zabbix',
        subTitle: 'The Zabbix handler imports a properly formatted requisition generated by the OpenNMS Zabbix plugin. The Zabbix plugin lets OpenNMS integrate with the Zabbix agent and use Zabbix templates to collect requisition data.',
        help: 'See the online documentation for detailed information on supported options:',
        linkCopy: 'READ FULL ARTICLE',
        link: 'https://docs.opennms.com/horizon/29/reference/provisioning/handlers/introduction.html'
      }
      ...
      helpVals = {
        title: 'Azure IoT',
        subTitle: 'The Azure IoT handler imports a properly formatted requisition generated by the OpenNMS Azure IoT plugin. The Azure IoT plugin can build a requisition from all devices in an IoT hub.',
        help: 'See the online documentation for detailed information on supported options:',
        linkCopy: 'READ FULL ARTICLE',
        link: 'https://docs.opennms.com/horizon/29/reference/provisioning/handlers/introduction.html'
      }
      ...
      helpVals = {
        title: 'PRIS',
        subTitle: 'The Provisioning Integration Server (PRIS) is a tool that helps you get external information from your inventory into an OpenNMS requisition model. The output from PRIS is provided as XML over HTTP. The PRIS handler imports a properly formatted requisition generated by PRIS.',
        help: 'See the online documentation for detailed information on supported options:',
        linkCopy: 'READ FULL ARTICLE',
    ...
    helpVals = {
      title: 'HTTP(S)',
      subTitle: 'The HTTP(S) handler imports a properly-formatted requisition definition from an XML file stored remotely on a web server.',
      help: 'See the online documentation for detailed information on supported options:',
      linkCopy: 'READ FULL ARTICLE',
