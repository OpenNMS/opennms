...
import { ref } from 'vue'
import { firstCharValidator, nameValidator, ipValidator } from '../../Validators/CustomValidators'
...
export default class reqDefModel {
  ...
  get rules() {
    return {
      ...
      type: { required },
      host: {
        required: helpers.withMessage('Please enter host ip address', required),
        ipValidator
      },
      foreignSource: {
