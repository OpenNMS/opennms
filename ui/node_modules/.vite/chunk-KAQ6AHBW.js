...
var _hoisted_6 = { class: "p-dropdown-item-group" };
var _hoisted_7 = {
  key: 2,
          ...
          $data.overlayVisible ? (openBlock(), createBlock("div", {
            ...
            createVNode("div", {
              ...
              createVNode("ul", _hoisted_5, [
                !$props.optionGroupLabel ? (openBlock(true), createBlock(Fragment, { key: 0 }, renderList($options.visibleOptions, (option, i) => {
                ...
                }), 128)) : (openBlock(true), createBlock(Fragment, { key: 1 }, renderList($options.visibleOptions, (optionGroup, i) => {
                ...
                $data.filterValue && (!$options.visibleOptions || $options.visibleOptions && $options.visibleOptions.length === 0) ? (openBlock(), createBlock("li", _hoisted_7, [
                  renderSlot(_ctx.$slots, "emptyfilter", {}, () => [
                    createTextVNode(toDisplayString($options.emptyFilterMessageText), 1)
                  ])
                ])) : !$props.options || $props.options && $props.options.length === 0 ? (openBlock(), createBlock("li", _hoisted_8, [
...
var dropdown_esm_default = script;

export {
  overlayeventbus_esm_default,
  dropdown_esm_default
};
//# sourceMappingURL=chunk-KAQ6AHBW.js.map
