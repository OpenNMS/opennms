...
var script$8 = {
  ...
  computed: {
    text() {
      let text = this.template.replace("{currentPage}", this.page + 1).replace("{totalPages}", this.pageCount).replace("{first}", this.first + 1).replace("{last}", Math.min(this.first + this.rows, this.totalRecords)).replace("{rows}", this.rows).replace("{totalRecords}", this.totalRecords);
      return text;
    }
  }
};
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return ($props.alwaysShow ? true : $options.pageLinks && $options.pageLinks.length > 1) ? (openBlock(), createBlock("div", _hoisted_1, [
    _ctx.$slots.left ? (openBlock(), createBlock("div", _hoisted_2, [
    ...
    (openBlock(true), createBlock(Fragment, null, renderList($options.templateItems, (item) => {
      return openBlock(), createBlock(Fragment, { key: item }, [
        ...
        }, null, 8, ["template", "page", "pageCount", "first", "rows", "totalRecords"])) : item === "RowsPerPageDropdown" && $props.rowsPerPageOptions ? (openBlock(), createBlock(_component_RowsPerPageDropdown, {
          key: 6,
          rows: $data.d_rows,
          options: $props.rowsPerPageOptions,
          onRowsChange: _cache[6] || (_cache[6] = ($event) => $options.onRowChange($event))
        }, null, 8, ["rows", "options"])) : item === "JumpToPageDropdown" ? (openBlock(), createBlock(_component_JumpToPageDropdown, {
          key: 7,
          page: $options.page,
          pageCount: $options.pageCount,
          onPageChange: _cache[7] || (_cache[7] = ($event) => $options.changePage($event))
        }, null, 8, ["page", "pageCount"])) : createCommentVNode("", true)
      ], 64);
    }), 128)),
    _ctx.$slots.right ? (openBlock(), createBlock("div", _hoisted_3, [
...
var paginator_esm_default = script;

export {
  paginator_esm_default
};
//# sourceMappingURL=chunk-L237RJIP.js.map
