...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return $options.visible() ? (openBlock(), createBlock("li", {
    key: 0,
      ...
      $props.item.to ? (openBlock(), createBlock(_component_router_link, {
        ...
        default: withCtx(({ navigate, href }) => [
          createVNode("a", {
            ...
            $props.item.icon ? (openBlock(), createBlock("span", {
              key: 0,
              class: $options.iconClass
            }, null, 2)) : createCommentVNode("", true),
            $props.item.label ? (openBlock(), createBlock("span", _hoisted_1$1, toDisplayString($props.item.label), 1)) : createCommentVNode("", true)
          ], 8, ["href", "onClick"])
        ]),
        _: 1
        ...
        $props.item.label ? (openBlock(), createBlock("span", _hoisted_2$1, toDisplayString($props.item.label), 1)) : createCommentVNode("", true)
      ], 8, ["href", "target"]))
...
var _hoisted_2 = createVNode("li", { class: "p-breadcrumb-chevron pi pi-chevron-right" }, null, -1);
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock("nav", _hoisted_1, [
    createVNode("ul", null, [
      ...
      }, null, 8, ["item", "template"])) : createCommentVNode("", true),
...
var breadcrumb_esm_default = script;

// dep:primevue_breadcrumb
var primevue_breadcrumb_default = breadcrumb_esm_default;
export {
