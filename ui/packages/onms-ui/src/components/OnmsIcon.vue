...
// Depends only on `vue`. Renders a locally-vendored icon component (see
// src/components/icons/<category>/<Name>.vue) as an inline <svg>, sized in `em`
// and coloured via currentColor. Same API/behavior as FeatherIcon.
export const props = {
  icon: {
