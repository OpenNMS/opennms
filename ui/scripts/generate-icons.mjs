 ...
 * self-contained template-only SFC to
 * packages/onms-ui/src/icons/<category>/<Name>.vue (moved there from
 * src/components/icons/ by NMS-20243).
 *
 * This exists so the app can drop the `@featherds/icon` dependency entirely while
 * keeping pixel-identical icons (see the packages/onms-ui/src/components/OnmsIcon.vue
 * wrapper).
 *
...
const outBase = resolve('packages/onms-ui/src/icons')
