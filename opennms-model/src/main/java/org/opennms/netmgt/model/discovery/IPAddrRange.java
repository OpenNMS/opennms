 ...
 *
 * Copyright (C) 2002-2014 The OpenNMS Group, Inc. OpenNMS(R) is Copyright (C) 1999-2014 The OpenNMS
 * Group, Inc.
 *
 * OpenNMS(R) is a registered trademark of The OpenNMS Group, Inc.
 *
 * OpenNMS(R) is free software: you can redistribute it and/or modify it under the terms of the GNU
 * Affero General Public License as published by the Free Software Foundation, either version 3 of
 * the License, or (at your option) any later version.
 *
 * OpenNMS(R) is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without
 * even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the GNU
 * Affero General Public License for more details.
 *
 * You should have received a copy of the GNU Affero General Public License along with OpenNMS(R).
 * If not, see: http://www.gnu.org/licenses/
 *
 * For more information contact: OpenNMS(R) Licensing <license@opennms.org> http://www.opennms.org/
...
/**
 * <P>
 * The IPAddressRange object is used to encapsulate the starting and ending points of a contiguous
 * IPv4/IPv6 Address range. The class can then generate either an Enumeration or Iterator that can
 * be used to cycle through the range of addresses by the object's user.
 * </P>
 *
...
public final class IPAddrRange implements Iterable<InetAddress>, Serializable
{
    ...
    /**
     * <P>
     * This class is used to enumerate or iterate through one contiguous set of IP addresses. The
     * class can either be used as an iterator or as an enumeration. In java 1.2 iterators were
     * introduced and are being used in favor of enumerations in new classes.
     * </P>
     * 
     */
    static class IPAddressRangeGenerator implements Enumeration<InetAddress>, Iterator<InetAddress>
    {
        ...
        /**
         * The last address in the range. The remaining address are in the range of [m_next ..
         * m_end].
         */
        private final BigInteger m_end;

        /**
         * Converts an integer to an InetAdrress object and discards any exceptions. If the address
         * cannot be constructed then a null reference is returned.
         * 
         * @param addr The IP address value, in network order.
         * 
         ...
         * 
         * @exception java.lang.IllegalArgumentException Thrown if the start address is greater than
         *                the ending address.
         * 
         */
        ...
        /**
         * <P>
         * Returns the next element in the enumeration. If there is no element left in the
         * enumeration an exception will be thrown.
         * </P>
         * 
         * @exception java.util.NoSuchElementException Thrown if the collection is exhausted.
         */
        @Override
        ...
        /**
         * <P>
         * Returns the next object in the iteration. If there are no objects left in the iteration
         ...
         * For the purposes of this class it is not implemented and will throw an exception.
         * </P>
         * 
         * @exception java.lang.UnsupportedOperationException Always thrown by the remove method.
         * 
         */
        @Override
        public void remove()
     ...
     * 
     * <P>
     * It is important to note that if the address for toIP is greater than fromIP, the values will
     ...
     * 
     * @exception java.net.UnknownHostException Thrown by the InetAddress class if the hostname
     *                cannot be resolved.
     * 
     */
    ...
    /**
     * <P>
     * Returns an Iterator object that can be used to step through all the address encapsulated in
     * the object.
     * </P>
     *
     * <P>
     * The iterator returns objects of type {@link java.net.InetAddress InetAddress}or
     * <code>null</code> if the address is unknown.
     * </p>
     *
    ...
    /**
     * <P>
     * Returns an Enumeration object that can be used to list out all the address contained in the
     * encapsulated range.
     * </P>
     * 
     * <P>
