...
/**
 * <p>
 * This class is designed to encapsulate the information about an address range plus the retry &amp;
 * timeout information. The class is designed so that it can return either an
 * {@link java.util.Enumeration enumeration}or an {@link java.util.Iterator iterator}to traverse the
 * range of addresses.
 * </p>
 *
...
public class IPPollRange implements Iterable<IPPollAddress>
{
    ...
    /**
     * <P>
     * The purpose of the IPPollRangeGenerator class is to provide an Enumeration or Iterator object
     * that can be returned by the encapsulating class. The class implements the new style Iterator
     * interface, as well as the old style Enumeration to allow the developer freedom of choice when
     * cycling over ranges.
     * </P>
     * 
    ...
    final class IPPollRangeGenerator implements Enumeration<IPPollAddress>, Iterator<IPPollAddress>
    {
         ...
         * </P>
         * 
         * @param en The Enumeration to use for address generation.
         */
         ...
         * </P>
         * 
         * @exception java.util.NoSuchElementException Thrown if there are no more elements in the
         *                iteration.
         */
        @Override
        ...
        /**
         * <P>
         * If there are more elements left in the iteration then a value of true is returned. Else a
        ...
        /**
         * The remove method is part of the Iterator interface and is optional. Since it is not
         * implemnted it will always throw an UnsupportedOperationException.
         * 
         * @exception java.lang.UnsupportedOperationException Always thrown by this method.
         */
        @Override
        public void remove()
        {
    ...
    /**
     * <P>
     * Creates an IPPollRange object that can be used to generate IPPollAddress objects. The
     * addresses are encapsulated by the range object and the values of timeout and retry are set in
     * each generated IPPollAddress object.
     * </P>
     *
     ...
     * <P>
     * Creates an IPPollRange object that can be used to generate IPPollAddress objects. The
     * addresses are encapsulated by the range [start..end] and the values of timeout and retry are
     * set in each generated IPPollAddress object.
     * </P>
     * 
    ...
    /**
     * <P>
     * Returns the timeout set for the object. The timeout should be in 1/1000th of a second
     * increments.
     * </P>
     *
     * @return a long.
    ...
    /**
     * <P>
     * Returns an Iterator object that can be used to cycle over the range of pollable address
     * information.
     * </P>
     *
