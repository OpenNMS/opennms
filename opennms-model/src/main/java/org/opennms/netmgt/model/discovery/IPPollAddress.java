...
/**
 * <p>
 * This class is used to represent the polling information needed by the discovery process. Each
 * instance encapsulates an internet address, timeout in milliseconds, and a retry count.
 * </p>
 *
...
public class IPPollAddress implements Serializable
{
    ...
    /**
     * <P>
     * Returns true if the passed object is equal to self. The objects must be equal in address,
    ...
    {
        return new ToStringBuilder( this ).append( "address", m_address ).append( "retries", m_retries ).append(
                        "timeout", m_timeout ).toString();
    }
}
