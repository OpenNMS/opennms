 ...
 * @since 1.8.1
 */
public class FastGraphResultsController extends AbstractController implements InitializingBean {
    ...
    protected ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        ModelAndView modelAndView = new ModelAndView("/graph/FASTresults", "results", model);
