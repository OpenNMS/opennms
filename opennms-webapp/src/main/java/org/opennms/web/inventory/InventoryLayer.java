...
//    }
   ...
   static public int updateCloginInfo(String group, String device, String user, String password, String method) {
       ...
       try {
           ...
           RWSClientApi.createOrUpdateRWSAuthNode("http://www.rionero.com/rws-current",rna);
