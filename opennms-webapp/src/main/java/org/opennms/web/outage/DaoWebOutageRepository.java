...
public class DaoWebOutageRepository implements WebOutageRepository {
    ...
    /*
     * NOTE: Critiera building for Outages must included the following aliases"
     * 
    ...
    public int countMatchingOutageSummaries(OutageCriteria criteria) {
        throw new UnsupportedOperationException(
                                                "DaoWebOutageRepository.countMatchingOutageSummaries is not yet implemented");
    ...
    public int countMatchingOutages(OutageCriteria criteria) {
        throw new UnsupportedOperationException(
                                                "DaoWebOutageRepository.countMatchingOutages is not yet implemented");
    ...
    public OutageSummary[] getMatchingOutageSummaries(OutageCriteria criteria) {
        throw new UnsupportedOperationException(
                                                "DaoWebOutageRepository.getMatchingOutageSummaries is not yet implemented");
    ...
    public Outage[] getMatchingOutages(OutageCriteria criteria) {
        throw new UnsupportedOperationException(
                                                "DaoWebOutageRepository.getMatchingOutages is not yet implemented");
    ...
    public Outage getOutage(int OutageId) {
        throw new UnsupportedOperationException(
                                                "DaoWebOutageRepository.getOutage is not yet implemented");
