 ...
 * @version $Id: $
 * @since 1.8.1
 * @deprecated DO NOT use anymore. See http://issues.opennms.org/browse/NMS-8245 why.
 */
@Deprecated
public class ExecCommandController extends AbstractController {
	
	private static final Logger LOG = LoggerFactory.getLogger(ExecCommandController.class);

	@Override
	public ModelAndView handleRequest(final HttpServletRequest request, final HttpServletResponse response) throws Exception {
		return Logging.withPrefix("web", () -> super.handleRequest(request, response));
	}
