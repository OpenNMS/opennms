 ...
 */
public interface InventoryPageConstants extends com.google.gwt.i18n.client.Constants {
	...
	@DefaultStringValue("Inventory Number")
	@Key("inventoryNumber")
	String inventoryNumber();

	@DefaultStringValue("This field should be used if the organization employs inventory tags for inventory purposes")
	@Key("inventoryNumberHelp")
	String inventoryNumberHelp();

	@DefaultStringValue("Error saving: One or more fields contains an invalid value. Please correct your input and try again. ")
	@Key("inventoryPageNotValidDontSave")
	String inventoryPageNotValidDontSave();
	...
	@DefaultStringValue("Comments for this inventory")
	@Key("commentHelp")
	String commentHelp();
	...
	@DefaultStringValue("Error fetching inventory data for node with ID: ")
	@Key("errorFatchingInventoryData")
	String errorFatchingInventoryData();

	@DefaultStringValue("Error fetching inventory suggestion data for node ID: ")
	@Key("errorFetchingInventorySuggData")
	String errorFetchingInventorySuggData();

	@DefaultStringValue("Error saving inventory data for node ID: ")
	@Key("errorSavingInventoryData")
	String errorSavingInventoryData();
	...
	@DefaultStringValue("Inventory Info of Node: ")
	@Key("infoInventory")
	String infoInventory();

	@DefaultStringValue("Loading Inventory Info of Node: ")
	@Key("infoInventoryLoging")
	String infoInventoryLoging();

	@DefaultStringValue("Resetting Inventory Info of Node: ")
	@Key("infoInventoryRestting")
	String infoInventoryRestting();

	@DefaultStringValue("Saved Inventory Info of Node: ")
	@Key("infoInventorySaved")
	String infoInventorySaved();

	@DefaultStringValue("Saving Inventory Info of Node: ")
	@Key("infoInventorySaving")
	String infoInventorySaving();
	...
	@DefaultStringValue("Vendor Inventory")
	@Key("vendorInventory")
	String vendorInventory();

	@DefaultStringValue("If the vendor that supplies this equipment uses a inventory tag of their own, populate that data here")
	@Key("vendorInventoryHelp")
	String vendorInventoryHelp();
