...
package org.opennms.gwt.web.ui.inventory.client.view;
...
import org.opennms.gwt.web.ui.inventory.client.tools.DisclosurePanelCookie;
import org.opennms.gwt.web.ui.inventory.client.tools.fieldsets.FieldSet;
import org.opennms.gwt.web.ui.inventory.client.tools.fieldsets.FieldSetTextBox;
import org.opennms.gwt.web.ui.inventory.shared.InventoryCommand;
import org.opennms.gwt.web.ui.inventory.shared.ContentElement;
 ...
 * 
 */
public class InventoryPageImpl extends Composite implements InventoryPagePresenter.Display {

	InventoryCommand m_inventory;
	Panel mainPanel;
	...
	@Override
	public InventoryCommand getData() {
	...
	@Override
	public void setData(InventoryCommand inventory) {
		m_inventory = inventory;
		PageModel pageModel = inventory.getPageModel();
	...
	private void createSectionUi(Panel rootPanel, SectionModel sectionModel) {
		...
		for (Iterator<ContentElement> contentElementIterator = contentElementList.iterator(); contentElementIterator
			...
			if (contentElement instanceof org.opennms.gwt.web.ui.inventory.shared.FieldSetModel) {
				...
				sectionPanel.add((Widget) fs);
			} else if (contentElement instanceof org.opennms.gwt.web.ui.inventory.shared.SectionModel) {
