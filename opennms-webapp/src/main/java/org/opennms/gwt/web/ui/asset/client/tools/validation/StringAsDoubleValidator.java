 ...
 *
 * Copyright (C) 2011-2012 The OpenNMS Group, Inc. OpenNMS(R) is Copyright (C) 1999-2012 The OpenNMS Group, Inc.
 *
 ...
 * Validates given object to be castable to Double.
 */
public class StringAsDoubleValidator implements Validator {

    private AssetPageConstants con = GWT.create(AssetPageConstants.class);

    /**
     * Validates if the string representation of given object a valid integer. Validation will run against
     * <code>Double.parseInt(object.toString())</code> so make sure to use a proper object.
     *
     * @param object
     */
    @Override
    public String validate(Object object) {
        ...
        try {
            ...
            return con.stringNoValidDouble();
        }
    }
}
