 ...
 * Validates given object to be castable to Float.
 */
public class StringAsFloatValidator implements Validator {

    private AssetPageConstants con = GWT.create(AssetPageConstants.class);

    /**
     * Validates if the string representation of given object a valid float. Validation will run against
     * <code>Float.parseFloat(object.toString())</code> so make sure to use a proper object.
     *
     * @param object
     */
    @Override
