    ...
    <div class="panel panel-default">
      ...
      <div class="list-group">
        ...
        <div class="col-xs-12 input-group">
          ...
          <input type="text" class="form-control" id="chunksize" name="chunksize" value="<%=((currConfig.getChunkSize() == null || currConfig.getChunkSize()==0)?DiscoveryConfigFactory.DEFAULT_CHUNK_SIZE:currConfig.getChunkSize())%>"/>
        </div> <!-- input-group -->
        </div>
      </div>
    </div> <!-- panel -->
