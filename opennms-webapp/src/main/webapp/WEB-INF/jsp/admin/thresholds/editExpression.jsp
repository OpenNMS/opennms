                ...
                <tr>
                    <c:choose>
                      <c:when test="${i.count==filterSelected}">
                        ...
                        <td><input type="text" name="updateFilterRegexp" class="form-control" size="60" value="${fn:escapeXml(filter.content)}"/></td>
                      ...
                      <c:otherwise>
                        ...
                        <td class="standard"><input type="text" class="form-control" disabled="disabled" size="60" value="${fn:escapeXml(filter.content)}"/></td>
