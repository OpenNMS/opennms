...
<div class="panel-body">
  ...
  <form name="chooseForm" action="distributedStatusHistory.htm" role="form" class="form-horizontal">
    ...
    <div class="form-group">
      <label class="col-sm-2 control-label" for="monitorId">Remote Poller</label>
      <div class="col-sm-4">
        <c:choose>
    ...
    <div class="form-group">
      <label class="col-sm-2 control-label" for="application">Application</label>
      <div class="col-sm-4">
    ...
    <div class="form-group">
      <label class="col-sm-2 control-label" for="timeSpan">Time Span</label>
      <div class="col-sm-4">
