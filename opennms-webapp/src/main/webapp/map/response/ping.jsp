...
function doCommand(){
     ...
     window.close();
     window.open('<%=org.opennms.web.Util.calculateUrlBase( request )%>map/CommandLine?command='+command+'&address='+address, 'AddSpecific', 'toolbar,width='+self.screen.width-150+' ,height=300, left=0, top=0, scrollbars=1') ;
}
</script>
