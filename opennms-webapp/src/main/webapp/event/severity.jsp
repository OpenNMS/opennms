...
<jsp:include page="/includes/header.jsp" flush="false" >
  ...
  <jsp:param name="quiet" value="true" />
			...
			<table>
				<tr><td style="background-color: red"><b>Critical</b></td><td>This event means numerous devices on the 
				...
				<tr><td style="background-color: cyan"><b>Warning</b></td><td>An event has occurred that may require 
				...
				<tr><td style="background-color: white"><b>Cleared</b></td><td>This event indicates that a prior error 
				condition has been corrected and service is restored</td></tr>
				<tr><td style="background-color: lightblue"><b>Indeterminate</b></td><td>No Severity could be associated with this event.</td></tr>
			</table>
