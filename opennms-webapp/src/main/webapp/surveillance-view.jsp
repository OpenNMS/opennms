...
<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn"%>
    ...
    <iframe name="surveillance-view-single" id="surveillance-view-ui" src="vaadin-surveillance-views?dashboard=false<%= viewName %>" frameborder="0" style="height:100%; width:100%;"></iframe>
