...
public class AssetServiceImplIT implements InitializingBean {
	...
	OnmsNode onmsNode = new OnmsNode(m_locationDao.getDefaultLocation(), "your Node");
		...
		LOG.debug("Asset: " + m_assetService.getAssetByNodeId(onmsNode.getId()));
	}
