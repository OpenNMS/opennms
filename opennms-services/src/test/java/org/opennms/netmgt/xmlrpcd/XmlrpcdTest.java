...
public class XmlrpcdTest extends OpenNMSTestCase {
    ...
    public void testSerialFailback() throws Exception {
        ...
        nodeThreeEvent.setTime(EventConstants.formatToString(date));
