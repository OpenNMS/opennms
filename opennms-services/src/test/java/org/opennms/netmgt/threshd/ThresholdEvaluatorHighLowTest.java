...
public class ThresholdEvaluatorHighLowTest extends TestCase {
    ...
    public void testConstructorThresholdNoType() {
        ...
        try {
            new ThresholdEvaluatorStateHighLow(threshold);
        } catch (Throwable t) {
            ta.throwableReceived(t);
        }
        ta.verifyAnticipated();
    ...
    public void testEvaluateHighNoTrigger() {
        ...
        ThresholdEvaluatorState item = new ThresholdEvaluatorStateHighLow(threshold);
    ...
    public void testIsThresholdExceededHighTriggeredAbove() {
        ...
        ThresholdEvaluatorStateHighLow item = new ThresholdEvaluatorStateHighLow(threshold);
