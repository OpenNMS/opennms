...
public abstract class LinkdNms7467NetworkBuilder extends LinkdNetworkBuilder {
     ...
     */
    static final String WORKSTATION_NAME        = "workstation";
    static final String WORKSTATION_IP          = "172.20.1.101";
    static final String WORKSTATION_MAC         = "60334b0817a8";

    /*
     * This is a cisco access point but without snmp walk available 
     */
    static final String ACCESSPOINT_NAME        = "accesspoint";
    static final String ACCESSPOINT_IP          = "172.20.1.5";
    ...
    static final String CISCO_C870_NAME         = "ciscorouter";
    static final String CISCO_C870_IP_PRIMARY   = "10.255.255.2";
    static final String CISCO_C870_IP           = "172.20.1.1";
    ...
    static final Map<InetAddress, Integer> CISCO_C870_IP_IF_MAP = new HashMap<InetAddress, Integer>();
    static {
        try {
    ...
    static final Map<Integer, String> CISCO_C870_IF_IFNAME_MAP = new HashMap<Integer, String>();
    static {
    ...
    static final Map<Integer, String> CISCO_C870_IF_IFDESCR_MAP = new HashMap<Integer, String>();
    static {
    ...
    static final Map<Integer, String> CISCO_C870_IF_MAC_MAP = new HashMap<Integer, String>();
    static {
    ...
    static final String CISCO_WS_C2948_NAME         = "ciscoswitch";
    static final String CISCO_WS_C2948_IP       = "172.20.1.7";
    ...
    static final Map<InetAddress,Integer> CISCO_WS_C2948_IP_IF_MAP =  new HashMap<InetAddress,Integer>();
    static {
        try {
    ...
    static final Map<Integer,String> CISCO_WS_C2948_IF_IFNAME_MAP = new HashMap<Integer, String>();
    static {
    ...
    static final Map<Integer,String> CISCO_WS_C2948_IF_MAC_MAP = new HashMap<Integer, String>();
    static {
     ...
     * 
     */
    static final String NETGEAR_SW_108_NAME         = "ng108switch";
    static final String NETGEAR_SW_108_IP       = "172.20.1.8";
    ...
    static final Map<Integer, String> NETGEAR_SW_108_IF_IFNAME_MAP = new HashMap<Integer, String>();
    static {
    ...
    static final Map<Integer, String> NETGEAR_SW_108_IF_MAC_MAP = new HashMap<Integer, String>();
    static {
    ...
    static final String LINUX_UBUNTU_NAME         = "linuxubuntu";
    static final String LINUX_UBUNTU_IP         = "172.20.1.14";
    static final String LINUX_UBUNTU_SYSOID     = ".1.3.6.1.4.1.8072.3.2.10";
    
    static final Map<InetAddress, Integer> LINUX_UBUNTU_IP_IF_MAP = new HashMap<InetAddress, Integer>();
    static {
        try {
    ...
    static final Map<Integer, String> LINUX_UBUNTU_IF_IFNAME_MAP = new HashMap<Integer, String>();
    static {
    ...
    static final Map<Integer, String> LINUX_UBUNTU_IF_MAC_MAP = new HashMap<Integer, String>();
    static {
    ...
    static final String DARWIN_10_8_NAME        = "mac";
    static final String DARWIN_10_8_IP          = "172.20.1.28";
    static final String DARWIN_10_8_SYSOID      = ".1.3.6.1.4.1.8072.3.2.255";
    

    static final Map<InetAddress,Integer> DARWIN_10_8_IP_IF_MAP = new HashMap<InetAddress, Integer>();
    static {
        try {
    ...
    static final Map<Integer, String> DARWIN_10_8_IF_IFNAME_MAP = new HashMap<Integer, String>();
    static {
    ...
    static final Map<Integer, String> DARWIN_10_8_IF_MAC_MAP = new HashMap<Integer, String>();
    static {
    ...
    OnmsNode getCiscoWsC2948() {
        return getNode(CISCO_WS_C2948_NAME,CISCO_WS_C2948_SYSOID,CISCO_WS_C2948_IP,CISCO_WS_C2948_IP_IF_MAP,CISCO_WS_C2948_IF_IFNAME_MAP,CISCO_WS_C2948_IF_MAC_MAP, new HashMap<Integer, String>());
    }
    
    OnmsNode getNetGearSw108() {
        return getNode(NETGEAR_SW_108_NAME,NETGEAR_SW_108_SYSOID,NETGEAR_SW_108_IP,NETGEAR_SW_108_IP_IF_MAP,NETGEAR_SW_108_IF_IFNAME_MAP,NETGEAR_SW_108_IF_MAC_MAP,new HashMap<Integer, String>());
    }
    
    OnmsNode getLinuxUbuntu() {
        return getNode(LINUX_UBUNTU_NAME, LINUX_UBUNTU_SYSOID, LINUX_UBUNTU_IP, LINUX_UBUNTU_IP_IF_MAP, LINUX_UBUNTU_IF_IFNAME_MAP, LINUX_UBUNTU_IF_MAC_MAP, new HashMap<Integer, String>());
    }
