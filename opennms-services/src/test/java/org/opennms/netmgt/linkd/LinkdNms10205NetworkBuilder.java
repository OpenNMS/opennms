...
//Node Id = 1 IfIndex = 519 Node ParentId = 3 Parent IfIndex = 28503
    ...
    static {
        try {
            ...
            SPACE_EX_SW1_IP_IF_MAP.put(InetAddress.getByName("172.16.7.1"), 528);
    ...
    static {
        try {
            ...
            BANGALORE_IP_IF_MAP.put(InetAddress.getByName("20.0.1.2"), 2397);
            BANGALORE_IP_IF_MAP.put(InetAddress.getByName("10.205.56.9"), 2366);
            BANGALORE_IP_IF_MAP.put(InetAddress.getByName("192.168.5.6"), 2396);
            BANGALORE_IP_IF_MAP.put(InetAddress.getByName("10.0.0.4"), 14);
            BANGALORE_IP_IF_MAP.put(InetAddress.getByName("128.0.0.4"), 14);
            BANGALORE_IP_IF_MAP.put(InetAddress.getByName("192.168.0.1"), 16);
        } catch (UnknownHostException e) {
            e.printStackTrace();
        }
        ...
        BANGALORE_IF_IFNAME_MAP.put(3341, "ge-0/1/1.3");
        BANGALORE_IF_IFDESCR_MAP.put(3341, "ge-0/1/1.3");
        ...
        BANGALORE_IF_IFNAME_MAP.put(3346, "ge-0/1/1.4");
        BANGALORE_IF_IFDESCR_MAP.put(3346, "ge-0/1/1.4");
        BANGALORE_IF_IFNAME_MAP.put(3348, "ge-0/1/1.6");
        BANGALORE_IF_IFDESCR_MAP.put(3348, "ge-0/1/1.6");
        ...
        BANGALORE_IF_IFNAME_MAP.put(3343, "ge-0/1/1.7");
        BANGALORE_IF_IFDESCR_MAP.put(3343, "ge-0/1/1.7");
        ...
        BANGALORE_IF_IFNAME_MAP.put(3347, "ge-0/1/1.2");
        BANGALORE_IF_IFDESCR_MAP.put(3347, "ge-0/1/1.2");
        ...
        BANGALORE_IF_IFNAME_MAP.put(2399, "ge-0/1/1.1");
        BANGALORE_IF_IFDESCR_MAP.put(2399, "ge-0/1/1.1");
        ...
        BANGALORE_IF_IFNAME_MAP.put(2400, "ge-0/1/1.32767");
        BANGALORE_IF_IFDESCR_MAP.put(2400, "ge-0/1/1.32767");
        ...
        BANGALORE_IF_IFNAME_MAP.put(3344, "ge-0/1/1.8");
        BANGALORE_IF_IFDESCR_MAP.put(3344, "ge-0/1/1.8");
        ...
        BANGALORE_IF_IFNAME_MAP.put(3349, "ge-0/1/1.5");
        BANGALORE_IF_IFDESCR_MAP.put(3349, "ge-0/1/1.5");
        BANGALORE_IF_IFNAME_MAP.put(3345, "ge-0/1/1.9");
        BANGALORE_IF_IFDESCR_MAP.put(3345, "ge-0/1/1.9");
        BANGALORE_IF_IFNAME_MAP.put(3342, "ge-0/1/1.10");
        BANGALORE_IF_IFDESCR_MAP.put(3342, "ge-0/1/1.10");
