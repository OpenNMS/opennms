...
public class InveneoSpikeSnmpCollectorTest extends AbstractCollectorTest {
    ...
    public void testPersist() throws Exception {
        ...
        initializeDataCollectionConfig("/org/opennms/netmgt/config/datacollection-Inveneo-persistTest-config.xml");
        ...
        assertEquals(1234567.0, RrdUtils.fetchLastValueInRange(ifRrdFile.getAbsolutePath(), "ifInOctets", stepSizeInMillis, stepSizeInMillis + 20000));
    ...
    public void xxtestUsingFetch() throws Exception {
