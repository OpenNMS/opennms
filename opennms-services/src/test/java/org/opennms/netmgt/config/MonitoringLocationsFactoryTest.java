...
public class MonitoringLocationsFactoryTest extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		Reader rdr = new InputStreamReader(getClass().getResourceAsStream("/org/opennms/netmgt/config/monitoring-locations.testdata.xml"));
		m_locationFactory = new MonitoringLocationsFactory(rdr);
		rdr.close();
        
        rdr = new InputStreamReader(getClass().getResourceAsStream("/org/opennms/netmgt/config/poller-configuration.testdata.xml"));
        m_pollerConfigManager = new TestPollerConfigManager(rdr, "localhost", false);
		rdr.close();
	}
