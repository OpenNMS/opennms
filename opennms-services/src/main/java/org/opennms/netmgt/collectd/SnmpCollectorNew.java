...
public class SnmpCollectorNew extends SnmpCollectorAbstract {
     ...
     */
    private final String SERVICE_NAME = "SNMP";
    ...
    public CollectionSet collect(CollectionAgent agent, Map<String, Object> parameters) throws CollectionException {
        try {
            ...
            SnmpCollectionSetRefactorDummy collectionSet = new SnmpCollectionSetRefactorDummy((SnmpCollectionAgent)agent, snmpCollection, snmpCollection.getClient());
            ...
            return collectionSet.createCollectionSet();
