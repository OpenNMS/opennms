...
public class LldpHelper {
    ...
    public static String decodeLldpChassisId(final SnmpValue lldpchassisid, Integer lldpLocChassisidSubType) {
    	...
    	if (lldpLocChassisidSubType.intValue() == LldpChassisIdSubType.LLDP_CHASSISID_SUBTYPE_MACADDRESS.getLldpChassisIdSubType().intValue())
    		lldpLocChassisId = lldpchassisid.toHexString();
    	if (lldpLocChassisidSubType.intValue() == LldpChassisIdSubType.LLDP_CHASSISID_SUBTYPE_NETWORKADDRESS.getLldpChassisIdSubType().intValue())
	...
	public static String decodeLldpLink(Integer lldpPortIdSubType,SnmpValue lldpportid) {
    	...
    	if (lldpPortIdSubType.intValue() == LldpPortIdSubType.LLDP_PORTID_SUBTYPE_MACADDRESS.getLldpPortIdSubType().intValue())
    		lldpPortId = lldpportid.toHexString();
    	if (lldpPortIdSubType.intValue() == LldpPortIdSubType.LLDP_PORTID_SUBTYPE_NETWORKADDRESS.getLldpPortIdSubType())
