 ...
 * from Pollerd to Minion so that {@link org.opennms.netmgt.poller.monitors.PassiveServiceMonitor}
 * can execute on Minion.
 */
public class PassiveStatusConfig implements Serializable {
    ...
    /**
     * Converts this config into a PassiveStatusKeeper-compatible status map.
     */
    ...
    /**
     * Creates a config from a PassiveStatusKeeper status map.
     */
    ...
    public boolean equals(Object o) {
        ...
        PassiveStatusConfig that = (PassiveStatusConfig) o;
    ...
    public String toString() {
        return "PassiveStatusConfig{entries=" + entries.size() + "}";
    }

    /**
     * A single passive status entry for Twin API serialization.
     */
    public static class Entry implements Serializable {
        ...
        public boolean equals(Object o) {
            ...
            if (o == null || getClass() != o.getClass()) return false;
            Entry entry = (Entry) o;
            return Objects.equals(nodeLabel, entry.nodeLabel) &&
                    Objects.equals(ipAddr, entry.ipAddr) &&
                    Objects.equals(serviceName, entry.serviceName) &&
                    Objects.equals(statusName, entry.statusName) &&
                    Objects.equals(reason, entry.reason);
        }

        @Override
        public int hashCode() {
            return Objects.hash(nodeLabel, ipAddr, serviceName, statusName, reason);
        }

        @Override
        public String toString() {
            return nodeLabel + ":" + ipAddr + ":" + serviceName + " -> " + statusName;
        }
    }
}
