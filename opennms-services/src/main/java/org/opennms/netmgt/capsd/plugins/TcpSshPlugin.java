 ...
 * existence of an TCP server on remote interfaces. The class implements the
 ...
 * 
 */
public final class TcpSshPlugin extends AbstractPlugin {
        ...
        for (int attempts = 0; attempts <= retries && !isAServer; attempts++) {
            ...
            try {
                ...
                if (regex == null) {
                    ...
                    // Read the server's banner line output and validate it
                    // against
