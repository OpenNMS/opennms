...
//
     ...
     * 
     */
    /*public void addEventHandler(Syslogd handler) {
     ...
     * 
     */
    /*public void removeEventHandler(Syslogd handler) {
        synchronized (m_handlers) {
