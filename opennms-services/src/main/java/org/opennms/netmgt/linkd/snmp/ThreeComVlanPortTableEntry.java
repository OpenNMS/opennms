...
/**
 *<P>The ThreeComVlanPortTableEntry class is designed to hold all the MIB-II
 ...
 * 
 * <P>This object is used by the ThreeComVlanPortTable  to hold infomation
 * single entries in the table. See the ThreeComVlanPortTable documentation
 ...
 *
 *
 * @see ThreeComVlanPortTable
 * @see <A HREF="http://www.ietf.org/rfc/rfc1213.txt">RFC1213</A>
 */
public final class ThreeComVlanPortTableEntry extends SnmpTableEntry
implements VlanCollectorEntry {

	// Lookup strings for specific table entries
	//
	public final static String VLAN_IFGI = "a3ComVlanIfGlobalIdentifier ";
	public final static String VLAN_IFINFO = "a3ComVlanIfInfo";

	private static String VLAN_INDEX_OID=".1.3.6.1.4.1.43.10.1.14.1.2.1.1";
	...
	static {
		...
		threeComVlan_elemList[ndx++] = new NamedSnmpVar(NamedSnmpVar.SNMPINT32,
				VLAN_INDEX, ".1.3.6.1.4.1.43.10.1.14.1.2.1.1", 1);
		...
		threeComVlan_elemList[ndx++] = new NamedSnmpVar(NamedSnmpVar.SNMPINT32,
				VLAN_IFGI, ".1.3.6.1.4.1.43.10.1.14.1.2.1.4", 4);
	 ...
	 */
	public ThreeComVlanPortTableEntry() {
