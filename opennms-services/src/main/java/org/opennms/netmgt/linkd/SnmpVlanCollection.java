...
public final class SnmpVlanCollection implements ReadyRunnable {
     ...
     */
    SnmpVlanCollection(final SnmpAgentConfig agentConfig,
            final boolean collectStp, final boolean collectBridge) {
        m_agentConfig = agentConfig;
        m_address = m_agentConfig.getEffectiveAddress();
        m_dot1dBase = null;
        m_dot1dBaseTable = null;
     ...
     */
    boolean failed() {
        return !hasDot1dBase() && !hasDot1dBasePortTable() && !hasDot1dStp()
                && !hasDot1dStpPortTable() && !hasDot1dTpFdbTable();
    }
    ...
    public String toString() {
        return new ToStringBuilder(this).
                ...
                append("dot1qTpFdbTable",m_dot1qTpFdbTable).toString();
    }
