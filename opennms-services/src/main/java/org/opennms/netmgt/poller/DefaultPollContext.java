...
public class DefaultPollContext implements PollContext, EventListener {
    ...
    public Event createEvent(String uei, int nodeId, InetAddress address, String svcName, Date date, String reason) {
        ...
        return createEvent(uei, nodeId, address, svcName, date, params);
    }

    /* (non-Javadoc)
     * @see org.opennms.netmgt.poller.pollables.PollContext#createEvent(java.lang.String, int, java.net.InetAddress, java.lang.String, java.util.Date, java.util.Map)
     */
    /** {@inheritDoc} */
    @Override
