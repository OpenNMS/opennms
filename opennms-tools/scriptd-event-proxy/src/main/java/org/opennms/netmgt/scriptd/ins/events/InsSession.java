...
class InsSession extends Thread{
	...
	/**
	 * the shared string for authentication
	 */ 
	private String sharedAsciiAuthString = null;
	...
	public void setSharedAsciiAuthString(String sharedAsciiAuthString) {
		this.sharedAsciiAuthString = sharedAsciiAuthString;
	}
	
	public String getSharedAsciiAuthString() {
		return sharedAsciiAuthString;
	}
	...
	/*public CurrentAlarmsSender getSendCurrentAlarmsThread() {
		return sendCurrentAlarmsThread;
	}*/
