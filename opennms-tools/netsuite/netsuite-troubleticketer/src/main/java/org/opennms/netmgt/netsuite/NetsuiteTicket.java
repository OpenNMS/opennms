 ...
 *
 */
public class NetsuiteTicket implements Serializable {
    /**
	 * 
	 */
    ...
    public NetsuiteTicket() {
    }

    public NetsuiteTicket(final String queue, final String requestor, final String subject, final String text) {
        this(null, queue, requestor, subject, text);
    }

    public NetsuiteTicket(final Long id, final String queue, final String requestor, final String subject, final String text) {
        m_id = id;
        m_queue = queue;
    ...
    public NetsuiteTicket copy() {
        final NetsuiteTicket newTicket = new NetsuiteTicket();
