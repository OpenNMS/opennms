...
public class EventdStresser {
    ...
    private static void processSystemProperties() throws IllegalArgumentException, NumberFormatException {
        ...
        if (property != null) {
            m_trapPort = SystemPropertiesUtils.getInteger(PROPERTY_TRAP_PORT);
        ...
        if (property != null) {
            m_trapCount = SystemPropertiesUtils.getInteger(PROPERTY_TRAP_COUNT);
