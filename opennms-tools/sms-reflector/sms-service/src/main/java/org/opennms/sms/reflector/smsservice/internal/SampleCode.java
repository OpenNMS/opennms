...
public class SampleCode implements BundleActivator {
	...
	public void start(BundleContext context) throws Exception {
        ...
        m_service.setOutboundNotification(new OutboundMessageNotification(null));
        m_service.setInboundNotification(new InboundMessageNotification(null));
        m_service.setGatewayStatusNotification(new GatewayStatusNotification(null));
