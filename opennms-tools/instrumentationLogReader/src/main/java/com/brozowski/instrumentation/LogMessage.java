...
public class LogMessage {
    ...
    public static LogMessage create(String logMessage) {
        ...
        if (m.matches()) {
            return new LogMessage(parseTimestamp(m.group(1)), m.group(2), toMsgType(m.group(3)), m.group(4));
        } else {
            return null;
        }
    }
    ...
    private LogMessage(Date timestamp, String threadName, MsgType msgType, String serviceId) {
