...
import com.brozowski.instrumentation.LogMessage.MsgType;
...
public class LogMessageTest {
    ...
    public LogMessageTest(boolean msgIsValid, Date timestamp, String threadName, MsgType msgType, String serviceId, String logString) {
    ...
    @Before
    public void setUp() {
        m_logMessage = LogMessage.create(m_logString);
    }
    ...
    public void testGetTimestamp() {
        ...
        assertEquals(m_timestamp, m_logMessage.getTimestamp());
    }
    
    @Test
    public void testGetThreadName() {
        assumeThat(m_msgIsValid, is(true));
        assertEquals(m_threadName, m_logMessage.getThreadName());
    }
