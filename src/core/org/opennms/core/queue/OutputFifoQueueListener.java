 ...
 * when a new element is removed from a queue. The notification method is
 * invoked aftet the element is removed to the queue, the exact semantics
 * of which are defined by the queue.</p>
 *
 * <p>This is most often used to notify a object that a full queue
 * has new space for more elements to be added. This allows the object
...
public interface OutputFifoQueueListener
{
	 ...
	 *
	 * @param queue	The queue where an element was removed.
	 */
