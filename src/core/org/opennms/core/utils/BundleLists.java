...
/**
 * Contains utility functions for handling with <em>bundle lists</em>,
 * that is, a comma-delimited list of strings that are contained as one
 * line in a Java properties file.  This class contains methods to parse
 * and create these bundle lists.
 *
...
public class BundleLists extends Object 
{
    ...
    /** 
     * Parses a Object array and puts them into a array of substrings, 
     * using a comma as a delimiter
     * @param objArray The object array to be formatted as a comma-delimited string.
