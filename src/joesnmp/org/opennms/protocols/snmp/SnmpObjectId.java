 ...
 * An object identifier is a sequence of numbers that correspond
 * to branches in the Management Information Base (MIB). Each vendor
	...
	implements SnmpSyntax, Cloneable, Serializable
{
	 ...
	 *
	 * @param idstr	An object identifier string
	 * 
	 * @return Returns an array of integers converted from
	 *	   the string. If an error occurs then a null
	 *	   is returned.
	 */
	 ...
	 * array of identifiers. If the passed argument is
	 * null then a default object id (.0.0) is created
	 * for the instance.
	 *
	 * @param data The array of object identifiers
	 *
	 */
	...
	/**
	 * Creates a duplicate object. The passed
	 * object identifier is copied into the 
	 ...
	 * dotted decimal object identifier string. The
	 * string is converted to the internal representation.
	 * If the conversion fails then a default (.0.0) object
	 * identifier is assigned to the object.
	 *
	 * @param strOid The dotted decimal object identifier string
	 *
	 */
	 ...
	 * object. The instance is returned as a reference.
	 * The caller should not make any modifications to
	 * the returned list.
	 *
	 ...
	 *
	 * @param data The new object identifier
	 *
	 */
	 ...
	 *
	 * @param strOid The dotted decimal object identifier.
	 *
	 */
	 ...
	 * current object.
	 *
	 * @param ids The array of identifiers to append
	 *
	 */
	 ...
	 *
	 * @param strOids The dotted decimal identifiers to append
	 *
	 */
	 ...
	 * self.
	 *
	 * @param second The object to append to self
	 *
	 */
	 ...
	 *
	 * @param strOids The dotted decimal identifiers to prepend
	 *
	 */
	 ...
	 * self.
	 *
	 * @param second The object to prepend to self
	 *
	 */
	 ...
	 * the array of identifiers. If the object is lexigraphically
	 * less than ids a negative number is returned. A positive
	 * number is returned if self is greater than the passed identifers
	 * and a zero is returned if they are equal. The length of the
	 * identifiers do not have to be equal.
	 *
	 * @param ids The array if identifier to compare
	 *
	 * @return Returns zero if the ids are equal. Less than zero if 
	 *	the object is less than 'ids' and greater than zero if 
	 *	the object is greater than 'ids'.
	 *
	 */
	 ...
	 *
	 * @param ids 	The array if identifier to compare.
	 * @param dist 	The maximum number of ids to compare.
	 *
	 * @return Returns zero if the ids are equal. Less than zero if 
	 *	the object is less than 'ids' and greater than zero if 
	 *	the object is greater than 'ids'.
	...
	/**
	 * Lexigraphically compares the object identifer to
	 * the passed object identifer. If the object is lexigraphically
	 * less than 'cmp' a negative number is returned. A positive
	 * number is returned if self is greater than the passed identifer
	 * and a zero is returned if they are equal. The length of the
	 * identifiers do not have to be equal.
	 *
	 * @param cmp The object identifier to compare
	 *
	 * @return Returns zero if the ids are equal. Less than zero if 
	 *	the object is less than 'cmp' and greater than zero if 
	 *	the object is greater than 'cmp'.
	 *
	 */
	...
	/**
	 * <P>Compares the passed object identifier against self
	 ...
	 * is returned from the object.</P>
	 *
	 * @param leaf	The object to be tested
	 *
	...
	/**
	 * Test for equality. Returns true if 'o' is an instance of
	 * an SnmpObjectId and is equal to self.
	 *
	 * @param o The object to be tested for equality.
	 *
	 * @return True if the object is an SnmpObjectId and is equal
	 ...
	 * identifier. If the value of the object identifier
	 * is changed through any method the hash value for
	 * the identifer will change. Care must be exercised
	 * by developers to ensure that ObjectIds do not change
	 * when inserted into managers that track object by their
	 * hash value.
	 *
