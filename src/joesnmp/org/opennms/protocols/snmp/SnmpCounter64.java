	...
	implements SnmpSyntax, Cloneable, Serializable
{
	...
	public SnmpCounter64( )
	{
		...
		m_value.clearBit(65);	// ensures that the 64-bits are treated as unsigned!
	}
	
	/**
	 * Constructs a SnmpCounter64 object with the specified value.
	 *
	 * @param value The new 64-bit value.
	 *
	 */
	 ...
	 * If the value exceeds 64-bit then the upper
	 * 64-bits will be silently truncated from
	 * the value.
	 *
