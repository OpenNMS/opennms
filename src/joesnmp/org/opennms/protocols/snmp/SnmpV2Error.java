...
// Tab Size = 8
//
// SnmpV2Error.java,v 1.1.1.1 2001/11/11 17:27:23 ben Exp
//
//
	...
	implements SnmpSyntax, Cloneable, Serializable
{
	 ...
	 *
	 * @param second	The object to copy to self
	 *
	 */
	 ...
	 *
	 * @param buf		The buffer to store encoded bytes
	 * @param offset	The start of the encoding location
	 * @param encoder	The encoding object
	 *
	 * @return The index of the byte immedantly after the last
	 *	encoded byte.
	 *
	 */
	 ...
	 * @param offset	The offset of the first byte of encoded data
	 * @param encoder	The object used to decode the data.
	 *
	 * @return The index of the byte immedantly after the last
	 *	encoded byte.
	 */
	 ...
	 * copy constructor.
	 *
	 * @return A newly created object that is a duplicate
	 *	of self.
	 */
