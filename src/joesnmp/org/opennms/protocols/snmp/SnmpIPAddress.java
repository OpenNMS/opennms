 ...
 * IP Addresses with a length of 4 bytes.</p>
 *
	...
	extends SnmpOctetString
{
	 ...
	 *
	 * @throws java.security.InvalidParameterException Thrown if the passed
	 *	buffer is not exactly 4 octets in size.
	 */
	 ...
	 *
	 * @param inetAddr	The internet address instance that 
	 ...
	 * of the evaluated argument. The argument is evaluated by the 
	 * {@link java.net.InetAddress#getByName InetAddress} class and
	 * the returned address is encoded in this instance.
	 *
	 * @param inetAddr	The string encoded IP Address to encapsulate.
	 *
	 * @exception SnmpBadConversionException Thrown if the string address
	 * 	cannot be converted to an IP Address.
	 */
	public SnmpIPAddress(String inetAddr)
	...
	/**
	 * <p>Sets the internal string array so that it is
	 ...
	 * in the SnmpOctetString Object.</p>
	 *
	 * <p>If the buffer is not valid according to the SNMP
	 * SMI then an exception is thrown and the object is
	 * not modified.</p>
	 *
	 * @param data	The new octet string data.
	 *
	 * @throws java.security.InvalidParameterException Thrown if
	 * 	the passed buffer is not valid against the SMI definition.
	 */
