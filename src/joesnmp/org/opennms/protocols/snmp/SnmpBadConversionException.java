...
public class SnmpBadConversionException extends Exception
{
	 ...
	 *
	 * @param why	The message for the exception.
	 */
	 ...
	 *
	 * @param why 		The message for the exception.
	 * @param reason	The original exception that caused the problem
	 *
	 */
	 ...
	 * previous exception. The two exceptions are chained
	 * together internally.
	 *
	 * @param reason	The original exception
	 */
	...
	/**
	 * Prints the stack trace of the exception. If the
	 * exception has been chained then the original exception
	 * is also printed to the stream.
	 */
	 ...
	 * is also printed to the stream.
	 *
	 * @param writer The stream to writer the stack trace onto.
	 */
	 ...
	 * is also printed to the stream.
	 *
	 * @param stream The stream to writer the stack trace onto.
	 */
