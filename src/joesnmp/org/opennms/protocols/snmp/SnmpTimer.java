...
class SnmpTimer extends Object
{
	...
	/**
	 * Used to track the individual runnables and when
	 * the runnable "expires".
	 *
	 */
	private class TimeoutElement
	{
		...
		/**
		 * Default Constructor. Takes an Offset from now
		 * and a runnable that will be executed.
		 *
		 * @param offset	The offset from the current time in milliseconds.
		 * @param what		The runnable to be executed
		 */
	...
	/**
	 * Creates an SnmpTime object and it's internal thread that
	 * is used to schedual the execution of the runnables.
	 *
	 */
	SnmpTimer()
	{
	...
	/**
	 * Cancels the current timer object and 
