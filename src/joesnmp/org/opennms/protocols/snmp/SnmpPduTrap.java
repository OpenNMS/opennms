...
// Tab Size = 8
//
// SnmpPduTrap.java,v 1.1.1.1 2001/11/11 17:27:22 ben Exp
//
//
 ...
 * for an SNMP Trap. The PDU format for a TRAP is not similar
 ...
 *
 */
public class SnmpPduTrap extends Object
	implements	SnmpSyntax, Cloneable
{
	...
	/**
	 * The IP Address of the remote agent sending the
	 * trap.
	 */
	...
	/**
	 * The timestamp for when the trap occured. This
	 * should be the sysUpTime from the remote system.
	 */
	...
	/**
	 * Sets the enterprise identifier for the trap.
	 * The string must be in the format of a dotted
	 * decimal object identifier.
	 *
	 ...
	 *
	 * @param addr	The remote agent's ip address.
	 */
	 ...
	 *
	 * @param generic The new generic code for the trap.
	 */
	 ...
	 *
	 * @param spec The new specific identifier.
	 *
	 */
	 ...
	 *
	 * @param ts The timeticks for the trap.
	 *
	 */
