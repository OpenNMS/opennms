 ...
 * an SnmpSession. The parameters include the read/write community
 ...
 *
 */
public class SnmpParameters extends Object
	implements Cloneable
{
	 ...
	 * The possible values are defined in the SnmpSMI
	 *
	 * @see SnmpSMI#SNMPV1
	 * @see SnmpSMI#SNMPV2
	 */
	...
	/**
	 * The default class constructor. Constructs the object
	 * with the publicly available default values. By default
	 * the write community string is left null.
	 *
	...
	/**
	 * Constructs a copy of the parameters defined in 
	 * the object second.
	 *
	...
	/**
	 * Constructs a default object with the specified
	 ...
	 *
	 * @param read	The read-only community string.
	 *
	 */
	...
	/**
	 * Constructs an object with the specified read-only
	 * and write-only community strings.
	 *
	 * @param read	The read-only community string.
	 * @param write The write-only community string.
	 *
	 */
	...
	/**
	 * Used to set the parameters read community
	 * string. 
	 *
	 * NOTE: The community string is covnerted to a set of
	 *	8-bit characters by the String.getBytes() method.
	 *
	 * @param rd	The new read community string.
	 *
	...
	/**
	 * Used to set the parameters write community
	 * string. The write community string is only
	 * used by SNMP SET packet.
	 *
	 * NOTE: The community string is covnerted to a set of
	 *	8-bit characters by the String.getBytes() method.
	 *
	 * @param wr	The new write community string.
	 *
	 * @see java.lang.String#getBytes()
	 */
	...
	/**
	 * Use to set the SNMP protocol version. The version
	 * should be one of the constants within the SnmpSMI.
	 *
	 * @param ver	The SNMP version protocol to use.
	 *
	 * @see SnmpSMI#SNMPV1
	 * @see SnmpSMI#SNMPV2
	 *
