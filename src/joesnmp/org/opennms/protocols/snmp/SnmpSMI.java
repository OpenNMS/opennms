...
// Tab Size = 8
//
// SnmpSMI.java,v 1.1.1.1 2001/11/11 17:27:22 ben Exp
//
//
...
public class SnmpSMI
{
	 ...
	 * The value is represented as a 32-bit signed integer.
	 *
	...
	/**
	 * A sequence of zero or more octets, where an octet is 
	 * an 8-bit quantity. 
	 *
	...
	/**
	 * A set of values associated with the information objects
	...
	/**
	 * A Null value. Commonly used to where there are several
	 * alternatives but none of them apply. 
	 *
	 ...
	 */
	public static final byte SMI_UNSIGNED32	= (ASN1.APPLICATION | 0x02); // same as gauge
	 ...
	 * starts again.
	 */
	public static final byte SMI_COUNTER64	= (ASN1.APPLICATION | 0x06); // SMIv2 only
	 ...
	 * if the requested object identfier has reached the 
