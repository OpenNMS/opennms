	...
	implements SnmpSyntax, Cloneable, Serializable
{
	...
	/**
	 * Simple class constructor that attempts to parse the passed string
	 ...
	 * 
	 * @throws java.lang.NumberFormatException Thrown if the passed value
	 *	cannot be turned into a valid integer.
	 * @throws java.lang.NullPointerException Thrown if the passed string
	 *	is a null reference.
	 */
