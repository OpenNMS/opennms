...
// Tab Size = 8
//
// SnmpPeer.java,v 1.1.1.1 2001/11/11 17:27:22 ben Exp
//
//
 ...
 * with. The SnmpPeer object is used by the SnmpSession class to
 * define the remote agent.
 *
 * The information includes the peer's port and address. Also included
 * is the number of retries and timeouts that should be used when
 * sending packets to the agent. 
 *
 * @see SnmpSession
 * @see SnmpPeer
 *
 ...
 *
 */
public class SnmpPeer extends Object
	implements Cloneable
{
	...
	/**
	 * The remote port of the agent. By default this 
	 ...
	 * agent to respond. The time is measured
	 * in milliseconds (1/1000th of a second).
	 */
	private int		m_timeout;	// in milliseconds

	/**
	 * The default parameters for communicating with
	 * the agent. These include the read/write
	 * community string and the snmp protocol version.
	 */
	private SnmpParameters	m_params;

	/**
	 * The default remote port. On most systems this is
	 * port 161, the default trap receiver is on port
	 * 162.
	 */
	...
	/**
	 * Class constructor. Constructs a SnmpPeer to the 
	 * passed remote agent.
	 *
	 * @param peer	The remote internet address
	 */
	...
	/**
	 * Class constructor. Constructs a peer object
	 * with the specified internet address and 
	 * port.
	 *
	 * @param peer	The remote agent address
	 * @param port	The snmp port on the remote
	 *
	 */
	...
	/**
	 * Class copy constructor. Constructs a SnmpPeer object
	 * that is identical to the passed SnmpPeer object.
	 *
	 * @param second The peer object to copy.
	 *
	 */
	 ...
	 * the remote agent.
	 *
	 * @param addr	The remote agents internet address
	 *
	 */
	 ...
	 * for communications.
	 *
	 * @param addr	The remote agent's internet address
	 ...
	 *
	 * @param port The remote communication port
	 *
	 */
	 ...
	 * for this peer agent.
	 *
	 * @param retry The new number of retries for the peer
	 *
	 */
