...
public class Interface extends StandardNamedObject
{
	 ...
	 * @param services Services to be set for this interface.
	 */
	 ...
	 * If there is already an interface with name, this method adds a service to 
	 * this found service. Otherwise adds a new interface with service.
	 *
	 * @param name Name of the interface.
	 * @param service Name of the service to be added
	 */
	 ...
	 * with lost time. If there is already an interface with name, 
	 * adds a service depending upon whether it exists or not. 
	 * Otherwise adds a new interface with service.
	 *
	 * @param name Name of the interface.
	 * @param service Name of the service to be added
	 * @param losttime Lost time
	 */
	public Interface(String name, String service, long losttime)
	{
        ...
        /**
         * Constructor that sets the name to interface and adds service and outage
         * with lost time and regained time. If there is already an interface with name,
         * adds a service depending upon whether it exists or not.
         * Otherwise adds a new interface with service.
         *
         * @param name Name of the interface.
         * @param service Name of the service to be added
         * @param losttime Lost time
	 * @param regainedtime Regained Time
         */
	 ...
	 *
	 * @param services Services for this interface to be set.
	 */
	...
	/**
	 * Adds a new service to this interface.
	 * @param service Service name to be added
	 * @param losttime Outage with lost time to be added to service
	 */ 
	public void addService(String service, long losttime)
	{
        ...
        /**
         * Adds a service to this interface with outage having 
	 * lost time and regained time.
