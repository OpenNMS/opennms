...
public class Outage extends Object
{
	 ...
	 *
	 * @param svcLost Time at which the service is lost.
	 */
	 ...
	 *
	 * @param svcLost Time at which the service is lost.
	 * @param svcRegained Time at which the service is regained.
	 */
	 ...
	 * Set the Lost time
	 *
	 * @param losttime Time at which the service is lost.
	 */
	 ...
	 *
	 * @param regainedtime Time at which the service is regained.
	 */
	...
	/**
         * Return the downtime (difference between the regained and lost times)
         * in the last rolling window
         *
	 * @param curTime Time denoting end of rolling window (milliseconds).
	 * @param rollingWindow Rolling Window (milliseconds)
	 *
         * @return the downtime (difference between the regained and lost times)
         * in the last rolling window
	 */
...
//				log.debug("Downtime " + downTime);
                ...
                else
                {
                        ...
                        {
                                if(m_svcRegainedTime < startTime)	// Doesnt lie within rolling window.
                                {
                                        return 0;
