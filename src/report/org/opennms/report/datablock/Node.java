...
public class Node extends StandardNamedObject
{
	 ...
	 *
	 * @param interfaces Interfaces for this node to be set.
	 */
	 ...
	 * Checks if the interface with name intfname exists. If not, adds 
	 * a new interface with name intfname.
	 */
	 ...
	 * adds service to that interface. Otherwise, adds a new interface
	 * with name intfname and service.
	 */
	 ...
	 * @param intfname Interface name
	 * @param service Service name
	 * @param lost Lost time
         * Checks if the interface with name intfname exists. If so,
         * adds service to that interface. Otherwise, adds a new interface
         * with name intfname and service, and adds an outage with losttime as lost.
	 */
	...
	/**
         ...
         * @param service Service name
         * @param lost Lost time
	 * @param regained Regained time.
         * Checks if the interface with name intfname exists. If so,
         * adds service to that interface. Otherwise, adds a new interface
         * with name intfname and service, and adds an outage with losttime 
	 * as lost and regained time as regained.	 
	 */
