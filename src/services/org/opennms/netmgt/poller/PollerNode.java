 ...
 * 
 */
public class PollerNode extends PollerContainer {
    /**
     * nodeId
     */
    ...
    public PollerInterface findInterface(String ipAddress) {
        return (PollerInterface) findMember(ipAddress);
    }

    public synchronized void removeInterface(PollerInterface pInterface) {
    ...
    public synchronized PollStatus poll(PollerService pSvc) {
        ...
        PollerInterface pInterface = pSvc.getInterface();
    ...
    private PollStatus pollRemainingInterfaces(PollerInterface pInterface) {
    ...
    private PollStatus pollInterface(PollerInterface pIf) {
        ...
        if (critSvcName != null && pIf.supportsService(critSvcName)) {
            ...
            svc = (PollerService) pIf.getServices().iterator().next();
        }
        return pIf.poll(svc);
    }
