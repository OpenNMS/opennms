 ...
 * of the FTP service on remote interfaces. The class implements the ServiceMonitor interface
...
final class FtpMonitor extends IPv4LatencyMonitor {
    ...
    /**
     * Specific error message generated by some FTP servers when a QUIT is issued by a client
     * when the client has not successfully logged in.
     */
    ...
    /**
     * Used to check for a multiline response. A multline response begins with the same 3 digit
     * response code, but has a hypen after the last number instead of a space.
     */
    private static RE MULTILINE = null;

    /**
     * Used to check for the end of a multiline response. The end of a multiline response is
     * the same 3 digit response code followed by a space
     */
