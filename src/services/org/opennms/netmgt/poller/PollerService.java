 ...
 * 
 */
final class PollerService extends PollerElement {
    /**
     * interface that this service belongs to
     */
    private PollerInterface m_pInterface;
     ...
     * 
     */
    PollerService(PollerInterface pInterface, ServiceConfig svcConfig, PollStatus status, Date svcLostDate) {
        super(status);
    ...
    public boolean equals(Object aService) {
        ...
        if (aService instanceof PollerService) {
            PollerService temp = (PollerService) aService;
...
//        }
    ...
    public PollerInterface getInterface() {
        return m_pInterface;
    }
