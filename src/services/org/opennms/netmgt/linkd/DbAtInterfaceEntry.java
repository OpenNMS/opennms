...
final class DbAtInterfaceEntry {
	...
	private void insert(Connection c) throws SQLException {
		...
		if (log.isDebugEnabled())
			log.debug("AtInterfaceEntry.insert: SQL insert statement = "
				+ stmt.toString());
		...
		if (log.isDebugEnabled())
			log.debug("AtInterfaceEntry.insert: SQL update result = " + rc);
	...
	private void update(Connection c) throws SQLException {
		...
		stmt.setString(ndx++, m_ipaddr);
		if (log.isDebugEnabled())
			log.debug("AtInterfaceEntry.update: SQL update statement = "
				+ stmt.toString());
		...
		int rc = stmt.executeUpdate();
		if (log.isDebugEnabled())
			log.debug("AtInterfaceEntry.update: update result = " + rc);
		stmt.close();
	...
	private boolean load(Connection c) throws SQLException {
		...
		if (log.isDebugEnabled())
			log.debug("AtInterfaceEntry.load: SQL load statement = "
				+ stmt.toString());
