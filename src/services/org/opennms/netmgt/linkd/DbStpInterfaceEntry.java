...
public class DbStpInterfaceEntry {
	...
	private void insert(Connection c) throws SQLException {
		...
		if (log.isDebugEnabled())
			log.debug("StpInterfaceEntry.insert: SQL insert statment = "
				+ names.toString());
		...
		if (log.isDebugEnabled())
			log.debug("StpInterfaceEntry.insert: SQL insert statement = "
				+ stmt.toString());
		...
		if (log.isDebugEnabled())
			log.debug("StpInterfaceEntry.insert: SQL update result = " + rc);
		stmt.close();
	...
	private void update(Connection c) throws SQLException {
		...
		if (log.isDebugEnabled())
			log.debug("StpInterfaceEntry.update: SQL update statment = "
				+ sqlText.toString());
		...
		if (log.isDebugEnabled())
			log.debug("StpInterfaceEntry.update: update SQL = " + stmt.toString());

		// Run the insert
		//
		int rc = stmt.executeUpdate();
		if (log.isDebugEnabled())
			log.debug("StpInterfaceEntry.update: update result = " + rc);
		stmt.close();
	...
	private boolean load(Connection c) throws SQLException {
		...
		if (log.isDebugEnabled())
			log.debug("StpInterfaceEntry.load: SQL load statement = "
				+ stmt.toString());
