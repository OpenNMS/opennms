	...
	int     m_nodeId;
		...
		private void insert(Connection c) throws SQLException {
			...
			StringBuffer names = new StringBuffer(
					"INSERT INTO DataLinkInterface (nodeid,ifindex");
			...
			log.debug("DataLinkInterfaceEntry.insert: SQL insert statment = "
					+ names.toString());
			...
			if (log.isDebugEnabled())
				log.debug("DataLinkInterfaceEntry.insert: SQL insert statement = "
					+ stmt.toString());
			...
			if (log.isDebugEnabled())
				log.debug("DataLinkInterfaceEntry.insert: SQL update result = " + rc);
			stmt.close();
		...
		private void update(Connection c) throws SQLException {
			...
			if (log.isDebugEnabled())
				log.debug("DataLinkInterfaceEntry.update: SQL update statment = "
					+ sqlText.toString());
			...
			if (log.isDebugEnabled())
				log.debug("DataLinkInterfaceEntry.update: SQL update statement = "
					+ stmt.toString());
			...
			int rc = stmt.executeUpdate();
			if (log.isDebugEnabled())
				log.debug("DataLinkInterfaceEntry.update: update result = " + rc);
			stmt.close();
		...
		private boolean load(Connection c) throws SQLException {
			...
			if (log.isDebugEnabled())
				log.debug("DataLinkInterfaceEntry.load: SQL load statement = "
					+ stmt.toString());
