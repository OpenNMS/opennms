...
final class DbIpRouteInterfaceEntry {
	...
	private void insert(Connection c) throws SQLException {
		...
		if (log.isDebugEnabled())
			log.debug("AtInterfaceEntry.insert: SQL insert statment = "
				+ names.toString());
		...
		if (log.isDebugEnabled())
			log.debug("IpRouteInterfaceEntry.insert: SQL insert statement = "
				+ stmt.toString());
		...
		if (log.isDebugEnabled())
			log.debug("IpRouteInterfaceEntry.insert: SQL update result = " + rc);
		stmt.close();
	...
	private void update(Connection c) throws SQLException {
		...
		if (log.isDebugEnabled())
			log.debug("AtInterfaceEntry.update: SQL update statment = "
				+ sqlText.toString());
		...
		if (log.isDebugEnabled())
			log.debug("IpRouteInterfaceEntry.update: SQL update statement = "
				+ stmt.toString());
		...
		int rc = stmt.executeUpdate();
		if (log.isDebugEnabled())
			log.debug("IpRouteInterfaceEntry.update: update result = " + rc);
		stmt.close();
	...
	private boolean load(Connection c) throws SQLException {
		...
		if (log.isDebugEnabled())
			log.debug("IpRouteInterfaceEntry.load: SQL load statement = "
				+ stmt.toString());
