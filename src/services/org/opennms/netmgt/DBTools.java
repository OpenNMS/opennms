...
/**
 * This class is intended to be group some utility classes
 * related with RDBMS and the capsd and monitoring plugins.
...
public class DBTools {
 ...
 public static final String JDBC_HOST = "OPENNMS_JDBC_HOSTNAME";
  ...
  /**
   * Default port to use to check this service. Defaults to '4100'
   * Make sure than is less than MAX_PORT_VALUE and greather than MIN_PORT_VALUE
   * @see #MIN_PORT_VALUE
   * @see #MAX_PORT_VALUE
   */
  ...
  /**
   * Default database password. Should be empty. You should not put
   * a database password here (or event worst, harcode it in the code)
   * Instead call the class method that accepts a map
   */
  ...
  /**
   * Returns a single instance of this class to the caller. We do not want multplie copies
   * of this class loaded, just one.
   ...
   */
    ...
    */
   public int getNumberOfInstances() { return _counter; };
