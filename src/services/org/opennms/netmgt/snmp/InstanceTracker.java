...
public abstract class InstanceTracker  {
    ...
    /**
     * Call this to indicate to the tracker that an error has occurred while retrieving
     * the last returned oid.
     */
    public abstract void errorOccurred();


    /**
     * This notifies the tracker that the last request returned endOfMib.
     */
    public abstract void receivedEndOFMib();
    
    /**
     * 
     */
    public static InstanceTracker get(SnmpObjId base, String instances) {
        if (SnmpCollectionTracker.COLUMN.equals(instances)) {
