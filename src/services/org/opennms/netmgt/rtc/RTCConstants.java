...
{
	/**
	 * The value returned by RTC if a nodeid/ip/svc tuple
	 * does not belong to a category.
	 */
	public static double	NODE_NOT_IN_CATEGORY =-1.0;

	/**
	 * The base name of the eventd configuration file. This does
	 * not include any path information about the location of the 
	 * file, just the filename itself.
	 */
	...
	/**
	 * The SQL statement necessary to convert the service name
	 * into a service id using the 'service' table.
	 */
	public final static String 	SQL_DB_SVCNAME_TO_SVCID	= "SELECT serviceID FROM service WHERE serviceName = ?";

	/**
	 * The sql statement that is used to get node information for 
	 * an IP address.
	 */
	...
	/**
	 * The sql statement that is used to get services information 
	 * for a nodeid/IP address.
	 */
	...
	/**
	 * The sql statement for getting outage entries for a 
	 * nodeid/ip/serviceid.
	 */
