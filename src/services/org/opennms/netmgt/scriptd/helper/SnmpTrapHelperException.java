 ...
 * If the described exception was caused by some other exception (e.g. an exception
 * associated with the JoeSNMP library), that exception will be included as the
 * "cause". The getMessage and printStackTrace methods are overridden, in order
 * to describe the "cause" exception, where present.
 *
...
public class SnmpTrapHelperException extends Exception
{
   ...
   *
   * @param  message  The message to be associated with the exception.
   * @param  cause    The cause exception to be associated with the exception. 
   */  
  ...
  /**
   * Get the message associated with this exception. If this exception has 
   * an associated cause exception, the message associated with the cause exception
   * is appended.
   *
   ...
   * If this exception has an associated cause exception, the stack trace associated 
   * with the cause exception is printed.
   *
   * @param  ps  The print steam to which the stack trace should be printed.
   */  
   ...
   * with the cause exception is printed.
   *
   * @param  pw  The print writer to which the stack trace should be printed.
   */  
