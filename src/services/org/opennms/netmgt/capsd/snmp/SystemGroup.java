 ...
 */
public final class SystemGroup extends java.util.TreeMap
	implements SnmpHandler
{
	...
	static
	{
		...
		/**
	 	 * <P>A description of the remote entity. For example this
	 	 * may include hardware,  opererating system, and various
	 	 * version information. This should be a US-ASCII display
	 	 * string.</P>
	 	 */
		ms_elemList[ndx++] = new NamedSnmpVar(NamedSnmpVar.SNMPOCTETSTRING, SYS_DESCR, ".1.3.6.1.2.1.1.1");

		/**
	 	 * <P>The vendor's authoritative identification of the
	 	 * network management subsystem. This can often be used
	 	 * to identify the vendor, and often times the specific
	 	 * vendor's hardware platform.</P>
	 	 */
		ms_elemList[ndx++] = new NamedSnmpVar(NamedSnmpVar.SNMPOBJECTID, SYS_OBJECTID, ".1.3.6.1.2.1.1.2");


		/**
	 	 * <P>The time since the network management portion of
	 	 * the system was last initialized. This will be in
	 	 * 1/100th of a second increments.</P>
	 	 */
		ms_elemList[ndx++] = new NamedSnmpVar(NamedSnmpVar.SNMPTIMETICKS, SYS_UPTIME, ".1.3.6.1.2.1.1.3");

		/**
	 	 * <P>The identification and contact information for the
	 	 * person that is managing this node. While the contact
	 	 * information is often used to store contact information
	 	 * about the person managing the node, it is a free form
	 	 * US-ASCII field that may contain additional information
	 	 * depending on the environment.</P>
	 	 */
		ms_elemList[ndx++] = new NamedSnmpVar(NamedSnmpVar.SNMPOCTETSTRING, SYS_CONTACT, ".1.3.6.1.2.1.1.4");

		/** 
	 	 * <P>The administratively assigned name for this particular
	 	 * node. This may often be the same as the hostname, but it
	 	 * can differ depending on the site's implementation.</P>
	 	 */
		ms_elemList[ndx++] = new NamedSnmpVar(NamedSnmpVar.SNMPOCTETSTRING, SYS_NAME, ".1.3.6.1.2.1.1.5");

		/**
	 	 * <P>The physical location of the node. This field, like
	 	 * many others, is a free formed US-ASCII field that can
	 	 * contain any type of location string. Some sites might 
	 	 * acutually use a special encoding that designates the
	 	 * state, city, building, floor, and room that contains
	 	 * the equipment.</P>
	 	 */
		ms_elemList[ndx++] = new NamedSnmpVar(NamedSnmpVar.SNMPOCTETSTRING, SYS_LOCATION, ".1.3.6.1.2.1.1.6");

		/**
	 	 * <P>A value that indicates the set of services that
	 	 * this entity provides. This is a bit encode integer
	 	 * that allows the management entity to determ if the
	 	 * agent supports the following standards</P>
	 	 *
	 	 * <UL>
	 	 ...
	 	 * </UL>
	 	 *
	 	 * <P>To get more information about the encoding see
	 	 * Page 123 of "SNMP, SNMPv2, SNMPv3 and RMON 1 and 2 3rd Ed."
	 	 * by William Stallings [ISBN 0-201-48534-6]</P>
	 	 */
		//ms_elemList[ndx++] = new NamedSnmpVar(NamedSnmpVar.SNMPINT32, "sysServices", ".1.3.6.1.2.1.1.7");
	}
