 ...
 * information for one entry in the ipAddrTable. The table effectively
 * contains a list of these entries, each entry having information
 * about one address. The entry contains an IP Address, its netmask,
 * interface binding, broadcast address, and maximum packet 
 * reassembly size.</P>
 *
 * <P>This object is used by the IpAddrTable to hold infomation
 * single entries in the table. See the IpAddrTable documentation
	...
	extends java.util.TreeMap
{
	...
	static
	{
		...
		//ms_elemList[ndx++] = new NamedSnmpVar(NamedSnmpVar.SNMPINT32,		IP_ADDR_ENT_REASM_MAXSIZE, ".1.3.6.1.2.1.4.20.1.5",	5);
	}
	 ...
	 */
	public static final String	TABLE_OID	= ".1.3.6.1.2.1.4.20.1";	// start of table (GETNEXT)
	...
	/**
	 * <P>Creates a default instance of the IP Address
	 * table entry map. The map represents a singular
	 * instance of the address table. Each column in
	...
	/** 
	 * <P>Returns the number of entries in the MIB-II ipAddrTable element list.</P>
	 */
