 ...
 * interface extensions table. It implements the SnmpHandler to receive notifications
...
public final class IfXTable implements SnmpHandler
{
	...
	/**
	 * <P>The list of interfaces from the remote's interface extensions table.
	 * The list contains a set of IfXTableEntry objects that were
	...
	*/
	...
	/**
	 * <P>Constructs an IfXTable object that is used to collect
	 ...
	 * information about the interface extensions table.</P>
	 *
