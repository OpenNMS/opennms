...
public final class IfXTableEntry {
     ...
     * represents a singular instance of the interface extensions table. Each
     * column in the table for the loaded instance may be retreived either
     * through its name or object identifier.
     * </P>
     * 
     * <P>
     ...
     * single varbind -- the ifXTable root oid. The PDU can then be used to
     * perform an <EM>SNMP walk</EM> of the MIB-II interface extensions table
     * on remote host via SNMPv2 GETBULK REQUESTS.
     * </P>
     * 
