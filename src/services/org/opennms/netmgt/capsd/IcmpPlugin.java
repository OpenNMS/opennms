 ...
 * on new interfaces as them are passed into the system. In order to
 * minimize the number of sockets and threads, this class creates a 
	...
	extends AbstractPlugin
{
	...
	/**
	 * This method is used to ping a remote host to test for ICMP 
	 * support. If the remote host responds within the specified
	 * period, defined by retries and timeouts, then a value of true
	 * is returned to the caller.
	 *
	 * @param ipv4Addr	The address to poll.
