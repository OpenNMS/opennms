...
/**
 * This plugin is used to check a host for DNS (Domain Name
 * Server) support. This is done by contacting the specified host
 * and requesting the default address or <em>localhost</em>. If
 * a valid resposne is returned then the server is considered
 * a DNS server.
 *
