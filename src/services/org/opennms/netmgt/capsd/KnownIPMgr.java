...
final class KnownIPMgr
{
	...
	/**
	 * The SQL statment used to update the last capabilities
	 * check time.
	 */
	...
	/**
	 * This class is used to encapsulate the elements of importants
	 * from the IP interface table in the OpenNMS database. The main
	...
	final static class IPInterface
	{
		...
		/**
		 * The last date that the interface was 
		...
		/**
		 * Constructs a new instance to represent 
		 * the IP interface.
		 *
		 ...
		 */
		IPInterface(InetAddress iface, int nodeid, String date)
		...
		/**
		 * Returns the data on which the interface
		 * was last checked.
		 */
		...
		/**
		 * Updates the the last check time in the database
		 * to match the time encapsulated in this instance.
		 *
	 ...
	 *
	 * @throws java.util.MissingResourceException Thrown if the method cannot
	 ...
	 *
	 */
	static boolean isKnown(String ipAddr)
	 ...
	 * 	be converted.
	 */
	static boolean addKnown(String addr)
		throws UnknownHostException
	{
	...
	/**
	 * Returns the current snapshot set of all the known internet
	 * addresses in the set of known nodes.
	 *
