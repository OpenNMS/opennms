		...
		for (int attempts=0; attempts <= retries && !isAServer; attempts++)
		{
			...
			catch(IOException e)
			{
				...
				isAServer = false;
                        ...
                        {
                                log.warn("SshPlugin: thread interrupted while testing host " + host.getHostAddress(), e);
                                isAServer = false;
                                break;
                        }
			catch(Throwable t)
			{
				isAServer = false;
				log.warn("SshPlugin: An undeclared throwable exception was caught connecting to host " + host.getHostAddress()
					 + " on port " + port, t);
			}
			finally
			{
