        ...
        for (int attempts = 0; attempts <= retries && !isAServer; attempts++) {
            ...
            try {
                ...
                if (regex == null) {
                    ...
                    // the bannerMatch parameter to determine if this interface supports the
                    // service.
                    //
                ...
                isAServer = false;
                log.warn("TcpPlugin: An undeclared throwable exception was caught connecting to host " + host.getHostAddress() + " on port " + port,
                        t);
            } finally {
                try {
