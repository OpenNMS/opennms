 ...
 *
 */
public class ExtendedEventConstants
{
	/**
	...
	//
	// the eventUEIs used by IA OpenNMS
	//
	
	/**
	 * Inventory download failure event uei
	 */
	public final static String INVENTORY_FAILURE_EVENT_UEI = "uei.opennms.org/internal/inventory/Failure";
	
	/**
	 * Inventory download success event uei
	 */
	public final static String INVENTORY_SUCCESS_EVENT_UEI = "uei.opennms.org/internal/inventory/Success";
	
	/**
	 * Inventory configuration change event uei
	 */
	public final static String CONFIGURATION_CHANGED_EVENT_UEI = "uei.opennms.org/internal/inventory/configurationChanged";
	
	
	//
	// end IA OpenNMS's eventUEIs
	//
