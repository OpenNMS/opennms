...
/** 
 * <P>This exception is generated by a service monitor when the 
 * inventory framework passes the interface to the monitor. If the 
 * monitor does not support the interface type an exception of
