...
/**
 * This class holds all OpenNMS related constants - has the property names to be read
 * from the config files, the various config file names etc.
 *
...
{
	/**
	 * The property string in the properties file to get the XML 
	 * configuration files
	 */
	...
	/**
	 * The property string in the properties file which specifies the method to use
	 * for determining which interface is primary on a multi-interface box.
	 */
	...
	/**
	 * This is just a convience method that forwards the lookup of the 
	 * property to the {@link java.lang.System System} class. This method
	 * may be modified in the furture to search additional property locations
	 * for the properties defined in this class.
	 *
	 * @param property	The property key used to lookup the result.
	 *
