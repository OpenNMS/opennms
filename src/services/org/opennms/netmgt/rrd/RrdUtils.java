...
/**
 * Provides static methods for interacting with round robin files.  Supports JNI and JRobin
 * based files and provides queuing for managing differences in collection speed and
 * disk write speed.  This behaviour is implemented using the Strategy pattern with a
 * different RrdStrategy for JRobin and JNI as well as a Strategy that provides
 * Queueing on top of either one.
 * 
...
public class RrdUtils {
    ...
    /**
     * Create a round robin database file.   See the man page for rrdtool create for 
     ...
     */
    public static boolean createRRD(String creator, String directory, String dsName, int step, String dsType, int dsHeartbeat, String dsMin,
            String dsMax, List rraList) throws RrdException {
     ...
     * @param dsName the datasource name for file. (Also becames the basename of the file)
     * @param val the value to be stored.  This should be a string representation of a number
     * @throws RrdException 
     */
    public static void updateRRD(String owner, String repositoryDir, String dsName, String val) throws RrdException {
        ...
        if (log.isDebugEnabled()) log.debug("updateRRD:updating RRD file: "+rrdFile+" with value: "+updateVal);
    ...
    /**
     * This method issues an round robin fetch command to retrieve the
     * last value of the datasource stored in the specified RRD file. The retrieved value
