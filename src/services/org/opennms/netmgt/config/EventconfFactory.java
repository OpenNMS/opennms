...
public class EventconfFactory
{
	...
	*/
	...
	/**
	 * @deprecated This function is not implemented completely. It will
	 * not perform as expected. When it is implemented, remove this
	 * deprecation tag.
	 */
	...
	*/
	...
	/**
	*/
	public synchronized void removeEvents(String uei)
	...
	/**
	*/
	public synchronized void removeEvent(String uei, Mask mask)
                throws MarshalException, IOException, ValidationException
	{
		List events = getEvents(uei);
