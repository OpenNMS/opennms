 ...
 * configuration from the opennms-database.xml. This provides
 * convenience methods to create database connections to the
 * database configured in this default xml</p>
 *
...
public final class DatabaseConnectionFactory
{
	...
	/**
	 * The linked list of cached connections that are reused
	 * if the garbage collector has not finalized them yet.
	 */
	private LinkedList		m_dbcCache = null;

	/**
	 * This class is used to represent a cached database connection
	 * within this factory. The cached connection may or may not have
	 * been collected by the main java garbage collector thread. If the
		...
		implements Connection
	{
		...
		/**
		 * This flag is set to true if the connection is
		 * currently in use.
		 */
		private boolean 			m_inUse;

		/**
		 * This flag is set to true if the connection 
		 * experienced an error.
		 */
		private boolean 			m_hadError;

		/**
		 * This value is used to mark the last time
		 * the connection was returned to the pool.
		 * If the last use reaches a certian time and
		 * the connection is on the bottom of the 
		 * stack, then it is released. This time is 
		 * set via the system time.
		 *
		...
		/**
		 * The class constructor used to create a new cached
		 * connection for a particular factory.
		 *
		 * @param dbc	The database connection to cache.
		 * @param owner The owner of the cached connection.
		 *
		 */
		...
		/**
		 * This method checks the access of the connection. If the
		 * connection is not marked <em>in use</em> then access
		 * is denied via an exception.
		 *
		 * @throws java.sql.SQLException Thrown if access is denied.
		 */
		...
		/**
		 * Returns the current age of the connection since it was
		 * last used in milliseconds. The time is based upon the
		 * last time the connection was returned to the database
		 * pool. If the connection is kept in use then the value
		 * returned by this method is of no value.
		 *
		...
		/**
		 * Forwards the request to the encapsulated connection
		 * after access to the connection is granted.
		 *
		 * @throws java.sql.SQLException May be thrown by the encapsulated connection
		 */
	 ...
	 */
	private DatabaseConnectionFactory(String configFile)
		throws 	IOException,
		        MarshalException, 
			ValidationException,
	...
	/**
	 * <p>Return the singleton instance of this factory. This is the
	 * instance of the factory that was last created when the <code>
	 * init</code> or <code>reload</code> method was invoked. The
	 * instance will not change unless a <code>reload</code> method
	 * is invoked.</p>
	 *
	...
	/**
	 * Return a new database connection to the database configured in
	 * the <tt>opennms-database.xml</tt>. The database connection is 
	 * not managed by the factory and must be release by the caller
	 * by using the <code>close</code> method.
	 *
	 * @return a new database connection to the database configured
	 *         in the <tt>opennms-database.xml</tt>
	 *
	 * @throws java.sql.SQLException	Thrown if there is an error opening
