...
public class KSC_PerformanceReportFactory
{
	...
	private static long m_lastModified;
        ...
        public final String[] timespan_options = {"1_hour", "8_hour", "1_day", "7_day", "1_month", "6_month", "1_year", "Today", 
            "Yesterday", "This Week", "Last Week", "This Month", "Last Month", "This Quarter", "Last Quarter", "This Year", "Last Year"};
	...
	public static ReportsList getConfiguration() 
	{
        ...
        public void deleteReportAndSave(int index) 
                throws ArrayIndexOutOfBoundsException, IOException, FileNotFoundException, MarshalException, ValidationException
        { 
        ...
        { 
            // Create a new and unique instance of the report for screwing around with
            StringWriter stringWriter = new StringWriter();
