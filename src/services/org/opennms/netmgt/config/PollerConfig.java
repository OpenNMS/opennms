...
public interface PollerConfig {
	 ...
	 *	false otherwise.
	 */
	public abstract boolean interfaceInPackage(String iface,
	 ...
	 */
	public abstract boolean serviceInPackageAndEnabled(String svcName,
			org.opennms.netmgt.config.poller.Package pkg);
	 ...
	 */
	public abstract org.opennms.netmgt.config.poller.Package getFirstPackageMatch(
			String ipaddr);
	 ...
	 */
	public abstract boolean isPolled(String svcName,
			org.opennms.netmgt.config.poller.Package pkg);
