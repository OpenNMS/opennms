...
public class SnmpEventInfoTest extends TestCase {
     ...
     */
    public final void testModifySpecificInDef() throws MarshalException, ValidationException, UnknownHostException {
        ...
        MergeableDefinition configDef = new MergeableDefinition(SnmpPeerFactory.getConfig().getDefinition(0));
...
//      System.err.println(config);
        ...
        assertEquals(SnmpPeerFactory.toLong(InetAddress.getByName("192.168.0.5")), SnmpPeerFactory.toLong(InetAddress.getByName(matchingDef.getConfigDef().getSpecific(0))));
        assertEquals("abc", matchingDef.getConfigDef().getReadCommunity());
        assertEquals(1, SnmpPeerFactory.getConfig().getDefinitionCount());
    }
     ...
     * @throws UnknownHostException
     */
    public final void testAddAdjacentSpecificToDef() throws MarshalException, ValidationException, UnknownHostException {
...
//      System.err.println(config);
     ...
     * @throws UnknownHostException
     */
    public void testSplitRange() throws MarshalException, ValidationException, UnknownHostException {
...
//        System.err.println(config);
     ...
     * @throws UnknownHostException
     */
    public void testRemoveSpecificFromRange() throws MarshalException, ValidationException, UnknownHostException {
...
//        System.err.println(config);
     ...
     * @throws UnknownHostException
     */
    public void testRecombineSpecificIntoRange() throws MarshalException, ValidationException, UnknownHostException {
...
//        System.err.println(config);
     ...
     * @throws UnknownHostException
     */
    public void testRemoveSpecificInSeparateDefWithNewRange() throws MarshalException, ValidationException, UnknownHostException {
...
//        System.err.println(config);
     ...
     * @throws UnknownHostException
     */
    public void testInvalidRange() throws MarshalException, ValidationException, UnknownHostException {
        String snmpConfigXml = "<?xml version=\"1.0\"?>\n" + 
        "<snmp-config retry=\"3\" timeout=\"800\"\n" + 
        "   read-community=\"public\" write-community=\"private\">\n" + 
        "   <definition version=\"v2c\">\n" + 
     ...
     * @throws UnknownHostException
     */
    public void testNewSpecifcSameAsBeginInOldDef() throws MarshalException, ValidationException, UnknownHostException {
        String snmpConfigXml = "<?xml version=\"1.0\"?>\n" + 
        "<snmp-config retry=\"3\" timeout=\"800\"\n" + 
        "   read-community=\"public\" write-community=\"private\">\n" + 
        "   <definition version=\"v2c\">\n" + 
...
//        System.err.println(config);
     ...
     * @throws UnknownHostException
     */
    public void testOverlapsTwoRanges() throws MarshalException, ValidationException, UnknownHostException {
...
//        System.err.println(config);
     ...
     * @throws UnknownHostException
     */
    public void testRecombineRanges() throws MarshalException, ValidationException, UnknownHostException {
...
//        System.err.println(config);
     ...
     * @throws UnknownHostException
     */
    public void testRecombineRangesNonAdjacentRange() throws MarshalException, ValidationException, UnknownHostException {
...
//        System.err.println(config);
     ...
     * @throws UnknownHostException
     */
    public final void testAddNewSpecificToConfig() throws MarshalException, ValidationException, UnknownHostException {
...
//      System.err.println(config);
        ...
        assertEquals(2, SnmpPeerFactory.getConfig().getDefinitionCount());
     ...
     * @throws MarshalException 
     */
    public final void testOptimizeAllDefs() throws UnknownHostException, MarshalException, ValidationException {
        ...
        SnmpConfig SnmpConfig = SnmpPeerFactory.getConfig();
