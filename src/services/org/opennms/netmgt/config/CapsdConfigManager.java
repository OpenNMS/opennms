...
public abstract class CapsdConfigManager implements CapsdConfig {
    ...
    /**
         ...
         * </P>
         */
        static protected final class LightWeightIfEntry {
            /**
    ...
    protected void loadXml(Reader rdr) throws MarshalException, ValidationException {
        m_config = (CapsdConfiguration) Unmarshaller.unmarshal(CapsdConfiguration.class, rdr);
        finishConstruction();
    }
    ...
    public ProtocolPlugin getProtocolPlugin(String svcName) {
        Enumeration e = m_config.enumerateProtocolPlugin();
        while(e.hasMoreElements()) {
	 ...
	 */
	InetAddress compareAndSelectPrimaryCollectionInterface(
			String svcName, InetAddress currentIf, InetAddress oldPrimary, String method, boolean strict) {
