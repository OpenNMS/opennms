...
public final class VulnscandConfigFactory
{
	...
	*/
	private VulnscandConfigFactory(String configFile)
		throws 	IOException,
			MarshalException,
			ValidationException
	{
	...
	*
	*/
	public static boolean isInterfaceInDB(Connection dbConn, InetAddress ifAddress)
		throws SQLException
	{
	...
	*
	*/
	public static int getInterfaceDbNodeId(Connection dbConn, InetAddress ifAddress)
		throws SQLException
	{
		Category log = ThreadCategory.getInstance(VulnscandConfigFactory.class);
