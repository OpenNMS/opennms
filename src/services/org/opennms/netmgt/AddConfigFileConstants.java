 ...
 */
public final class AddConfigFileConstants
{
	private static final String[] FILE_ID_TO_NAME;

	/**
	 * The cosimonms inventory config file
	 */
	...
	public static final File getFile(int id)
		throws IOException
	{
		Category log = ThreadCategory.getInstance(AddConfigFileConstants.class);
	...
	public static final String getHome()
	{
		...
		if(home == null)
		{
			ThreadCategory.getInstance(AddConfigFileConstants.class).warn("getConfigFileByName: The \"opennms.home\" property was not set, falling back to /opt/OpenNMS");
