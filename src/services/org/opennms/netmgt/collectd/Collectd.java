	...
	implements PausableFiber
{
	...
	/**
	 * Map of all available ServiceCollector objects indexed by 
	 * service name
	 */
	...
	/**
	 * Returns the loaded ServiceCollector for the specified
	 * service name.
	 * 
	 * @param svcName	Service name to lookup.
	 * 
	 * @return ServiceCollector responsible for performing data
	 * 	collection on the specified service.
	 */
