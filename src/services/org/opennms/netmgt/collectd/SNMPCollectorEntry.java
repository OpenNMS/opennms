 ...
 * collected data pertaining to a particular interface.</P>
 * 
 *<P>An instance of this class is created by calling the 
 * constructor and passing a list of SnmpVarBind objects
 * from an SNMP PDU response.  This class extends 
 * java.util.TreeMap which is used to store each of the
 * collected data points indexed by object identifier.</P>
 *
...
{
        /**
	 * The list of MIBObjects that will used for associating the
         * the data within the map.
	 */
        private java.util.List m_objList;

        /** 
	 * Key that will be used in the map for returning the ifIndex of
         * particular interface.
	 */
        public static final String IF_INDEX = "ifIndex";
        
	/**
	 * <P>Creates a default instance of the SNMPCollector
	 *  entry map. The map represents a singular
	 *  instance from the MibObject. Each column in
	 *  the table for the loaded instance may be retrieved
	 *  through its OID from the MIBObject.</P>
	 *
	 ...
	 *
	 * @param vars		The array of collected SNMP variable bindings
	 * @param objList	List of MibObject objects representing each of
	 *                      of the oid's configured for collection.
	 * @param ifIndex	The ifIndex (as a String) of the interface for
	 *                      which the collected SNMP data is relevant.
    	 * 		  	NOTE:  NULL if the collected SNMP data is for
	 * 			       the node.	
	 */
	public SNMPCollectorEntry(SnmpVarBind[] vars, List objList, String ifIndex)
	{
        ...
        /**
	 * <P>This method is used to update this entry's map
	 ...
	 *
	 * @param vars	Array of SnmpVarBind objects containing all the
	 *              SNMP data collected for a particular interface.
	 * @param ifIndex	The ifIndex (as a String) of the interface for
	 *                      which the collected SNMP data is relevant.
	 *
	 */
