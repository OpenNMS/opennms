 ...
 * which is actively being collected by the collectd scheduler.  When 
 * associated with a SnmpCollector object the updates represented 
 * by the class are to be applied to the SnmpCollector AFTER being 
 ...
 * to the SnmpCollector objects at the time that a particular
 * event is received by the BroadcastEventProcessor class...the 
 * interface may in fact be in the process of being collected.  So 
 * we make "note" of the updates using this class and wait for the
 * collector object to be popped from the interval queues before 
...
final class CollectorUpdates
{
	 ...
	 * deletion and should no longer be polled or
	 * rescheduled.
	 */
