 ...
 * the file named <tt>eventconf.xml</tt>. The file must be in the 
 * applications searched classpaths in order to be loaded when
 * the class is loaded.</p>
 *
 * <p>Once the class is constructed it is possible to reconfigure or
...
public final class EventConfigurationManager
{
	...
	/**
	 * This method is used to load the passed configuration into
	 * the currently managed configuration instance. Any events 
	 * that previously existed are cleared.
	 *
	 ...
	 * @exception java.lang.IOException Thrown if the file cannot be
	 * 	opened for reading.
	 */
	 ...
	 * This method is used to load the passed configuration into
	 * the currently managed configuration instance. Any events 
	 * that previously existed are cleared. After the contents of
	 * the reader stream is loaded the stream is closed.
	 *
	 * @param rdr	The reader used to load the configuration.
	 *
	 * @exception org.exolab.castor.xml.MarshalException Thrown if the 
	 * 	file does not conform to the schema.
	 * @exception org.exolab.castor.xml.ValidationException Thrown if 
	 ...
	 * This method is used to load the passed configuration into
	 * the currently managed configuration instance. Any events 
	 * that previously existed are overwritten by the new events
	 * in this configuration. This call will replace the current
	 * override settings.
	 *
	 ...
	 * 	opened for reading.
	 */
	public static void mergeConfiguration(String file)
		throws 	IOException,
			MarshalException,
			ValidationException
	{
	 ...
	 * that previously existed are overwritten by the new events
	 * in this configuration. This call will replace the current
	 * override settings. After the contents of the reader 
	 ...
	 *
	 */
	public static void mergeConfiguration(Reader rdr)
	...
	/**
	 * Returns the matching event configuration instance
	 * that is indexed by the passed UEI. This is an instance
	 * of the <code>Event</code> that was loaded from the 
	...
	/**
	 * Returns the matching event configuration instance
	 * that is indexed by the SNMP enterprise identifier.
	 * This is an instance of the <code>Event</code> that 
	 * was loaded from the event configuration file.
	 *
	...
	/**
	 * Returns the matching event configuration instance
	 * for the event that just came in. This is an instance
	 * of the <code>Event</code> that was loaded from the
	 * event configuration file.
	 *
