	...
	implements EventIpcManager
{
	...
	/**
	 * A thread dedicated to each listener. The events meant for each
	 * listener is added to a dedicated queue when the 'sendNow()' is
	 * called. The ListenerThread reads events off of this queue and 
	 * sends it to the appropriate listener
	 */
