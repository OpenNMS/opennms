 ...
 * values changed, hashcode is re-evaluated)</pre>
 *
...
public class EventKey extends LinkedHashMap implements Serializable, Comparable
{
	 ...
	 * Constructor for this class
	 *
	 * @param	maskelements	the maskelements that should form this key
	 */
	 ...
	 * Constructor for this class
	 *
	 * @param	event	the config event that this will be the key for
	 */
	public EventKey(org.opennms.netmgt.xml.eventconf.Event event)
	{
		...
		else
		{
			...
			while(enum.hasMoreElements())
			{
				...
				//List value = new EventMaskValueList(Arrays.asList(maskelement.getMevalue()));
	 ...
	 * Constructor for this class
	 *
	 * @param	event	the event that this will be the key for
	 */
	...
	/**
	 * <pre>Evaluate the hash code for this object
	 *
	...
	/**
	 * <pre>Get the value of the mask element for this event.
