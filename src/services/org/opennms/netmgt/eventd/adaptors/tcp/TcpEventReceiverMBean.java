...
public interface TcpEventReceiverMBean
{
	...
	/**
	 * The current status of the managed bean. This
	 * is a representation of the managed bean's run
	 * state as defined by the <code>Fiber</code>
	 * interface.
	 */
	 ...
	 * This can only be done prior to starting the 
	 * managed bean. If the managed bean is already running
	...
	/**
	 * Returns the where a listener is waiting to 
	 * process new request.
	 *
	 ...
	 *
	 * @param name	The name of the handler to add.
	 *
	 * @throws javax.management.MalformedObjectNameException Thrown if
	 * 	the passed name is not a valid ObjectName.
	 * @throws javax.management.InstanceNotFoundException Thrown if 
	 * 	no managed bean can be found that matches the name.
	 */
	...
	/**
	 * Removes an event handler. The passed name must
	 * be a valid JMX object name.
	 *
