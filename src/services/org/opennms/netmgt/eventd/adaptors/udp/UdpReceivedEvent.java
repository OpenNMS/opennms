...
{
	/** 
	 * The received XML event, decoded using the
	 * US-ASCII encoding.
	 */
	private String		m_eventXML;

	/**
	 * The decoded event document. The classes are
	 * defined in an XSD and generated by castor.
	 */
	private Log		m_log;
	...
	/**
	 * Private constructor to prevent the used of <em>new</em>
	 * except by the <code>make</code> method.
	 */
	...
	/**
	 * Constructs a new event encapsulation instance based upon
	 * the information passed to the method. The passed datagram data
	 * is decoded into a string using the <tt>US-ASCII</tt> character
	 * encoding.
	 *
	 * @param packet	The datagram received from the remote agent.
	 *
	 * @throws java.io.UnsupportedEncodingException Thrown if the data buffer
	 * 	cannot be decoded using the US-ASCII encoding.
	 */
	static UdpReceivedEvent make(DatagramPacket packet)
		throws UnsupportedEncodingException
	{
		return make(packet.getAddress(),
			    packet.getPort(),
			    packet.getData(),
			    packet.getLength());
	}
	...
	/**
	 * Constructs a new event encapsulation instance based upon
	 * the information passed to the method. The passed byte array is
	 * decoded into a string using the <tt>US-ASCII</tt> character
	 * encoding.
	 *
	...
	/**
	 * Decodes the XML package from the remote agent. If an 
	 * error occurs or the datagram had malformed XML then an 
	 * exception is generated.
	 *
	 * @return The toplevel <code>Log</code> element of the XML document.
	 *
	 * @throws org.exolab.castor.xml.ValidationException Throws if the documents
	 * 	data does not match the defined XML Schema Definition.
	 * @throws org.exolab.castor.xml.MarshalException Thrown if the XML is 
	 * 	malformed and cannot be converted.
	 */
	Log unmarshal()
	...
	/** 
	 * Adds the event to the list of events acknowledged in
	 * this event XML document.
	 *
	...
	/**
	 * Returns true if the instance matches the object based upon
	...
	/**
	 * Returns the hash code of the instance. The hash code is 
	 * computed by taking the bitwise XOR of the port and the
	 * agent's internet address hash code.
	 *
