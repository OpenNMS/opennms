...
/**
 * <p>This class is use to encapsulate an ICMP reply 
 * that conforms to the {@link Packet packet} 
 * class. The reply must be of type ICMP Echo Reply
 * and be the correct length.</p>
 *
 * <p>When constructed by the <code>create</code> method
 * the returned reply encapsulates the sender's address
...
public final class Reply
{
	...
	/**
	 * Constructs a new reply with the passed
	 * address and packet as the contents of 
	 * the reply.
	 *
	 * @param addr	The address of the ICMP sender.
	...
	/**
	 * Returns true if the recovered packet is 
	 * an echo reply.
	 */
