...
{
	/**
	 * Unique named padding that is placed in front of the
	 * incremental padding.
	 */
	private static final byte NAMED_PAD[] = { (byte)'O', (byte)'p', (byte)'e', (byte)'n',
						  (byte)'N', (byte)'M', (byte)'S', (byte)'!' };
	...
	/**
	 * The thread id of the sender. Effective
	 * key for the packet.
	 */
	private long	m_tid;	// thread id
	
	/**
	 * Padding used to make the packet conform to
	 * the defacto unix ping program (56 bytes).
	 */
	private byte[]	m_pad;
	 ...
	 * value to avoid sign extension. The 
	 * method essentially treats the value
	 * of 'b' as an 8-bit unsigned value for
	 * conversion purposes.
	 *
	...
	/**
	 * Private constructor to disallow default construction
	 * of an object.
	 *
	...
	/**
	 * Creates a new discovery ping packet 
	 * from the passed buffer.
	 *
	 * @param buf	The buffer containing a refected ping packet.
	 */
	 ...
	 * which is suitable for transmission to remote
	 * hosts.
	 *
