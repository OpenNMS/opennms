...
public final class IPAddressRange
{
		...
		implements Enumeration, Iterator
	{
		...
		/**
		 * Converts an integer to an InetAdrress object
		 * and discards any exceptions. If the address cannot
		 * be constructed then a null reference is returned.
		 *
		 * @param addr	The 32-bit IP address value, int network order.
		 *
	...
	/**
	 * Returns the begin address of the IP address range as
	 * a String value.
	 *
	...
	/**
	 * Returns the end address of the IP address range as
	 * a String value.
	 *
	...
	/** 
	 * Returns the begin address of the IP address range
	 * as a long value.
	 *
	...
	/** 
	 * Returns the end address of the IP address range
	 * as a long value.
	 *
	...
	/** 
	 * This method may be used to determine if the 
	 * specified IP address is contained within the
	 * IP address range.
	 *
	 * @param ipAddr  IP address (long) to compare
	 * 
	 * @return 'true' if the specified IP address falls
	 * within the IP address range. 'false' otherwise.
	 */
	 ...
	 * within the IP address range. 'false' otherwise.
	 */
	boolean contains(String ipAddr)
		throws java.net.UnknownHostException
	{
	 ...
	 * object.</P>
	 *
	 * <P>The iterator returns objects of type {@link java.net.InetAddress InetAddress}
	 * or <code>null</code> if the address is unknown.</p>
	 *
	...
	/**
	 * <P>Converts a 32-bit unsigned quantity to a
	 * IPv4 dotted decimal string address.</P>
	 *
	 * @param address	The 32-bit quantity to convert.
	 *
	 * @return The dotted decimal IPv4 address string.
	 *
	 */
