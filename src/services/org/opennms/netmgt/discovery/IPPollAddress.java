...
/**
 * <p>This class is used to represent the polling information
 * needed by the discovery process. Each instance encapsulates
 * an internet address, timeout in milliseconds, and a retry
 * count.</p>
 *
...
final class IPPollAddress 
{
	...
	/**
	 * Returns the internet address encapsulated in the
	 * object.
	 *
