 ...
 * an address range plus the retry &amp; timeout information. The
 * class is designed so that it can return either an 
 * {@link java.util.Enumeration enumeration} or an
 * {@link java.util.Iterator iterator} to traverse the range of
 * addresses.</p>
 *
...
final class IPPollRange
{
		...
		implements Enumeration, Iterator
	{
		...
		{
			return new IPPollAddress((InetAddress)m_range.nextElement(), 
						 m_timeout, 
						 m_retries);
		}
