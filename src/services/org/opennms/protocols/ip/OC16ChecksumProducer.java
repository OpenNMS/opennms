 ...
 * from data that is "added" to the sum. The 
	...
	extends Object
{
	...
	/**
	 * Converts a 8-bit value to a 32-bit 
	 * integer value. The conversion is done
	...
	/**
	 * Converts a 16-bit value to a 32-bit
	 * value. The conversion is done in an
	 * unsigned fashion.
	 *
	 * @param s The 16-bit value to convert
	 * @return The converted 32-bit value
	 *
	 */
	...
	/**
	 * Finalizes the result by adding the carried
	 * out bits back into the checksum.
	 *
	 */
	...
	/**
	 * Adds the specified 8-bit value to the 
	 * checksum. Since the checksum must be
	 * in 16-bits, the byte is copied to the upper
	 * 8-bits of the 16-bit value. The lower 8-bits
	 * are set to zero.
	 *
	 * @param b The 8-bit value to add to the checksum.
	 *
	 */
	...
	/** 
	 * Adds the specified 16-bit value to the checksum
	 * total. 
	 *
	 * @param s The 16-bit value to add
	 *
	 */
	 ...
	 * The 32-bit value is broken into two 16-bit values
	 * for the purpose of computing the checksum.
	 *
	 ...
	 * The 64-bit value is split into 4 16-bit quantities
	 * and added to the checksum.
	 *
	 * @param l The 64-bit value to add
	 */
	...
	/**
	 * Returns the current checksum value that has
	 * been computed for the object.
	 *
