...
/**
 * This is the implementation of an ICMP Address Mask Reqeust
...
public final class AddressMaskRequest extends ICMPHeader
{
	...
	/**
	 * Creates a new ICMP Address mask request from
	...
	/**
	 * Writes the ICMP address mask request out to the specified
