 ...
 * decode the data of a DNS response to an address resquest.</P>
 *
...
{
	/**
	 * <P>Constructs a new input stream for decoding 
	 * DNS records.</P>
	 *
	 * @param data	The array of data to pass to the base class.
	 */
	...
	/**
	 * <P>Read a byte off the input stream.</P>
	 *
	 * @return The integer read.
	 *
	 * @exception java.io.IOException Thrown if the end-of-file 
	 * 	is encountered trying to read the next byte.
	 */
	...
	/**
	 * <P>Read a 'short' off the input stream.</P>
	 *
	 * @return The short from the input stream.
	 *
	 * @exception java.io.IOException Thrown if the end-of-file 
	 * 	is encountered trying to read the next short.
	 */
	...
	/**
	 * <P>Read an 'int' off the input stream.</P>
	 *
	 * @return The int from the input stream.
	 *
	 * @exception java.io.IOException Thrown if there
	 *	is an error while read.
	 */
	...
	/**
	 * <P>Read a 'string' off the input stream.</P>
	 *
	 * @return the string from the input stream
	 *
	 * @exception java.io.IOException Thrown if 
	 *	there is an error while read
	 */
	...
	/**
	 * <P>The readDomainName method is used to read an entire
	 * domain name from the stream. The string returned will
	 * be the concatentation of several substrings, each substring
	 * in the record is separated by a '.'(dot). For more information
	 * see the RFC for the distributed name service.</P>
	 *
	 * @return The domain name string.
	 *
	 * @exception java.io.IOException Thrown if an error occurs
	 * 	decoding the string from the stream.
	 */
	...
	/**
	 * <P>Reads the resource record from the input stream.</P>
	 *
	 * @return The DNSAddressRR that is in response to the address request.
	 *
	 * @exception java.io.IOException Thrown if data 
	 *	does not decode to a DNSAddressRRl.
	 */
	public DNSAddressRR readRR() throws IOException 
	{
		...
		try 
		{
			...
			// the caller.
			//
			DNSAddressRR rr = new DNSAddressRR(rrName, 
							   rrType, 
							   rrClass, 
							   rrTTL, 
							   rrDNSIn);
