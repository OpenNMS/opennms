 ...
 * address of a particular hostname. A resource record typically has:</P> 
 *
 * <TABLE BORDER=0>
 *	<TH>
...
public final class DNSAddressRR
{
	...
	/**
	 * <P>Class of this RR.</P>
	 */
	private int m_class;

	/**
	 * <P>Time to live for this RR.</P>
	 */
	private long m_TTL;
	
	/**
	 * <P>Time at which this RR was created.</P>
	 */
	private long m_created;

	/**
	 * <P>The IP Address for the Route Record.</P>
	 */
	private int[] ipAddress;

	/**
	 * <P>Returns the address in the dotted decimal format.</P> 
	 *
	...
	/**
	 * <P>Constructs an new DNS Address Resource Record
	 * with the specified information.</P>
	 *
	 * @param name		name of the RR
	 * @param type		type of the RR
	 * @param clas		class of the RR
	 * @param ttl		time for which this RR is valid
	 * @param dnsIn		inputstream  for this RR
	 *
	 * @exception java.io.IOException Thrown if an error occurs
	 *	decoding data from the passed DNSInputStream.
	 */
	...
	/**
	 * <P>Returns the address from the 
	 * address record as a byte array.</P>
	 *
	...
	/**
	 * <P>the InetAddress of the address contained
	 * for the record.</P>
	 *
	 * @return The InetAddress of the address
	 *
	 * @exception java.net.UnknownHostException Thrown if the 
	 *	InetAddress object cannot be constructed.
	 */
	...
	/**
	 * <P>Converts the object to a textual string that
	 * describes the resource record.</P>
	 *
	...
	/**
	 * <P>Returns the name of this RR.</P>
	 *
	...
	/**
	 * <P>Returns the type of this RR.</P>
	 *
	...
	/**
	 * <P>Returns the class of this RR.</P>
	 *
	...
	/**
	 * <P>Returns the TTL of this RR.</P>
	 *
	...
	/**
	 * <P>Returns true if still valid i.e. 
	 * TTL has not expired.</P>
	 *
