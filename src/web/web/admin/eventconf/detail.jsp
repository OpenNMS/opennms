...
<% String breadcrumb2 = java.net.URLEncoder.encode("<a href='admin/eventconf/index.jsp'> Event Configuration </a>"); %>
<% String breadcrumb3 = java.net.URLEncoder.encode("Details"); %>
