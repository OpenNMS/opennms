...
<% String breadcrumb3 = java.net.URLEncoder.encode("<a href='admin/userGroupView/views/list.jsp'>Views List</a>"); %>
<% String breadcrumb4 = java.net.URLEncoder.encode("Modify View"); %>
