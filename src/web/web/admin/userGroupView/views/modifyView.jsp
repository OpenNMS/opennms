...
<% String breadcrumb2 = "<a href='" + java.net.URLEncoder.encode("admin/userGroupView/index.jsp") + "'>Users, Groups, and Views</a>"; %>
<% String breadcrumb3 = "<a href='" + java.net.URLEncoder.encode("admin/userGroupView/views/list.jsp") + "'>Views List</a>"; %>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="2" >
        <tr>
          <td>
            ...
            <tr>
              <td>
                Assign and unassign users and groups to the view using the select lists below.
                <br>
              </td>
            </tr>
            <!--<table width="100%" border="0" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td width="90%" valign="top">
                  <textarea rows="5" cols="50" name="comments"><%=view.getComment()%></textarea>
                </td>
              </tr>
            </table>-->
          </td>
