...
var cURLBase = "graph/domainResults?"
...
// var imgSource;
 ...
 zoomBoxWidth = 401; //Default size, this needs to be read eventually from the tag
 zoomBoxHeight = 101; //Default size, this needs to be read eventually from the tag
...
function onMouseUpEvent(e) {
 ...
 if ((gMouseObj.rightButtonPressed()) && (insideZoomBox())) {
  ...
  var domain = gUrlObj.getUrlParameterValue("domain");

  open(urlBase + "zoom=true&type=" + type + "&intf=" + intf + "&domain=" + domain + "&reports=" + reports + "&start=" + newGraphStart + "&end=" + newGraphEnd, "_self");
 }
 ...
 if ((gMouseObj.leftButtonPressed()) && (gMouseObj.dragging)) {
  ...
  open(urlBase + "zoom=true&type=" + type + "&intf=" + intf + "&domain=" + domain + "&reports=" + report + "&start=" + newGraphStart + "&end=" + newGraphEnd, "_self");
