var x_picker,pick_begin,num_color_picker,pick_color,pick_appui,comp_rouge,comp_vert,comp_bleu,pick_color,pick_prefixe;
...
{if (pick_appui==true)
{xcurs=evt.getClientX()-x_picker;if (xcurs<10) {xcurs=10};if (xcurs>140) {xcurs=140};
...
obj=svgdoc.getElementById("test");obj.getStyle().setProperty("fill",pick_color);
/*node=svgdoc.getElementById("couleur");child=node.getFirstChild();
