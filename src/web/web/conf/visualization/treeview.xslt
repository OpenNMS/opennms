...
-->
	...
	<xsl:param name="param-img-directory" select="'conf/visualization/Icons/'"/>
...
-->
	<xsl:template match="/treeview">
		...
		<!-- Warning, if you use-->
		<script src="conf/treeview.js" language="javascript" type="text/javascript"></script>
		...
		<table border="0" cellspacing="0" cellpadding="0">
	  		<tr>
	  			...
	  			<td>
	  				<a class="folder">
					<xsl:if test="@code">  				
		  				<xsl:attribute name="onclick">toggle(this, '<xsl:value-of select="@code"/>')</xsl:attribute>
					</xsl:if>
