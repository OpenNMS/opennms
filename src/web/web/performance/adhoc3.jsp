...
<%@page language="java" contentType="text/html" session="true" import="org.opennms.web.performance.*,java.util.*,org.opennms.web.*" %>
...
<table width="100%" cellspacing="0" cellpadding="0" border="0">
  <tr>
    ...
    <td>
    <form METHOD="GET" ACTION="performance/adhoc4.jsp" >
