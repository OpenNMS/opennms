...
/*        //handle the style sort parameter
        ...
        OutageFactory.SortStyle sortStyle = OutageFactory.SortStyle.IFLOSTSERVICE;
        ...
        OutageFactory.OutageType outType = OutageFactory.OutageType.CURRENT;
        ...
        if( filterStrings != null ) {
            for( int i=0; i < filterStrings.length; i++ ) {
                OutageFactory.Filter filter = OutageUtil.getFilter( filterStrings[i] );
                if( filter != null ) {
        ...
        try {
            ...
            RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher( "/outage/browser.jsp" );
