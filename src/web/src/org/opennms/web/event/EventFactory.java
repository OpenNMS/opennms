...
public class EventFactory extends Object
{
    ...
    /**
     * Count the number of events for a given acknowledgement type.
     * @return An array of event counts.  Each index of the array 
     * corresponds to the event severity for the counts (indeterminate is 1,
     * critical is 7, etc).
     */
     ...
     * given sort style. 
     *
     * <p><strong>Note:</strong> This limit/offset code is <em>Postgres 
     * specific!</em>  Per <a href="mailto:shaneo@opennms.org">Shane</a>,
     * this is okay for now until we can come up with an Oracle alternative
     * too.</p>
     *
    ...
    /** 
     * Return all events (optionally only unacknowledged events) sorted by the given
    ...
    /** 
     * Return some maximum number of events or less (optionally only unacknowledged events) 
     * sorted by the given sort style for the given node.
     *
     * @param throttle a value less than one means no throttling
     */
    ...
    /** 
     * Return some maximum number of events or less (optionally only unacknowledged events) 
     * sorted by the given sort style for the given node and IP address.
     *
     * @param throttle a value less than one means no throttling
     * @param offset which row to start on in the result list
     */
    ...
    /** 
     * Return some maximum number of events or less (optionally only unacknowledged events) 
     * sorted by the given sort style for the given IP address.
     *
     * @param throttle a value less than one means no throttling
     * @param offset which row to start on in the result list
     */
    ...
    /** 
     * Return some maximum number of events or less (optionally only unacknowledged events) 
     * sorted by the given sort style for the given node, IP address, and service ID.
     *
     * @param throttle a value less than one means no throttling
     * @param offset which row to start on in the result list
     */
    ...
    /** 
     * Return some maximum number of events or less (optionally only unacknowledged events) 
     * sorted by the given sort style for the given service ID.
     *
     * @param throttle a value less than one means no throttling
     * @param offset which row to start on in the result list
     */
    ...
    /**
     * Acknowledge with the given username and the current time all events that match
    ...
    /**
     * Acknowledge with the given username and the given time all events that match
     * the given filter criteria.
     */ 
     ...
     * related to a given sort style.
     *
     * @param ackType the acknowledge type to map to a clause
     */
