...
public class Event extends Object
{
    ...
    /**
     * Contains the eid, eidtext (optionally), specific,
    ...
    /**
     * The &lt;time&gt; element from the Event Data Stream DTD,
     * which is the time the event was received by the
     * source process.  Cannot be null.
     */
    protected Date time;
    ...
    /**
     * Formatted display text to control how the
     * event will appear in the browser.  This field
     * may contain variables that are populated by
     * field values of the message.
     */
    ...
    /**
     * Automated Action for event.  Should
    ...
    /**
     * Operator Action for event.  Should
     * consist of fully-qualfied pathname to
     * executable command, with possible variables
     * used to reference event-specific data
     */   
    ...
    /**
     * Notification string.  Should consist of
    ...
    /**
     * Trouble ticket integration string.  Should
     * consist of fully-qualfied pathname to
     * executable command, with possible variables
     * used to reference event-specific data
     */
     ...
     *  <ul>
     *   <li> State is a boolean flag as to whether the
     *      entry is active or not.  1=on, 0=off.
     *   <li> Destination is hostname or IP of system to
     *      forward the event to
     *   <li> Method is the means by which it will be 
    ...
    /**
     * Empty constructor to create an empty <code>Event</code> instance.
     * All fields will hold the default values.
     */
    public Event() {}
    ...
    public Event( int id,
        ...
        this( id, uei, time, dpName, createTime, severity, snmp, host, snmphost,
            parms, nodeID, serviceID, ipAddr, description, logMessage, logGroup, 
            operatorInstruction, autoAction, operatorAction, 
            operatorActionMenuText, notification, troubleTicket, 
            troubleTicketState,forward, mouseOverText, acknowledgeUser, 
