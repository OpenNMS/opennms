 ...
 */
public class HibernateSessionDataSource extends AbstractDataSource {

	private static final Logger LOG = LoggerFactory.getLogger(HibernateSessionDataSource.class);
	 ...
	 * Default constructor.
	 */
	public HibernateSessionDataSource() {
	}

	public HibernateSessionDataSource(DataSource target, SessionFactory session) {
