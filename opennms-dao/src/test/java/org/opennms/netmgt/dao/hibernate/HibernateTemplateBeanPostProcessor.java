...
public class    HibernateTemplateBeanPostProcessor implements BeanPostProcessor {
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        if (bean instanceof HibernateDaoSupport) {
            HibernateDaoSupport daoSupport = (HibernateDaoSupport) bean;
            // Disable write operation checks to allow writes even in MANUAL flush mode
            daoSupport.getHibernateTemplate().setCheckWriteOperations(false);
        }
        return bean;
    }
}