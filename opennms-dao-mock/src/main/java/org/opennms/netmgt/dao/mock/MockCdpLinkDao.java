...
public class MockCdpLinkDao extends AbstractMockDao<CdpLink, Integer> implements CdpLinkDao {
    ...
    @Override
    protected void generateId(final CdpLink link) {
        link.setId(id.incrementAndGet());
    }

    @Override
    protected Integer getId(final CdpLink link) {
        return link.getId();
    }
    ...
    @Override
    public void deleteByNodeIdOlderThen(Integer nodeiId, Date now) {
        throw new UnsupportedOperationException("not implemented yet");
    }
