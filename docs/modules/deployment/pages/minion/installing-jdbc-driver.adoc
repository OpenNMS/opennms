...
. Download the JDBC driver JAR from a repository (for example, a public https://mvnrepository.com/artifact/mysql/mysql-connector-java/8.0.22[Maven repository]).
...
You can troubleshoot the installation using `data/log/karaf.log`.
