...
TIP: To run with Apache Kafka or configure flow listeners, see the xref:reference:configuration/minion-docker.adoc#minion-docker[Minion configuration reference].
