...
* DNS configured, localhost, and your server's host name resolved properly
* {page-component-title} core instance runs on latest stable release
* Minion server can access the {page-component-title} core instance via REST (8980/tcp) and desired message broker nodes (for example, ActiveMQ 61616/tcp, Apache Kafke 9092/tcp)
