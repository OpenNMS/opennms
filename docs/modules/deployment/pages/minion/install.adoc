...
* Install a {page-component-title} Minion on one of the following <<minion/system-requirements.adoc#operating-systems-Core, Operating Systems>>
...
* Minion server can access the {page-component-title} core instance via REST (8980/tcp) and desired message broker nodes (e.g., ActiveMQ 61616/tcp, Apache Kafke 9092/tcp)
