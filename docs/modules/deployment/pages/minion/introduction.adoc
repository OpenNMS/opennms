...
image::deployment/minion/location.png[Network diagram displaying an example {page-component-title} instance with three Minions in different locations, 850]
