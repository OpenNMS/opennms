...
Download and install OpenJDK packages (OpenJDK 25 here but please refer to system requirements):

[source,console]
----
dnf install --downloadonly --downloaddir=/tmp/opennms_rpms java-25-openjdk-devel
