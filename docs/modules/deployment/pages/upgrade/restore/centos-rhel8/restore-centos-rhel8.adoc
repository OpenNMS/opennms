...
See xref:deployment:core/centos-rhel/initialize-core.adoc#initialize-core-firewall[firewall settings] and xref:core/firewall-core.adoc[firewall core].
xref:core/firewall-core.adoc[firewall].
