...
OpenNMS {page-component-title} configurations and performance data storage methods can differ a lot depending on customer needs.
...
* Able to run a disaster recovery without having OpenNMS packages available
