...
For configuring container deployments, refer to xref:reference:configuration/core-docker.adoc#core-oci-env[Core], xref:reference:configuration/minion-docker.adoc#minion-docker[Minion], and xref:reference:configuration/sentinel-features.adoc#sentinel-oci-confd[Sentinel].
