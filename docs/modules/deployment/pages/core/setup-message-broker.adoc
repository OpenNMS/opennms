...
This section describes how to set up your {page-component-title} Core instance to use an existing messaging infrasturce based on ActiveMQ or Apache Kafka.
...
We recommend that you substitute at least an alternate, more secure password. 
