...
This section describes how to setup your {page-component-title} Core instance to your use an existing messaging infrasturce based on ActiveMQ or Apache Kafka.
The {page-component-title} Core instance comes with an embedded ActiveMQ system which is by default not reachable from external network.
