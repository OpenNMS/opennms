...
NOTE: The commands below install a specific PostgreSQL version.
Make sure to reference your current https://www.postgresql.org/download/linux/redhat/[PostgreSQL version].
