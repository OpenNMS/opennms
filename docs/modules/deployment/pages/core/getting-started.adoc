...
NOTE: If you need SNMP Trap listener on port 162/udp directly, see the "Binding to privileged ports" steps in the <<core/getting-started.adoc#set-up-core-instance, Setup the Core Instance>> section above.
