...
After starting the {page-component-title} Core services, access the web application at +
...
. Use *admin* as the current password, type and confirm a new password in the appropriate boxes.
. Click btn:[Submit].
