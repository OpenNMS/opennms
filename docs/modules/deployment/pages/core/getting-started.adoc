...
If you want to get started quickly with OpenNMS Horizon on a bare metal system, check out our https://github.com/opennms-forge/opennms-install[quick install scripts].
This convenient bootstrap script installs Horizon on Debian or CentOS systems, running the steps documented in this section of the deployment guide.
Use this quick starting point to evaluate and explore how to configure Horizon in complex distributed environments.
...
* Script does not deal with existing installations or upgrades
* Script does not configure or install Minions, Sentinels, or distributed time series storage like Cortex.
