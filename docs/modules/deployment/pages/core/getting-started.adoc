...
Click *Show Me What is Being Sent* to see a list of xref:operation:deep-dive/admin/configuration/usage-statistics.adoc[information that we collect and share].
