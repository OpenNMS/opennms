...
**_Does not take into account your intended workload, for example, network size, number of monitored metrics, flows, events, and data retention requirements._
