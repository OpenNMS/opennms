...
image::deployment/core/opennms-arch.svg["Architecture diagram displaying the components of a basic {page-component-title} deployment and their relationships", 850]
