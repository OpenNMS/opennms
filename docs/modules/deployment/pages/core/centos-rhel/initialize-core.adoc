.FIPS mode
If your environment requires FIPS mode enabled, you must enable the `PKCS12` keystore type for the Secure Credentials Vault prior to creating the keystore:
[source, console]
----
