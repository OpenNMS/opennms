...
This functionality can be leveraged to help track and diagnose communication problems that may arise in distributed deployments of _{page-component-title}_ components; for example, Core instance, Minion and/or Sentinel.
