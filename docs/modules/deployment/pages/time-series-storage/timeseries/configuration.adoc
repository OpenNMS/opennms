...
NOTE: If you are using a container, you can set this as an environment variable in your container's configuration settings instead of creating or modifying a property file:
+
[source, properties]
