...
Set the following property in `$\{OPENNMS_HOME}/etc/opennms.properties.d\timeseries.properties` to configure {page-component-title} to use the Time Series Integration Layer:
