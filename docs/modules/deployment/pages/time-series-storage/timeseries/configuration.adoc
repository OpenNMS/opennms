...
After activating the Time Series Integration Layer, you must configure the plugin.
For specific instructions, check your plugin's documentation.

Enabling and/or configuring the Time Series Integration Layer requires a restart of the {page-component-title} service.
