...
. Configure the Prometheus RemoteWrite plugin in {page-component-title} via the Karaf shell, or by creating or modifying `$\{OPENNMS_HOME}/etc/org.opennms.plugins.tss.cortex.cfg`.
+
