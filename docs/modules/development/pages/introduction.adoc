 ...
 * https://opennms.discourse.group/t/developing-with-git[Developing with GIT]
 * https://opennms.discourse.group/t/set-up-local-development-environment-macos/485[Set up local development environment]
