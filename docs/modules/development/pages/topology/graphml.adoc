...
| `nodeID`                  | no       | Node         | `int`     | -         | Lets you reference the vertex to an OpenNMS node.
| `foreignSource`           | no       | Node         | `string`  | -         | Lets you reference the vertex to an OpenNMS node identified by foreign source and foreign id.
...
| `foreignID`               | no       | Node         | `string`  | -         | Lets you reference the vertex to an OpenNMS node identified by foreign source and foreign id.
