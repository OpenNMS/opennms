...
The MCP server exposes {page-component-title} to clients that speak the https://modelcontextprotocol.io[Model Context Protocol] (MCP), the open standard that AI agents such as Claude Code and Claude Desktop use to interact with external systems.
