...
[source,bash]
----
curl -X POST -H "Content-Type: application/json" -u admin:admin -d '{"name": "http", "dstPort":"80,8080", "protocols":["tcp", "udp"], "group": {"id": 2}}' http://localhost:8980/opennms/rest/classifications
----
...
[source,bash]
----
curl -X POST -H "Content-Type: application/json" -u admin:admin -d '{"protocol": "tcp", "srcAddress": "10.0.0.1", "srcPort": "55555", "dstAddress": "192.168.0.1", "dstPort": "80", "exporterAddress": "10.0.0.1"}' http://localhost:8980/opennms/rest/classifications/classify
----
...
[source,bash]
----
curl -X POST -H "Content-Type: application/json" -u admin:admin -d '{"protocol": "tcp", "srcAddress": "10.0.0.1", "srcPort": "55555", "dstAddress": "192.168.0.1", "dstPort": "8980", "exporterAddress": "10.0.0.1"}' http://localhost:8980/opennms/rest/classifications/classify
----
