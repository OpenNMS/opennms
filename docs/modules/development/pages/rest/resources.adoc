...
POST requires JSON using `application/json` as its `Content-Type`.

[caption=]
.Resources API POST function
[options="autowidth"]
|===
| Resource  | Description

| /resources/generateId
| Store a set of resource IDs in the JSON store and return a generated key.
The request body is a JSON array of resource-ID strings.
The same input always produces the same key, and the response is the generated key as a JSON string.
|===
      ...
      <rrdGraphAttributes>
        ...
        <entry>
          ...
          <value name="ifHCInOctets"
                 ...
                 rrdFile="ifHCInOctets.rrd"/>
        </entry>
        <entry>
          <key>ifHCOutOctets</key>
          <value name="ifHCOutOctets"
                 relativePath="snmp/1/lo"
                 rrdFile="ifHCOutOctets.rrd"/>
        </entry>
        ...
      </rrdGraphAttributes>
    </resource>
