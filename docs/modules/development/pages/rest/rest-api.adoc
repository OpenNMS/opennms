...
Please note: #If a namespace is added manually, in order to use a XML tool to validate against the XSD (like xmllint) it won't be preserved when OpenNMS updates that file.# 
