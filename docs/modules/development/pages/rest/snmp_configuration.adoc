...
----
{
  // any fields from the table above, these are the default overrides, if any
  ...
  "definition": [
    {
      ...
      // any fields from the table above that you want to override for this definition, for example:
      "readCommunity": "myReadCommunityFor10Net"
    },
    {
      "specific": [
        "10.9.9.9", "10.11.12.13"
      ]
      // any fields from the table above that you want to override for this definition
    },
    {
      "ipMatch": [
        "10.0.0.*", "192.168.*.*"
    ...
    "profile": [
      {
        ...
        // any fields from the table above that you want to override for this profile
      },
      {
        "label": "datacenter2",
