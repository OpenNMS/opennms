...
The Netflow v9 UDP parser accepts packets received by a <<deep-dive/telemetryd/listeners/udp.adoc#telemetryd-listener-udp, UDP listener>> and must forward them to a <<deep-dive/telemetryd-netflow9-adapter, Netflow v9 adapter>>.
...
The Netflow v9 adapter handles Netflow v9 payloads received and parsed by by the <<deep-dive/telemetryd-netflow9-parser-udp, Netflow v9 UDP Parser>>.
