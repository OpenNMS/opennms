...
The IPFIX UDP parser accepts packets received by a <<deep-dive/telemetryd/listeners/udp.adoc#telemetryd-listener-udp, UDP listener>> and must forward them to an <<deep-dive/telemetryd-ipfix-adapter, IPFIX adapter>>.
...
The IPFIX TCP parser accepts packets received by a <<deep-dive/telemetryd/listeners/tcp.adoc#telemetryd-listener-tcp, TCP Listener>> and must forward them to an <<deep-dive/telemetryd-ipfix-adapter, IPFIX adapter>>.
