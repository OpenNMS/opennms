...
= IPFIX
:description: Learn how the IPFIX UDP and TCP parsers in {page-component-title} accept packets from UDP/TCP listeners and forward them to an IPFIX adapter.
