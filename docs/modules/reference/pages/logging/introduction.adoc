...
| notifd.log
| Information about the notifications that were or were not send.
...
| provisiond.log
| The node provisioning processes are being logged here. This includes also service detection and policy results.
