...
NOTE: This DNS server setting may be shared with the xref:deep-dive/provisioning/adapters/rdns.adoc[reverse DNS adapter] if you have them both installed.
