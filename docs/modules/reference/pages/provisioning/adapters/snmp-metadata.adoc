...
There is also an optional attribute `resultsBehavior` that can be used to specify how the adapter should update the node's metadata. The table below outlines the behavior of each option:
