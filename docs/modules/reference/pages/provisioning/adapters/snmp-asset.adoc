[[adapter-snmp-asset]]
= SNMP Asset
:description: Learn how to configure and use the SNMP asset adapter to collect SNMP values and populate asset records for nodes in OpenNMS Horizon/Meridian.
