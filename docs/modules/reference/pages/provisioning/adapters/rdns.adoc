[[adapter-rdns]]
= Reverse DNS
:description: Learn how the RDNS adapter uses the dynamic DNS protocol to send updated PTR DNS records to your DNS system when OpenNMS Horizon/Meridian provisions nodes.
