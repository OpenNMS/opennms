...
Once the role is setup, you will need to assign the role to the user account.
You can either create a new user to assign the role or assign the role to a user from an external authentication directory that is setup on your vCenter.
