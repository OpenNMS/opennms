...
[[vmware-handler]]
= VMWare Handler
:description: Learn how to use and configure the VMware adapter to pull hosts and/or virtual machines from a vCenter server into OpenNMS Horizon/Meridian.
//should this be in the Adapters section? Was it perhaps not moved because of the link concern?
