...
Use the `opennms:show-import` command, available via the xref:operation:deep-dive/karaf-shell/karaf-shell.adoc[Karaf shell], to show the results of an import without persisting or triggering the import:
