...
[[dns-handler]]
= DNS Handler
:description: Learn how to configure and use the DNS handler in OpenNMS Horizon/Meridian to request a zone transfer (AXFR) from a DNS server to retrieve A and AAAA records.
