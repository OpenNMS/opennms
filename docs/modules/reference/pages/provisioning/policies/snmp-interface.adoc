...
= SNMP Interface Policy
:description: Learn how the SNMP Interface policy controls whether to persist discovered SNMP interface entities in OpenNMS Horizon/Meridian and SNMP collection parameters.
