...
= SNMP Interface Policy
:description: Learn how the SNMP Interface policy controls whether to persist discovered SNMP interface entities in {page-component-title} and SNMP collection parameters.
