= Metadata Policies
:description: Learn about the node and interface metadata policies in OpenNMS Horizon/Meridian to set metadata for provisioned nodes and discovered interfaces on them.
