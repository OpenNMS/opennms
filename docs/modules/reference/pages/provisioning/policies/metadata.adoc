= Metadata Policies
:description: Learn about the node and interface metadata policies in {page-component-title} to set metadata for provisioned nodes and discovered interfaces on them.
