= TrivialTimeDetector
:description: Learn how the TrivialTimeDetector in {page-component-title} finds and assigns services based on a timely response from a Trivial Time Service.
