...
:description: Learn how the WSManWQLDetector in {page-component-title} attempts to connect to the agent defined in `wsman-config.xml` and issues a WQL query.
