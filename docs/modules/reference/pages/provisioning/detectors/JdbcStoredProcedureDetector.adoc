...
:description: Learn how the JDBCStoredProcedureDetector in {page-component-title} connects to a JDBC-enabled database and checks the result of a stored procedure.
