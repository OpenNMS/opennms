...
= JDBC Query Detector
:description: Learn how the JDBCQueryDetector in {page-component-title} connects to a JDBC-enabled database and checks for any result from a user-specified SQL query.
