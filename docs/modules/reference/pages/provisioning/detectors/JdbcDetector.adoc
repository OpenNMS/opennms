...
= JDBC Detector
:description: Learn how the JDBCDetector in {page-component-title} connects to a JDBC-enabled database and tries to fetch its catalog to determine its availability.
