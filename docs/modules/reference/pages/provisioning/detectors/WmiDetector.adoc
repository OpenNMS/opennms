...
:description: Learn how the WMIDetector in {page-component-title} detects the availability of WMIConfiguration on a device when using Provisiond to scan it.
