...
|===
| Parameters for the HTTPS detector are the same parameters as the <<reference:configuration/provisioning/detectors/HttpDetector.adoc#HttpDetector, HttpDetector>>.
|===
