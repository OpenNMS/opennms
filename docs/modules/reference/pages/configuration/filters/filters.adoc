...
[[filters]]
= Filters
:description: Learn about the database schema file in OpenNMS Horizon/Meridian and how to use filters (rules) to select IP addresses from the ipinterface table.
