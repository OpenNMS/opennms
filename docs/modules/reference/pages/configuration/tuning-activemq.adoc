...
----
<1> The amount of JVM heap memory assigned to the broker to track of destinations, cache messages, etcr; `memoryUsage` limit can be increased to `512MB` or more.
