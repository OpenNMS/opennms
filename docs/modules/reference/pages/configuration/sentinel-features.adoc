= Sentinel Features
:discovery: Discover some of the Sentinel features you can install manually in OpenNMS Horizon/Meridian: core, Java Message Service (JMS), Kafka, flows, and so on.
