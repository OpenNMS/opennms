= Tuning Apache Kafka
:description: Learn about default Kafka settings in OpenNMS Horizon/Meridian and how to change them to meet your system requirements, including multi-tenancy.
