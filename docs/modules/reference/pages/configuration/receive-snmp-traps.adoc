...
NOTE: If you need the SNMP trap listener on port `162/udp` directly, see the "Binding to privileged ports" steps in xref:deployment:core/getting-started.adoc#set-up-core-instance.
