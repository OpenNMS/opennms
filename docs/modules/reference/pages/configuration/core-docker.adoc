[[core-docker]]
= Core Docker
:description: Learn about startup arguments and environment variables for the Docker with the OpenNMS Horizon/Meridian core.
...
| `OPENNMS_CASSANDRA_DATACENTER`  | Data center DC set for  Cassandra                                             | optional | `datacenter1`
|===
