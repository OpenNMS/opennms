...
= PercMonitor
:description: Learn how to configure and use the PercMonitor in OpenNMS Horizon/Meridian to test the status of a PowerEdge Expandable RAID Controller (PERC) RAID array.
