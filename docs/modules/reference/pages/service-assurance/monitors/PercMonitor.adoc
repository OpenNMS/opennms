...
= PercMonitor
:description: Learn how to configure and use the PercMonitor in {page-component-title} to test the status of a PowerEdge Expandable RAID Controller (PERC) RAID array.
