...
TIP: If you want to monitor the status of a Windows file server, check out the <<deep-dive/service-assurance/monitors/JCifsMonitor.adoc#poller-jcifs-monitor,JCifsMonitor>>.
