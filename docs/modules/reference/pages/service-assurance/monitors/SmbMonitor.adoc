...
= SmbMonitor
:description: Learn how to configure and use the SmbMonitor in OpenNMS Horizon/Meridian to test the NetBIOS over TCP/IP name resolution in Microsoft Windows environments.
