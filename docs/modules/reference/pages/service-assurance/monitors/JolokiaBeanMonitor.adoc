...
= JolokiaBeanMonitor
:description: Learn about the JolokiaBeanMonitor in {page-component-title} that lets you run a method or poll an attribute via JMX using the Jolokia framework.
