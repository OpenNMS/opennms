...
= JolokiaBeanMonitor
:description: Learn about the JolokiaBeanMonitor in OpenNMS Horizon/Meridian that lets you run a method or poll an attribute via JMX using the Jolokia framework.
