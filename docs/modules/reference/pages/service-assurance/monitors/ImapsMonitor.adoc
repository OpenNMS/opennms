...
All ImapMonitor parameters apply, so refer to <<deep-dive/service-assurance/monitors/ImapMonitor.adoc#poller-imap-monitor, ImapMonitor>> for more information.
