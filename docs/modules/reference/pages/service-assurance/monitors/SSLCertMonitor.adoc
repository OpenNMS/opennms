...
= SSLCertMonitor
:description: Learn how to configure and use the SSLCertMonitor in OpenNMS Horizon/Meridian to test if an SSL certificate a remote network server presents is valid.
