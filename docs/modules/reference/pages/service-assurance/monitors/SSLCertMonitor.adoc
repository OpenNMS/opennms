...
= SSLCertMonitor
:description: Learn how to configure and use the SSLCertMonitor in {page-component-title} to test if an SSL certificate a remote network server presents is valid.
