...
All LdapMonitor parameters apply, so refer to <<deep-dive/service-assurance/monitors/LdapMonitor.adoc#poller-ldap-monitor, LdapMonitor>> for more information.
