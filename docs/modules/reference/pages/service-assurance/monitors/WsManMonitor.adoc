...
= WsManMonitor
:description: Learn about the WsManMonitor in {page-component-title} to issue a WS-Man GET command and validate the results using a Spring language expression (SPEL).
