...
:description: Learn how to configure and use the PassiveStatusMonitor in {page-component-title} to maintain the status of passive services in memory with a hash table.
