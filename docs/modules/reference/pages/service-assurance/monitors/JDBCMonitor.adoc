...
= JDBCMonitor
:description: Learn about the JDBCMonitor in OpenNMS Horizon/Meridian that checks if it can connect to a database and get the catalog from the DB management system (DBMS).
