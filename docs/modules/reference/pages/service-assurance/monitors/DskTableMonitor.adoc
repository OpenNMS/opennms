...
= DskTableMonitor
:description: Learn about the DskTableMonitor in OpenNMS Horizon/Meridian that tests if a disk or partition is under the minimum required space configured for it.
