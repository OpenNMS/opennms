...
= SnmpMonitor
:description: Learn how to configure and use the SnmpMonitor in OpenNMS Horizon/Meridian to provide a common platform to monitor states and results from SNMP agents.
