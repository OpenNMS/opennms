...
= SnmpMonitor
:description: Learn how to configure and use the SnmpMonitor in {page-component-title} to provide a common platform to monitor states and results from SNMP agents.
