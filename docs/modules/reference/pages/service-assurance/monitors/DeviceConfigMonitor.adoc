...
= DeviceConfigMonitor
:description: Learn about the DeviceConfigMonitor in OpenNMS Horizon/Meridian that tries to retrieve configuration from network devices and shows retrieval status.
