...
= DeviceConfigMonitor
:description: Learn about the DeviceConfigMonitor in {page-component-title} that tries to retrieve configuration from network devices and shows retrieval status.
