...
Configure the system proxy settings via <<operation:deep-dive/admin/system-properties/introduction.adoc#system-properties, system properties>>.
| false
|===
...
<monitor service="OpenNMS-Web-Login" class-name="org.opennms.netmgt.poller.monitors.PageSequenceMonitor"/> <1>
----
...
<monitor service="OpenNMS-Demo-Login" class-name="org.opennms.netmgt.poller.monitors.PageSequenceMonitor"/> <1>
----
<1> Required *monitor* section.
...
<monitor service="OpenNMS-Login" class-name="org.opennms.netmgt.poller.monitors.PageSequenceMonitor"/> <1>
----
<1> Required *monitor* section.
