= StrafePingMonitor
:description: Learn how to configure and use the StrafePingMonitor in OpenNMS Horizon/Meridian to use ICMP to monitor a specific endpoint and visualize packet loss.
