= StrafePingMonitor
:description: Learn how to configure and use the StrafePingMonitor in {page-component-title} to use ICMP to monitor a specific endpoint and visualize packet loss.
