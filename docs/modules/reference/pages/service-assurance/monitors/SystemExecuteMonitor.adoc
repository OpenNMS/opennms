...
:description: Learn how to configure and use the SystemExecuteMonitor in {page-component-title} to run a system call or a script to determine a service status.
