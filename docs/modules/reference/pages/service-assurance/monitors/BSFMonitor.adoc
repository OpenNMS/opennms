...
= BSFMonitor
:description: Learn how to configure and use the BSFMonitor in {page-component-title} to determine the status of a service through a Bean Scripting Framework.
