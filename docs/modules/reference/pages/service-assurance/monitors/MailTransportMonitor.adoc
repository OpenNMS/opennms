...
:description: Learn about the {page-component-title} MailTransportMonitor that runs a synthetic test of a full email transaction from sending to delivery confirmation.
