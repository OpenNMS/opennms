...
:description: Learn about the OpenNMS Horizon/Meridian MailTransportMonitor that runs a synthetic test of a full email transaction from sending to delivery confirmation.
