...
= NrpeMonitor
:description: Learn about the NrpeMonitor in OpenNMS Horizon/Meridian that lets you test plugins and checks running on the Nagios Remote Plugin Executor (NRPE) framework.
