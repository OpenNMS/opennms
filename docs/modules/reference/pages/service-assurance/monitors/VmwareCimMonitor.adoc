...
= VmwareCimMonitor
:description: Learn how to configure and use the VmwareCimMonitor in OpenNMS Horizon/Meridian to test the health status provided from all host system (host) sensor data.
