...
= BgpSessionMonitor
:description: Learn how to configure and use the BgpSessionMonitor in {page-component-title} to check if a BGP session to a peering partner (peer-ip) is functional.
