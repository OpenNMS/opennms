...
= BgpSessionMonitor
:description: Learn how to configure and use the BgpSessionMonitor in OpenNMS Horizon/Meridian to check if a BGP session to a peering partner (peer-ip) is functional.
