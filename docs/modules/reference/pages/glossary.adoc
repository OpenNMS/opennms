...
(See xref:operation:deep-dive/provisioning/getting-started.adoc#foreign-source-definition[Foreign Source Definition].)
...
(See xref:operation:deep-dive/provisioning/getting-started.adoc#requisition-create[Create a Requisition].)
...
(See xref:operation:deep-dive/provisioning/getting-started.adoc#provision-snmp-configuration[Configure SNMP for Provisioning].)
