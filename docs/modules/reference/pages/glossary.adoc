...
The optional Newts storage strategy requires a Cassandra instance as back-end storage.
...
xref:operation:provisioning/introduction.adoc#discovery-auto[Discovery]::
...
Horizon:: An open-source solution from The OpenNMS Group that helps users visualize and monitor everything on their local and remote networks.
(See https://www.opennms.com/horizon/[OpenNMS Horizon].)
