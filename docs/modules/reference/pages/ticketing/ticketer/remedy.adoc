...
:description: Learn how to use the Remedy Ticketing Plugin to create requests in the BMC Remedy ARS Help Desk Module in response to OpenNMS Horizon/Meridian alarms.
