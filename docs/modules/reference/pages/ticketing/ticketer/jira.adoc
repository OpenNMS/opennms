...
. You should create/change the file jira.properties under your etc folder.
Please fill the following properties with regards to the description down below:
...
| jira.password
| Authentication token from Jira Cloud user security settings
