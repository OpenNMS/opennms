...
Monitors the state of xref:operation:deep-dive/snmp-poller/concepts.adoc[SNMP interfaces] based on the administrative and/or operational state of the interface.
