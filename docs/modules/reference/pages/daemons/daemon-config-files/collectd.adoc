...
Collects xref:operation:deep-dive/performance-data-collection/introduction.adoc[performance management] data to persist node metric data.
...
| instrumentation.log
| Collection statistics used to populate the xref:operation:deep-dive/admin/webui/log-reader.adoc[Instrumentation Log Reader] in the web UI admin section.
|===
