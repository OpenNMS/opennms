...
Once added to `etc/http-datacollection-config.xml`, you can use the `collect` command available in the xref:operation:deep-dive/karaf-shell/karaf-shell.adoc[Karaf shell] to test it:
