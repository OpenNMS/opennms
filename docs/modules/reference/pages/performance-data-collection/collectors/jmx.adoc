...
:description: Learn how to configure and use the JmxCollector in OpenNMS Horizon/Meridian to collect performance data via Java Management Extensions (JMX).
