...
From the xref:operation:deep-dive/karaf-shell/karaf-shell.adoc[Karaf shell], you can now issue an ad hoc collection request against the `node_exporter` process
[source, console]
----
