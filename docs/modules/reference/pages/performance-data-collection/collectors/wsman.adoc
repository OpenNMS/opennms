...
= WsManCollector
:description: Learn how to configure the WsManCollector in OpenNMS Horizon/Meridian to collect performance metrics using the Web Services-Management protocol.
