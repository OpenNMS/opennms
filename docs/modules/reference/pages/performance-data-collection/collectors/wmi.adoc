...
= WmiCollector
:description: Configure the WmiCollector in OpenNMS Horizon/Meridian to collect performance metrics from Windows systems using Windows Management Instrumentation (WMI).
