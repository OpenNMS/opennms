...
If you encounter a configuration error when starting {page-component-title}, you should ensure that {page-component-title} is installed and updated to the latest version:
