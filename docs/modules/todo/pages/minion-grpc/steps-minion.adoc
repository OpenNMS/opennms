...
.Test if gRPC client can connect to {page-component-title} gRPC server
[source, shell]
----
feature:list | grep opennms-core-ipc-grpc-client
opennms-core-ipc-grpc-client                │ 28.0.0.SNAPSHOT  │ x        │ Started
----
...
.Ensure the Minion is registered in the {page-component-title} web interface
