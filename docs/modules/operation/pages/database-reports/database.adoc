...
| Status
|Summary of statistics on outages and availability for user-specified node tag during a user-specified number of days.

| xref:operation:database-reports/templates/availability.adoc[Availability by Node]
| Status
| List of availability statistics for each node in user-specified node tag during a user-specified number of days.

| xref:operation:database-reports/templates/calendar.adoc[Default Calendar]
| Status
...
| xref:operation:database-reports/templates/classic.adoc[Default Classic]
| Status
...
| xref:operation:database-reports/templates/maintenance-strategy.adoc[Maintenance Contracts Strategy]
| Asset Management
...
| Status
| Summary of response times across node tag.
...
Please refer to the xref:development:rest/measurements.adoc[Measurements API documentation] on how to use the Measurements API.
...
Please follow the instructions in this <<admin/http-ssl.adoc#ga-operation-ssl-opennms-trust-store,section>> to set up the Java Truststore correctly.
