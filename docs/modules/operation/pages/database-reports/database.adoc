...
|  xref:operation:database-reports/templates/avail-summary.adoc#avail-summary-report[Availability Summary]
| Status
...
| xref:operation:database-reports/templates/morning.adoc#morning-report[Early Morning Report]
| Status
| Summary of status of network nodes over the past 24 hours.

| xref:operation:database-reports/templates/response-summary.adoc#response-time-summary-report[Response Time Summary]
| Status
| Summary of response times across surveillance category.

| xref:operation:database-reports/templates/response-time.adoc#response-time-report[Response Time by Node]
| Status
| Response times by node.

| xref:operation:database-reports/templates/serial.adoc#serial-interface-report[Serial Interface Utilization Summary]
| Status
| Summary of serial interface utilization.

| xref:operation:database-reports/templates/snmp.adoc#snmp-report[SNMP Interface Availability]
| Status
| Status of SNMP interfaces over time range.

| xref:operation:database-reports/templates/total-bytes.adoc#total-bytes-report[Total Bytes Transferred by Interface]
| Usage
| Bytes transferred by interface.

| xref:operation:database-reports/templates/traffic-rates.adoc#traffic-rate-report[Average and Peak Traffic Rates for Nodes by Interface]
| Usage
