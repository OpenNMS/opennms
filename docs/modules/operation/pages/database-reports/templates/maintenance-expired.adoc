...
This is an asset management report that shows all assets with maintenance contracts that are expiring within a threshold period, which starts today and extends for the number of days specified in the warning threshold parameter below.
