...
The association of metadata with nodes, interfaces, and services happens during <<reference:configuration/provisioning/introduction.adoc#ref-provisioning-meta-data, provisioning>>.
...
* <<provisioning/detectors/detectors.adoc#ga-provisioning-meta-data,Provisioning Detectors>>
