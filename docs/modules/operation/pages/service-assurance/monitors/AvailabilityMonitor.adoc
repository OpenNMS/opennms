...
This monitor has been developed in a time when the <<service-assurance/monitors/IcmpMonitor.adoc#poller-icmp-monitor, IcmpMonitor>> monitor wasn't remote enabled, to circumvent this limitation.
