...
| server-name kbd:[{}]      | This is the DNS hostname to send as part of the TLS negotiation, known as
...
| starttls-start-response kbd:[{}] | Regular expression that must match response to STARTTLS command sent to server. | n/a
|===
