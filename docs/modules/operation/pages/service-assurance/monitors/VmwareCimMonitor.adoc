...
IMPORTANT: This monitor requires to import hosts with _Provisiond_ and the _VMware_ import.
           {page-component-title} requires network access to _VMware vCenter_ and the hosts.
...
NOTE: In case of using link:https://www.vmware.com/content/dam/digitalmarketing/vmware/en/pdf/techpaper/Distributed-Power-Management-vSphere.pdf[Distributed Power Management] the _standBy_ state forces a service _down_.
