...
This monitor supports the following SNMP OIDS from #http://tools.cisco.com/Support/SNMP/do/BrowseOID.do?local=en&translate=Translate&objectInput=1.3.6.1.4.1.9.9.42[CISCO-RTT-MON-MIB]#:
