...
. Execute an action while logged in.
. Log off.

The service is considered as up if all this works.
...
3+|*Required*
| page-sequence  | Definition of the page sequence to execute. See table with_Page Sequence Parameters                 | n/a
3+|*Optional*
...
To use this functionality, add a ds-name attribute to each page whose load time should be tracked.
