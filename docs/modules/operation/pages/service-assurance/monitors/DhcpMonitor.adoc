...
| rrd-base-name  | The name of the RRD file to write (minus the extension, +.rrd+ or +.jrb+)                      | dhcp
| ds-name        | The name as reference for this particular data source in the RRD file.                 | dhcp
3+|*Optional*
