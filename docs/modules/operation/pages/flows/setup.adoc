...
See the examples in `$OPENNMS_HOME/etc/telemetryd-configuration.xml`, or <<reference:telemetryd/listener/introduction.adoc#ref-listener, Telemetryd Listener Reference>> for details.
