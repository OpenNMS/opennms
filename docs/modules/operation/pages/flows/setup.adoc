...
See the examples in `$OPENNMS_HOME/etc/telemetryd-configuration.xml`, or <<telemetryd/listener/introduction.adoc#ref-listener, Telemetryd Listener Reference>> for details.
