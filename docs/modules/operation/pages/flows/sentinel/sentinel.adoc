...
When your flows data collection volume increases to the point that {page-component-title} is too busy processing flows, you can add Sentinel to do the processing instead.
...
* Generate and send events to Horizon Core instance via message broker

Follow the procedures below to set up Sentinel to scale your flows data.
