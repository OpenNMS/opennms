...
A list of currently supported protocols is available in the <<reference:configuration/telemetryd/protocols/introduction.adoc#ref-protocol, Telemetry>> section.
