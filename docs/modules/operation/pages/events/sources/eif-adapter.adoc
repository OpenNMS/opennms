...
These EIF events are translated into {page-component-title} events using pre-configured rules.
The resulting UEI are anchored in the `uei.opennms.org/vendor/IBM/EIF/` namespace, with the name of the EIF event class appended.
