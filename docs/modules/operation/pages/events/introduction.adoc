...
Events may originate within {page-component-title} itself, or from an external source via <<events/sources/snmp-traps.adoc#ga-events-sources-snmp-traps, SNMP traps>>, <<events/sources/syslog.adoc#ga-events-sources-syslog, syslog messages>>, or a variety of other <<events/event-sources.adoc#ga-events-sources-of-events, sources>>.
