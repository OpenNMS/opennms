...
By default, the SSH scripting service collects all SSH session output for debugging and saves it in the poller's status. 
To disable this behavior, configure the scripting service on both {page-component-title} and Minion as below:
