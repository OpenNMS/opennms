...
By default, the ssh scripting service collects all ssh session output for debugging purposes and saves it in the poller's status. 
To disable this, you can configure the scripting service on both Horizon and Minion as below:
