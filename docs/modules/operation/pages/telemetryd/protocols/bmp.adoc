...
|===
| Parameter          | Description                                                                    | Default
| metaDataNodeLookup | Enables lookup using BGP IDs.                                                  | n/a
|===
...
| metaDataNodeLookup | Enables lookup using BGP IDs.                                                  |
|===
...
|===
| Parameter          | Description                                                                    | Default
| kafka.*            | Uses options to create OpenBMP Kafka producer.
                       Enables all known Kafka settings, but with `kafka.` prefixed.                  |
| topicPrefix        | Prefix used before each Kafka topic.                                           |
|===
