...
* Customize a requisition with xref:reference:configuration/provisioning/detectors/detectors.adoc[detectors] and xref:reference:configuration/provisioning/policies/introduction.adoc[policies]
