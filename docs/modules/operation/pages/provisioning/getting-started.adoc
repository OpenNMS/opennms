...
* Customize a requisition with xref:operational:provisioning/detectors/detectors.adoc[detectors] and xref:reference:configuration/provisioning/policies.adoc[policies]
