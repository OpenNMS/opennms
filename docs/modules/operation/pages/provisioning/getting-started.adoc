...
* Customize a requisition with xref:reference:configuration/provisioning/introduction.adoc#ref-detectors[detectors] and xref:provisioning/policies/policies.adoc#policies[policies]
