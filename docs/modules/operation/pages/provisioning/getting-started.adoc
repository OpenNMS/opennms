...
* Customize a requisition with xref:provisioning/detectors/detectors.adoc#ga-detectors[detectors] and xref:provisioning/policies/policies.adoc#policies[policies]
