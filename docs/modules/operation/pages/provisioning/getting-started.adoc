...
* Customize a requisition with xref:reference:configuration/provisioning/detectors.adoc#ref-detectors[detectors] and xref:provisioning/policies/policies.adoc#policies[policies]
