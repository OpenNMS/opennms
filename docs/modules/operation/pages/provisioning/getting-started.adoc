...
* Customize a requisition with xref:operation:provisioning/detectors/detectors.adoc[detectors] and xref:reference:configuration/provisioning/policies.adoc[policies]
