...
Since this detector uses SNMP to accomplish its work, systems against when you use it must have an SNMP agent that supports the HOST-RESOURCES-MIB installed and configured. 
...
| serviceToDetect | none    | Process name to detect.
|===
