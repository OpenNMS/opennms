...
Use link:#ga-provisioning-auto-discovery-detectors[auto discovery with detectors] to specify services that you need to detect in addition to the ICMP IP address ping.
