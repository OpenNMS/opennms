...
Provisioning is a mechanism that imports node and service definitions either from an external source such as DNS or HTTP or via the {page-component-title} web UI.
...
Use xref:reference:provisioning/handlers/introduction.adoc#import-handlers[import handlers] to further control provisioning.
