...
If you want to collect inventory from devices that provide additional fields, you can specify which OIDs to use in the configuration file `$OPENNMS_HOME/etc/snmp-hardware-inventory-adapter-configuration.xml`.
