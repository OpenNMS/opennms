...
You can configure a path outage for an individual node by setting a parent on the node in a requisition, or create a rule-based configuration for a group of nodes:
