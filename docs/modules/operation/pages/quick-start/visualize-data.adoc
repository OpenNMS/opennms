...
:description: Step 9 of {page-component-title} setup: how to visualize your environment's data with dashboard, surveillance view, and trend page.
...
Refer to Visualizations in the Deep Dive section for more information on the available visualizations.
