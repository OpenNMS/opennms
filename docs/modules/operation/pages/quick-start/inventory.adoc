...
NOTE: It is possible to use meta-data expressions in the fields Security Name, Read Community, Write Community, Auth Passphrase and Privacy Passphrase to reference credentials stored in the Secure Credentials Vault.
