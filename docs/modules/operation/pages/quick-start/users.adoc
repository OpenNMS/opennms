...
. On the *admin* menu, click *Change Password*.
...
. Click the *Gear* symbol at the top-right of the screen, under OpenNMS System, click *Configure Users, Groups and On-Call Roles*.
. In the *Users and Groups* screen, click *Configure Users*.
