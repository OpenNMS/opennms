...
For information on supported ticketers and how to configure them, see xref:reference:configuration/ticketing/introduction.adoc[ticketer reference section].