...
Thresholding for streaming telemetry with <<telemetryd/introduction#ga-telemetryd, telemetryd>> is supported on Sentinel when using <<admin/newts/introduction.adoc#ga-opennms-operation-newts, Newts>>.
