...
| Triggered UEI
| A custom universal event identifier (UEI) sent into the events system when the threshold is triggered.
...
| Re-armed UEI
| A custom universal event identifier (UEI) sent into the events system when the threshold is re-armed.
 | leave blank
