...
To discover Links an algorithm based on a scientific paper with the title #link:https://cs-pub.bu.edu/groups/nrg/readinglist/lowekamp-sigcomm01.pdf[Topology Discovery for Large Ethernet Networks]# is implemented.
