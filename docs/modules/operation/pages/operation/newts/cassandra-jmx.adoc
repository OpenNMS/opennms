...
The documentation for Cassandra Thread pool monitoring is originated from link:https://blog.pythian.com/guide-to-cassandra-thread-pools[Pythian Guide to Cassandra Thread Pools].
