...
Configure access to the SNMP agent through the SNMP configuration in the Web UI (<<provisioning/getting-started.adoc#provision-snmp-configuration,`Admin>Configure SNMP Community Names by IP Address`>>). 
