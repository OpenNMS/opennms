...
WS-Management is a DMTF open standard defining a SOAP-based protocol for the management of servers, devices, applications, and web services.
...
.Required collector-specific parameter for the WsManCollector
