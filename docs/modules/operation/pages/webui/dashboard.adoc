...
To give a quick entry point diagnose performance issues a Resource Graph Viewer lets you navigate to time series data reports which are filtered in the context of the Surveillance View.
...
The Surveillance View component lets you to model multiple views for different monitoring contexts.
