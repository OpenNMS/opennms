...
[[ga-alarm-history]]
= Alarm History
:description: Find out how OpenNMS Horizon/Meridian can use Elasticsearch to persist historical alarm data: indexing, alarm document fields, and properties.
