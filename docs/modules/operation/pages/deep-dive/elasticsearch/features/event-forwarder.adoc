...
NOTE: Forwarded events are written to time-based indices that {page-component-title} does not expire.
See <<deep-dive/elasticsearch/introduction.adoc#ga-elasticsearch-index-retention, Index retention>> to avoid filling the Elasticsearch disk.
