...
----
The `opennms-pagerduty:eval-jexl` command can evaluate a JEXL expression against a single alarm (using `--alarm-id`) or against all available alarms (the default).
