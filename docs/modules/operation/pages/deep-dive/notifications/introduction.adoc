...
* Browser-based desktop notifications, which each user opts in to per browser (see xref:operation:quick-start/notifications.adoc[Turn on Default Notifications])
