...
[[ga-telemetryd]]
= Telemetry Daemon
:description: Learn about the telemetry daemon in OpenNMS Horizon/Meridian to support applications that use different protocols to transfer metrics data.
