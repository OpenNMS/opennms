...
[[data-types]]
= Data Types
:description: Over of data types collected in OpenNMS Horizon/Meridian including counter, gauge, integer, IpAddress, OctetString, Opaque, String, and TimeTicks.
