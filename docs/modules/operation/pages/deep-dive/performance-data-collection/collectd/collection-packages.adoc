...
For a list of collector-specific parameters and their default values, refer to the specific collector listed in the xref:reference:performance-data-collection/collectors/introduction.adoc[Collectors] section.
