...
:description: Enum lookup property extender in OpenNMS Horizon/Meridian to map an enumerated set of integer values to a corresponding set of human-readable text values.
