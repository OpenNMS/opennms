...
:description: Create custom resource types in OpenNMS Horizon/Meridian to collect SNMP data from tables with arbitrary indexes: attributes, mibObj definitions.
