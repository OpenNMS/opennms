...
The `opennms:stress-metrics` xref:deep-dive/karaf-shell/karaf-shell.adoc[Karaf shell] command can be used to simulate load on the active persistence strategy, whether it be `RRDtool`, `JRobin`, or `Newts`.
