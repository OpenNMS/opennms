...
= Ad hoc collection
:description: Ad hoc collection commands in Horizon/Meridian via xref:deep-dive/karaf-shell/karaf-shell.adoc[Karaf shell] to perform a collection on any available collectors for troubleshooting and testing.
