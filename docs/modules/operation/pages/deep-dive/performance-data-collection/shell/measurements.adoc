...
The following xref:reference:karaf-shell/karaf-shell.adoc[Karaf shell] commands are made available to help enumerate, view, and manage measurement-related resources.
