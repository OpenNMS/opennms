// This file is included in deployment:time-series-storage/newts/resourcecli.adoc.  Any change to this file name will need to be updated in that file as well.
...
The following xref:operation:deep-dive/karaf-shell/karaf-shell.adoc[Karaf shell] commands are made available to help enumerate, view, and manage measurement-related resources.
