...
:description: Learn more about discovering Layer 2 network links using bridge forwarding in OpenNMS Horizon/Meridian topology mapping, including supported OIDs.
