...
= Ticketing
:description: Learn how the ticketer plugin helps OpenNMS Horizon/Meridian create and update tickets in external systems based on new or resolved alarms.
