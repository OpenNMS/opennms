...
:description: Overview of how to back up configuration for devices like routers, firewalls, and switches with OpenNMS Horizon/Meridian, for better disaster recovery.
