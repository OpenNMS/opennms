...
:description: Back up configuration for devices like routers, firewalls, switches with OpenNMS Horizon/Meridian, for better disaster recovery and change management.
