...
You will reference this script when you xref:operation:deep-dive/device-config-backup/dcb-requisition.adoc#dcb-requisition[create a requisition] for a device of this type.
