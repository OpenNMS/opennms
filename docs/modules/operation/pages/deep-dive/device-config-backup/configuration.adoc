...
:description: Device Configuration Backup feature poller configuration in OpenNMS Horizon/Meridian: TFTP port and IP address, events, parameters, thread pool adjustments.
