...
:description: Poller configuration in OpenNMS Horizon/Meridian for device configuration backup: TFTP port and IP address, events, parameters, thread pool adjustments.
