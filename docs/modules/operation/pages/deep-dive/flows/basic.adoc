...
(Also see xref:operation:deep-dive/admin/daemon-config-files.adoc#daemon-reload[Reload daemons by CLI].)
...
* xref:operation:deep-dive/flows/distributed.adoc#flows-remote[Enable remote flows data collection]
* xref:operation:deep-dive/flows/sentinel/sentinel.adoc#flows-scaling[Scale to manage large volumes of flows data]
