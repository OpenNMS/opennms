...
NOTE: Make sure you complete the tasks in xref:operation:quick-start/inventory.adoc[Step 3: Provision Inventory] before adding nodes.
...
| initial-sleep-time
| 30000 ms (30 seconds)
| The time, in milliseconds, before the discovery process begins after {page-component-title} has started.
