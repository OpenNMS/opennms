...
image::thresholding/Graphs.png["Two example performance data metric graphs: one displaying system uptime, and one displaying the number of active processes over time"]
