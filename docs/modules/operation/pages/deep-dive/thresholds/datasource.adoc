...
For information on how to create a basic or expression-based threshold, see xref:quick-start/thresholding.adoc[Step 5: Set up a Threshold] in the Quick Start section.
...
.{page-component-title} dashboard displaying thresholding events
...
+
.{page-component-title} metric graphs
image::thresholding/Graphs.png["Two example metric graphs: one displaying system uptime, and one displaying the number of active processes across a time period"]
