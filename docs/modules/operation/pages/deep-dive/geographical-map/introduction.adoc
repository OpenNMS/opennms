= Geographical Maps
:description: Learn more about the geographical map in OpenNMS Horizon/Meridian that displays nodes with address asset information, including dynamic alarm status.
