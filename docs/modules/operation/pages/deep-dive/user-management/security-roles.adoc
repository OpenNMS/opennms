...
| ROLE_REST
| Permissions to interact with the {page-component-title} REST API. +
Writing configuration through the REST API (the `/rest/config` endpoints) requires `ROLE_ADMIN`.
