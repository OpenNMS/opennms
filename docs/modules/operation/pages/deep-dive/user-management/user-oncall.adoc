...
. Click menu:User Management[Manage On-call Roles] in the side menu.
. Or, click menu:Administration[Configure OpenNMS] in the side menu, then under OpenNMS System, click menu:Configure Users, Groups and On-Call Roles[Configure On-Call Roles].
