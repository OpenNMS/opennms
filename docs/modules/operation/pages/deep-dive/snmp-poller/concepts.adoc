...
= SNMP Interface Poller
:description: Learn how the SNMP Interface Poller in OpenNMS Horizon/Meridian monitors the SNMP interfaces not being directly monitored by the Service Assurance monitor.
