...
:description: Learn how to create a Response Time Summary report in OpenNMS Horizon/Meridian, which displays ICMP latency statistics for each IP interface.
