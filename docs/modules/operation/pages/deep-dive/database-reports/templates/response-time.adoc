...
image:database-reports/node-response-report.png["Example of a Node Response Time report. A table of nodes in the Cameras surveillance category is displayed, with response statistics.", 700]
