...
:description: Learn how to create an Interface Availability report in OpenNMS Horizon/Meridian, which summarizes interface availability for interfaces with outages.
