...
:description: Learn how to create and Interface Availability report in OpenNMS Horizon/Meridian, which summarizes interface availability for interfaces with outages.
