...
:description: Learn how to create a report in OpenNMS Horizon/Meridian that summarizes the number of bytes transferred by each interface that matches a category.
