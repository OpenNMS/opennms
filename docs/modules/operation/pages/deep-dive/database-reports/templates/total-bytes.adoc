...
image:database-reports/total-bytes-interface.png["Example of a Total Bytes Transferred by Interface report. A table of interfaces in the Cameras surveillance category is displayed with transferred byte statistics.", 700]
