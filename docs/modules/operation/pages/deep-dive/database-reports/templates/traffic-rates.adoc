...
:description: Learn how to create a report in OpenNMS Horizon/Meridian that summarizes the the average and peak traffic rates for nodes that match a specified node tag.
