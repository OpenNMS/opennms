...
{page-component-title} lets you create a report for any Grafana dashboard, not just those created using http://docs.opennms.org/helm/branches/master/helm/latest/welcome/index.html[OpenNMS Helm].

You must set Grafana as a data source by xref:grafana-endpoint[configuring the Grafana endpoint] in {page-component-title}.
