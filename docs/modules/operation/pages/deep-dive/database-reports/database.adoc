...
See <<deep-dive/admin/https/https-client.adoc#ga-operation-ssl-opennms-trust-store, Configure {page-component-title} to use the defined Java Truststore>> for setup instructions.
