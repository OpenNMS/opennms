...
= Heatmap
:description: Learn about the heatmap visualization in OpenNMS Horizon/Meridian, which displays unacknowledged alarms or ongoing outages, depending on its configuration.
