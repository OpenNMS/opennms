...
= Operator Board
:description: Learn about the operator board in OpenNMS Horizon/Meridian, which provides customizable dashlets to display information like alarms and availability maps.
