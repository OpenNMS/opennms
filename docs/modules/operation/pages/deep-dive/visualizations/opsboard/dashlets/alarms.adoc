...
The Alarms dashlet displays a table with a short descriptions of alarms in the xref:deep-dive/visualizations/opsboard/introduction.adoc[operator board].
