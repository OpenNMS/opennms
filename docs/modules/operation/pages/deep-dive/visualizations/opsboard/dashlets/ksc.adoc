...
This dashlet displays data from an existing https://opennms.discourse.group/t/ksc-report-configuration/2209[KSC report] in the <<deep-dive/visualizations/opsboard/introduction.adoc#opsboard-config, ops board>>.
