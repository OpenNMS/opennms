...
[[ksc]]
= KSC Reports
:description: Learn about the KSC Reports dashlet, which displays an existing Kapersky Security Center (KSC) report in the OpenNMS Horizon/Meridian operator board.
