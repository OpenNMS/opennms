...
The Charts dashlet displays predefined bar graphs in the Charts UI (menu:Reports[Charts]) and the <<deep-dive/admin/webui/opsboard/introduction.adoc#opsboard-config, ops board>>.
