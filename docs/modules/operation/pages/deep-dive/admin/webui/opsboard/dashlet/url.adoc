...
This dashlet shows the content of a web page or other web application in the xref:deep-dive/admin/webui/opsboard/introduction.adoc#opsboard-config[Ops Board] (for example, other monitoring systems by a given URL).
