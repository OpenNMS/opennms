...
For more information on configuring a surveillance view, see xref:deep-dive/admin/webui/surveillance-view.adoc[].
...
This procedure shows how to assign the Dashboard role to a new user (`drv4doe`):
