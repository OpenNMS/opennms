...
To create a truststore, follow the example in the <<deep-dive/admin/configuration/https/http-ssl.adoc#ga-operation-https-client, HTTPS client instructions>>.
