...
In the {page-component-title} web UI, click the *gear* symbol in the top-right of the screen.
...
For more details, see the https://wiki.openstreetmap.org/wiki/Nominatim[official Nominatim documentation] and check the https://operations.osmfoundation.org/policies/nominatim/[Nominatim Usage Policy] before using the geocoder service.
