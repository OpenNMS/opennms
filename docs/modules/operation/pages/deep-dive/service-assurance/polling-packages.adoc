...
image::service-assurance/03_polling-package.png["Screen displaying interface and service statistics for a polling package", 700]
...
To troubleshoot the polling services, you can run a test via the Karaf shell:
...
Use the Karaf shell to verify filters.
