...
A number of xref:deep-dive/karaf-shell/karaf-shell.adoc[Karaf shell] commands are available to help administer and diagnose issues related to service assurance.
