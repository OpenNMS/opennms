...
A number of xref:reference:karaf-shell/karaf-shell.adoc[Karaf shell] commands are available to help administer and diagnose issues related to service assurance.
