...
See xref:reference:configuration/notifications/command/mattermost.adoc[Mattermost] and xref:reference:configuration/notifications/command/slack.adoc[Slack] notifications for how to configure for these methods.
