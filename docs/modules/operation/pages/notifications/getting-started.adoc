...
{page-component-title} includes newer notification methods that currently require manual steps to activate.
See xref:reference:configuration/notifications/commands/mattermost.adoc[Mattermost] and xref:reference:configuration/notifications/commands/slack.adoc[Slack] notifications for how to configure for these methods.
