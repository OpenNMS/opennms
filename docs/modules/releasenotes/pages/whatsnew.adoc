...
It is recommended to instead use Kafka for use cases that require horizontal scaling of Minion communication.
...
The Minion is continuing to receive improvements in performance and features.
