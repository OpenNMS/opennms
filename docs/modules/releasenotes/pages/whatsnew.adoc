...
The release of OpenNMS {page-component-title} {page-component-version} will be the last version that supports reading and writing time series data using JRobin.
The JRobin library and the JRobin time series strategy will be removed from Horizon 35+ moving forward.
