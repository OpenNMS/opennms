...
== Deprecation of Tl1d
We removed Tl1d service from service configuration. We believe none of our users are using this service. The code will be
removed in the next Horizon version 35.

== Deprecation of AsteriskGateway
We removed AsteriskGateway service from service configuration. We believe none of our users are using this service. The code will be
removed in the next Horizon version 35.
