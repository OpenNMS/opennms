...
[[releasenotes-changelog-29.0.11]]

== Release 29.0.11

Release 29.0.11 contains a number of bug fixes and enhancements.

The codename for Horizon 29.0.11 is https://wikipedia.org/wiki/$$Hawk$$[_Hawk_].


=== Bug

* Admin guide lacks a chapter on logging (Issue http://issues.opennms.org/browse/NMS-8861[NMS-8861])
...
* Event/Alarm advanced search not passing search terms (Issue http://issues.opennms.org/browse/NMS-14161[NMS-14161])
