...
The codename for Horizon 33.0.0 is https://wikipedia.org/wiki/Breakcore[_Breakcore_].

=== Enhancement

* special nodes availability (Issue https://issues.opennms.org/browse/NMS-9797[NMS-9797])
...
* document the asynchronous datacollection engine (Issue https://issues.opennms.org/browse/NMS-15737[NMS-15737])
...
* Upgrade Spring from 4.2 to 4.3 (Issue https://issues.opennms.org/browse/NMS-12090[NMS-12090])
...
* Use a different html parser to replace jsoup and owasp functionality (Issue https://issues.opennms.org/browse/NMS-16183[NMS-16183])
...
* create an asynchronous datacollection engine (Issue https://issues.opennms.org/browse/NMS-15736[NMS-15736])
