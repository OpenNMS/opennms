...
= Changelog
[[releasenotes-changelog-33.1.11]]

== Release 33.1.11

Release 33.1.11 contains bug fixes, security updates and new features.

The codename for Horizon 33.1.11 is https://wikipedia.org/wiki/$$Calliandra_haematocephala$$[_Powderpuff_].
