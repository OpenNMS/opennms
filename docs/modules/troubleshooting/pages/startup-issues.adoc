...
See xref:deployment:core/requirements.adoc[] for software compatibility requirements, including supported Java versions.
...
See xref:deployment:core/install.adoc#setup-postgresql[Set up PostgreSQL] for information on installing and setting up PostgreSQL.
