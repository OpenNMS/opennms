...
`$OPENNMS_HOME/logs/karafStartupMonitor.log` contains information relating to server events and the start and stop processes for {page-component-title} karaf related services.
