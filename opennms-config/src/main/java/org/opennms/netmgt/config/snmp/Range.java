...
@SuppressWarnings("all") public class Range implements java.io.Serializable {
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled org.opennms.netmgt.config.snmp.Range
     */
    public static org.opennms.netmgt.config.snmp.Range unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.opennms.netmgt.config.snmp.Range) Unmarshaller.unmarshal(org.opennms.netmgt.config.snmp.Range.class, reader);
    }
