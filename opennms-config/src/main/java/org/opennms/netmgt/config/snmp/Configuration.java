...
@SuppressWarnings("all") public class Configuration implements java.io.Serializable {
    ...
    /**
     * The proxy host to use when communiciating with this
     *  agent
     */
    private java.lang.String _proxyHost;

    /**
     * If set, forces SNMP data collection to the specified
     *  version.
     */
    ...
    /**
     * (SNMP4J specific) Specifies the maximum number of bytes that
     * may be
     *  encoded into an individual SNMP PDU request by Collectd.
     * Provides a
     *  means to limit the size of outgoing PDU requests. Default
     * is 65535, must be 
     *  at least 484.
     */
     ...
     * SNMPv3
     */
    private java.lang.String _contextEngineId;
     ...
     * SNMPv3
     */
    private java.lang.String _enterpriseId;
    ...
    public boolean equals(
        ...
        if (obj instanceof Configuration) {
            ...
            if (this._readCommunity != null) {
                if (temp._readCommunity == null) return false;
            ...
            if (this._writeCommunity != null) {
                if (temp._writeCommunity == null) return false;
            ...
            if (this._proxyHost != null) {
                if (temp._proxyHost == null) return false;
            ...
            if (this._contextEngineId != null) {
                if (temp._contextEngineId == null) return false;
            ...
            if (this._enterpriseId != null) {
                if (temp._enterpriseId == null) return false;
    ...
    /**
     * Returns the value of field 'contextEngineId'. The field
     * 'contextEngineId' has the following description: SNMPv3
     * 
    ...
    /**
     * Returns the value of field 'contextName'. The field
     * 'contextName' has the following description: SNMPv3
     * 
    ...
    /**
     * Returns the value of field 'enterpriseId'. The field
     * 'enterpriseId' has the following description: SNMPv3
     * 
    ...
    /**
     * Returns the value of field 'maxRepetitions'. The field
     * 'maxRepetitions' has the following description: Number of
     * repetitions to send per get-bulk request.
     *  
     * 
    ...
    /**
     * Returns the value of field 'maxRequestSize'. The field
     * 'maxRequestSize' has the following description: (SNMP4J
     * specific) Specifies the maximum number of bytes that may be
     *  encoded into an individual SNMP PDU request by Collectd.
     * Provides a
     *  means to limit the size of outgoing PDU requests. Default
     * is 65535, must be 
    ...
    /**
     * Returns the value of field 'proxyHost'. The field
     * 'proxyHost' has the following description: The proxy host to
     * use when communiciating with this
     *  agent
     * 
    ...
    /**
     * Returns the value of field 'readCommunity'. The field
     * 'readCommunity' has the following description: Default read
     * community string
     * 
     ...
     * has the following description: If set, forces SNMP data
    ...
    /**
     * Returns the value of field 'writeCommunity'. The field
     * 'writeCommunity' has the following description: Default
    ...
    /**
     * Sets the value of field 'contextEngineId'. The field
     * 'contextEngineId' has the following description: SNMPv3
     * 
     * @param contextEngineId the value of field 'contextEngineId'.
     */
    public void setContextEngineId(
            final java.lang.String contextEngineId) {
        this._contextEngineId = contextEngineId;
    }

    /**
     * Sets the value of field 'contextName'. The field
     * 'contextName' has the following description: SNMPv3
     * 
     * @param contextName the value of field 'contextName'.
     */
    public void setContextName(
            final java.lang.String contextName) {
    ...
    /**
     * Sets the value of field 'enterpriseId'. The field
     * 'enterpriseId' has the following description: SNMPv3
     * 
     * @param enterpriseId the value of field 'enterpriseId'.
     */
    public void setEnterpriseId(
            final java.lang.String enterpriseId) {
        this._enterpriseId = enterpriseId;
    }

    /**
     * Sets the value of field 'maxRepetitions'. The field
     * 'maxRepetitions' has the following description: Number of
     * repetitions to send per get-bulk request.
     *  
     * 
     * @param maxRepetitions the value of field 'maxRepetitions'.
     */
    ...
    /**
     * Sets the value of field 'maxRequestSize'. The field
     * 'maxRequestSize' has the following description: (SNMP4J
     * specific) Specifies the maximum number of bytes that may be
     *  encoded into an individual SNMP PDU request by Collectd.
     * Provides a
     ...
     *  at least 484.
     * 
     * @param maxRequestSize the value of field 'maxRequestSize'.
     */
    ...
    /**
     * Sets the value of field 'proxyHost'. The field 'proxyHost'
     * has the following description: The proxy host to use when
     * communiciating with this
     *  agent
     * 
     * @param proxyHost the value of field 'proxyHost'.
     */
    public void setProxyHost(
            final java.lang.String proxyHost) {
        this._proxyHost = proxyHost;
    }

    /**
     * Sets the value of field 'readCommunity'. The field
     * 'readCommunity' has the following description: Default read
     * community string
     * 
     * @param readCommunity the value of field 'readCommunity'.
     */
    public void setReadCommunity(
            final java.lang.String readCommunity) {
     ...
     * the following description: If set, forces SNMP data
     * collection to the specified
     *  version.
     * 
    ...
    /**
     * Sets the value of field 'writeCommunity'. The field
     * 'writeCommunity' has the following description: Default
     * write community string
     * 
     * @param writeCommunity the value of field 'writeCommunity'.
     */
    public void setWriteCommunity(
            final java.lang.String writeCommunity) {
    ...
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.opennms.netmgt.config.snmp.Configuration) Unmarshaller.unmarshal(org.opennms.netmgt.config.snmp.Configuration.class, reader);
    }
