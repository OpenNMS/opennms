...
public class Rrd implements java.io.Serializable {
     ...
     * collection
     */
    public java.util.Enumeration<String> enumerateRra(
    ) {
    ...
    throws IndexOutOfBoundsException {
        ...
        return (String) _rraList.get(index);
    }
    ...
    public String[] getRra(
        ...
        return (String[]) this._rraList.toArray(array);
    }
     ...
     * collection
     */
    public java.util.Iterator<String> iterateRra(
    ) {
     ...
     */
    public String removeRraAt(
            final int index) {
        Object obj = this._rraList.remove(index);
        return (String) obj;
    }
     ...
     */
    public void setRra(
            final java.util.List<String> vRraList) {
        // copy vector
        this._rraList.clear();
    ...
    public void setRraCollection(
            final java.util.List<String> rraList) {
