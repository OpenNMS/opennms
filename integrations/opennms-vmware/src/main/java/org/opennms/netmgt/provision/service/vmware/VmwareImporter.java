...
public class VmwareImporter {
     ...
     */
    private void iterateHostSystems(final VmwareViJavaAccess vmwareViJavaAccess, int apiVersion) {
     ...
     * @param vmwareViJavaAccess the access/connection to use
     */
    private void iterateVirtualMachines(final VmwareViJavaAccess vmwareViJavaAccess, int apiVersion) {
        ManagedEntity[] managedEntities = null;
