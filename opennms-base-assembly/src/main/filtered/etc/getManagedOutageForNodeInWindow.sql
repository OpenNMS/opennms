...
--
--
DROP FUNCTION IF EXISTS getManagedOutageForNodeInWindow(integer,float8,float8);
DROP FUNCTION IF EXISTS getManagedOutageForNodeInWindow(integer,text,text);
