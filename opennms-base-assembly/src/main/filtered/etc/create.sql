...
create table alarms (
    ...
    eventParametersRef      INTEGER NOT NULL, CONSTRAINT fk_alarmsEventParametersRef FOREIGN KEY (eventParametersRef) REFERENCES events (eventID) ON DELETE RESTRICT
