...
public class ServletRequestHandler implements RequestHandler {
    ...
    public ServletRequestHandler(ServletInfo servletInfo) {
        this.servletInfo = Objects.requireNonNull(servletInfo);
    }

    @Override
    public List<String> getPatterns() {
        return Collections.unmodifiableList(servletInfo.getPatterns());
    }
