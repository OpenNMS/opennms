...
public class Mapping implements Serializable {
    ...
    public void setSysoidMask(final String sysoidMask) {
        m_sysoidMask = ConfigUtils.assertNotEmpty(sysoidMask, "sysoid-mask");
    }

    public Optional<String> getSysdescrMatch() {
        return Optional.ofNullable(m_sysdescrMatch);
    }

    public void setSysdescrMatch(final String sysdescrMatch) {
        m_sysdescrMatch = ConfigUtils.normalizeString(sysdescrMatch);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(m_sysoidMask, 
                            m_sysdescrMatch, 
                            m_type);
    }
    ...
    public boolean equals(final Object obj) {
        ...
        if (obj instanceof Mapping) {
            ...
            return Objects.equals(this.m_sysoidMask, that.m_sysoidMask)
                    && Objects.equals(this.m_sysdescrMatch, that.m_sysdescrMatch)
