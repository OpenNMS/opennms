...
@SuppressWarnings("all") public class Rrd implements java.io.Serializable {
     ...
     * @throws org.exolab.castor.xml.ValidationException if this
     * object is an invalid instance according to the schema
     * @return the unmarshaled org.opennms.netmgt.config.poller.Rrd
     */
    public static org.opennms.netmgt.config.poller.Rrd unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.opennms.netmgt.config.poller.Rrd) Unmarshaller.unmarshal(org.opennms.netmgt.config.poller.Rrd.class, reader);
    }
