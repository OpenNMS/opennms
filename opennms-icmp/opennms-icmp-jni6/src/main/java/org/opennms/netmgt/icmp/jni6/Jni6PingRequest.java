...
public class Jni6PingRequest implements Request<Jni6PingRequestId, Jni6PingRequest, Jni6PingResponse>, EchoPacket {
    ...
    public Jni6PingRequest(final Jni6PingRequestId id, final long timeout, final int retries, final ThreadCategory log, final PingResponseCallback callback) {
        m_id = id;
        m_timeout = timeout;
        m_retries = retries;
        m_log = log;
    ...
    public Jni6PingRequest(final Inet6Address addr, final int identifier, final int sequenceNumber, final long threadId, final long timeout, final int retries, final ThreadCategory logger, final PingResponseCallback cb) {
        this(new Jni6PingRequestId(addr, identifier, sequenceNumber, threadId), timeout, retries, logger, cb);
    }
    
    public Jni6PingRequest(final Inet6Address addr, final int identifier, final int sequenceNumber, final long threadId, final long timeout, final int retries, final PingResponseCallback cb) {
        this(addr, identifier, sequenceNumber, threadId, timeout, retries, ThreadCategory.getInstance(Jni6PingRequest.class), cb);
    }

    public Jni6PingRequest(final Inet6Address addr, final int identifier, final int sequenceNumber, final long timeout, final int retries, final PingResponseCallback cb) {
