...
find $RPM_BUILD_ROOT%{jettydir} ! -type d | \
    ...
    grep -v '/WEB-INF/applicationContext-acegi-security.xml$' | \
...
%config %{jettydir}/%{servletdir}/WEB-INF/applicationContext-acegi-security.xml
...
%config %{webappsdir}/%{servletdir}/WEB-INF/applicationContext-acegi-security.xml
