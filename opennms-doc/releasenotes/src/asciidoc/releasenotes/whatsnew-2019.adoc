...
Release 2019.1.13 contains a bunch of bug fixes and a few handy enhancements.

The codename for 2019.1.13 is link:$$https://en.wikipedia.org/wiki/Haumea$$[_Haumea_].
