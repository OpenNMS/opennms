...
For a more complete list of major changes included in this release, see the link:https://vault.opennms.com/docs/opennms/releases/26.1.3/releasenotes/releasenotes.html["What's New" documentation] for Horizon 26.1.3.

=== Changelog

[releasenotes-changelog-Meridian-2020.1.20]

==== Release Meridian-2020.1.20

Release 2020.1.20 contains mostly bug fixes, including some small security-related changes.

The codename for Horizon 2020.1.20 is https://wikipedia.org/wiki/$$Headland$$[_Headland_].
...
[[releasenotes-changelog-Meridian-2020.1.19]]

==== Release Meridian-2020.1.19

Release 2020.1.19 is a small release with a number of bug fixes, including a few security
...
The codename for Horizon 2020.1.19 is https://wikipedia.org/wiki/$$Mid-ocean_ridge$$[_Mid-Ocean Ridge_].
...
[[releasenotes-changelog-Meridian-2020.1.18]]

==== Release Meridian-2020.1.18

Release 2020.1.18 is a small release with another upgrade for Log4j2 as well as an NPE
...
The codename for 2020.1.18 is link:https://wikipedia.org/wiki/$$Cuspate_foreland$$[_Cuspate Foreland_].
...
[[releasenotes-changelog-Meridian-2020.1.17]]

==== Release Meridian-2020.1.17

Release 2020.1.17 is a re-release of 2020.1.16 with additional fixes relating to
Log4j2 vulnerabilities.

The codename for 2020.1.17 is link:https://wikipedia.org/wiki/$$Blowhole_(geology)$$[_Blowhole_].

===== Bug

* CVE-2021-45046: incomplete Log4j2 vulnerability mitigation (Issue http://issues.opennms.org/browse/NMS-13858[NMS-13858])

[[releasenotes-changelog-Meridian-2020.1.16]]

==== Release Meridian-2020.1.16

Release 2020.1.16 is an out-of-band release with a fix for the Log4j2 security issue.

The codename for 2020.1.16 is link:https://wikipedia.org/wiki/$$Stack_(geology)$$[_Stack_].

===== Bug

* Log4j2 0-day: CVE-2021-44228 (Issue http://issues.opennms.org/browse/NMS-13850[NMS-13850])

[[releasenotes-changelog-Meridian-2020.1.15]]

==== Release Meridian-2020.1.15

Release 2020.1.15 contains a fix for a Jetty CVE, plus an update to fix a bug in user auth changes,
and an enhancement to SNMPv3 user authentication.

The codename for 2020.1.15 is link:https://wikipedia.org/wiki/$$Lagoon$$[_Lagoon_].
...
[[releasenotes-changelog-Meridian-2020.1.14]]
...
The codename for 2020.1.14 is link:https://wikipedia.org/wiki/$$Tessellated_pavement$$[_Tessellated Pavement_].
...
[[releasenotes-changelog-Meridian-2020.1.13]]

==== Release Meridian-2020.1.13

Release 2020.1.13 contains a couple of small bug fixes.

The codename for 2020.1.13 is link:https://wikipedia.org/wiki/$$Strait$$[_Strait_].
...
[[releasenotes-changelog-Meridian-2020.1.12]]

==== Release Meridian-2020.1.12

Release 2020.1.12 contains a few small bug fixes, including a CVE dependency update.

The codename for 2020.1.12 is link:https://wikipedia.org/wiki/$$Atoll$$[_Atoll_].
...
[[releasenotes-changelog-Meridian-2020.1.11]]
...
The codename for 2020.1.11 is link:https://wikipedia.org/wiki/$$Ayre_(landform)$$[_Ayre_].
...
[[releasenotes-changelog-Meridian-2020.1.10]]
...
The codename for 2020.1.10 is link:https://wikipedia.org/wiki/$$Calanque$$[_Calanque_].
...
[[releasenotes-changelog-Meridian-2020.1.9]]

==== Release Meridian-2020.1.9

Release 2020.1.9 contains a few bug fixes and enhancements.

The codename for 2020.1.9 is link:https://wikipedia.org/wiki/$$Wave-cut_platform$$[_Wave-Cut Platform_].

===== Bug

* IP interface link in Response Time graph page is broken (Issue http://issues.opennms.org/browse/NMS-13158[NMS-13158])
* Got Access Denied when viewing On-Call Role schedule (Issue http://issues.opennms.org/browse/NMS-13287[NMS-13287])
...
[[releasenotes-changelog-Meridian-2020.1.8]]

==== Release Meridian-2020.1.8

Release 2020.1.8 contains a number of security fixes, as well as fixes for a few other bugs.

The codename for 2020.1.8 is link:https://wikipedia.org/wiki/$$Isthmus$$[_Isthmus_].
...
* Sidebar navigation on the graph results page is not working (Issue http://issues.opennms.org/browse/NMS-13259[NMS-13259])
