...
ifndef::opennms-prime[]
include::text/run-with-docker/introduction.adoc[]
include::text/run-with-docker/opennms-config.adoc[]
include::text/run-with-docker/minion-config.adoc[]
include::text/run-with-docker/sentinel-config.adoc[]
endif::opennms-prime[]
