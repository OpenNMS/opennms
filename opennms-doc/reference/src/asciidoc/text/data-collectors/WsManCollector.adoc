...
[[ref-performance-mgmt-collectors-wsman-collector]]
==== WsManCollector
...
[[ref-performance-mgmt-collectors-wsman-setup]]
===== WS-Management Setup
...
[[ref-performance-mgmt-collectors-wsman-agent-config]]
...
[[ref-performance-mgmt-collectors-wsman-system-definitions]]
====== System Definitions
...
[[ref-performance-mgmt-collectors-wsman-group-definitions]]
====== Group Definitions
