...
:imagesdir: ../../images/service-monitors/DhcpMonitor
...
image::service-monitors/DhcpMonitor/01_dhcp-monitor-messages-broadcast.png[]

.Visualization of DHCP message flow in relay mode
image::service-monitors/DhcpMonitor/02_dhcp-monitor-messages-unicast.png[]
