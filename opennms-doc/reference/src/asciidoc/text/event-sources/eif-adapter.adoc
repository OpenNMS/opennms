...
[[ref-events-sources-eif]]
=== IBM Tivoli EIF Events

_OpenNMS_ can be configured to receive _Events_ sent using the https://www.ibm.com/support/knowledgecenter/SSSHTQ_7.3.1/com.ibm.netcool_OMNIbus.doc_7.3.1/omnibus/wip/eifsdk/concept/kaa24487.html[Tivoli Event Integration Facility](EIF).
...
[[ref-events-sources-eif-configuring]]
...
[[ref-events-sources-eif-troubleshooting]]
==== Troubleshooting
