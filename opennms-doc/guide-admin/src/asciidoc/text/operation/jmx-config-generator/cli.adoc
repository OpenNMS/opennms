...
| `-dictionary`        | Path to an dictionary file for replacing attriubte names and part of _MBean Attributes_.
...
It is possible to use a user-defined _RRD_ graph templates.
