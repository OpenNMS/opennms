...
| `org.opennms.newts.query.heartbeat`             | `450000`             | Duriation in milliseconds. Used when no heartbeat is specified. Should generally be 1.5x your smallest collection interval.
