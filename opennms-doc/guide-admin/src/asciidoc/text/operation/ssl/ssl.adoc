...
This chapter covers the possibilities to configure _OpenNMS_ to protect web sessions with HTTPS and also explains how to configure _OpenNMS_ to establish secure connections.
...
NOTE: Each time you modify the _Java Trust Store_ you have to restart _OpenNMS_ to have the changes take effect.
