...
_{opennms-product-name}_ supports several _Geocoder Service_s.
By default geolocation resoluation is disabled.

NOTE:   To enabed or configure the _Geocoer Service_ please use the web based configuration tool.
