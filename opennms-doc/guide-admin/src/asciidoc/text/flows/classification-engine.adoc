...
| The exporter of the flow must match this criteria.
  It supports all capabilities of the _https://wiki.opennms.org/wiki/Filters[{page-component-title} Filters API]_.
...
The following flows are send to _{page-component-title}_ and with the rules defined above classified accordingly.
