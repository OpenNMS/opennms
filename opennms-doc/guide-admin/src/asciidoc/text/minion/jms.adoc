...
By default, _{page-component-title}_ uses the _JMS_ protocol with an _ActiveMQ_ broker to communicate with _Minions_.
...
_{page-component-title}_ provides an embedded _ActiveMQ_ broker to help simplify installation.
