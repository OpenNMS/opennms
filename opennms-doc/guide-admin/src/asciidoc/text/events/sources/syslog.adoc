...
If you wish to customize the set of patterns, you can put a new set of patterns into a `syslogd-grok-patterns.txt` in the `etc` directory for {opennms-product-name}.
