...
The _Graphite_ telemetry adapter allows you to push telemetry data over UDP to _{page-component-title}_ using the link:https://graphite.readthedocs.io/en/latest/feeding-carbon.html#the-plaintext-protocol[_plaintext_ protocol].
