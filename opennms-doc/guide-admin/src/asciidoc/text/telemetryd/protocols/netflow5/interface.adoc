...
| _elasticUrl_
| URL to ReST API of ElasticSearch.
| required
| `http://localhost:9200`
...
| _elasticUser_
| User name in when link:https://www.elastic.co/guide/en/x-pack/current/setting-up-authentication.html[X-Pack Security] is configured
| optional
| -

| _elasticPassword_
| Password in when _X-Pack Security_ is configured
| optional
| -
