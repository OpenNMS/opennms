...
Service is Up on 192.168.31.100 <6> using org.opennms.netmgt.poller.monitors.IcmpMonitor:
...
[source]
----
opennms-filters:filter  "location='MINION'"
----
...
[source]
----
opennms-filters:filter "location='Default' & (IPADDR IPLIKE 172.*.*.*)"
----
Output is displayed as follows
[source]
----
