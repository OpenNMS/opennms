...
_{page-component-title}_ creates an _Alarm_ for issues in the network.
...
.
The figure <<ga-alarm-notes-ui, Alarm Detail View>> shows the component to add these information in _Memos_ to the _Alarm_.
