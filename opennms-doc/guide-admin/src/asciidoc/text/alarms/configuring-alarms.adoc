...
Since Alarmd instantiates Alarms from Events, defining Alarms in _{page-component-title}_ entails defining an additional XML element of an Event indicating a problem or resolution in the Network.
