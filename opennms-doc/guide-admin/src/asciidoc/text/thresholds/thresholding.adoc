...
NOTE: The basic walkthrough focuses on how to set a threshold using default values in the {opennms-product-name} setup. 
For information on how to set up collectors and collectd, see xxx
