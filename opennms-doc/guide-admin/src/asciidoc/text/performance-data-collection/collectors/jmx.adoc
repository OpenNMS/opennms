...
.Collector-specific parameters for the #Jsr160Collector Why is it called this?#
...
#TODO: this example looks like what you do in the collectd.config file, not in a JMX config file#
.Example
[source, xml]
----
