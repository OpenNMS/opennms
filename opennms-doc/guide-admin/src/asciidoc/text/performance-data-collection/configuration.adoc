...
| org.opennms.netmgt.dao.support.DisplayStringIndexStorageStrategy | Decodes the index from an OID encoded octet string
|===
...
The DisplayStringIndexStorageStrategy takes no parameters. This storage strategy will decode the original index value from an OID encoded octet string, and return the result.

Example:
Given an index string of `47.67.111.109.109.111.110.47.118.115.45.119.119.119.46.101.120.97.109.112.108.101.46.99.111.109`, will return a value of `Common-vs-www.example.com`.
