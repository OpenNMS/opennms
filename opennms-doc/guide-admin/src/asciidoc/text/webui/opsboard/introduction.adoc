...
The configuration section is in admin area of {page-component-title} and named _Ops Board Config Web Ui_.
...
image::webui/opsboard/04_add-dashlet.png[]
 ...
 3. Add a _Dashlet_ to show {page-component-title} monitoring information
