...
This procedure provides the order to follow when shutting down and restarting your {opennms-product-name} system: {opennms-product-name} core layer, persistence and messaging layer, and database layer. 
...
NOTE: You must be root to run the commands listed below. 
