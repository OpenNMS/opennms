...
The `opennms-provision:show-import` command available via the _Karaf Shell_ can be used to show the results of an import (without persisting or triggering the import):

[source]
----
opennms-provision:show-import -l MINION http url=http://127.0.0.1:8000/req.xml
----
