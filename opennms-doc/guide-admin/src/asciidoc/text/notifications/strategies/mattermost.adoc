...
If your organization uses the Mattermost team communications platform, you can configure _{opennms-product-name}_ to send notices to a Mattermost channel via an incoming webhook.
