...
TIP: A video walkthrough is available as part of the _OpenNMS 101_ videos on YouTube.  https://www.youtube.com/watch?v=h4xML_m0r8s[Module 4-2] features custom notification commands.
