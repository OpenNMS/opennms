...
The _JIRA Ticketing Plugin_ is used to create JIRA Issues in response to _{page-component-title}_ alarms.
...
When _{page-component-title}_ has started again, login to the _Karaf Shell_ and install the feature:
...
The _{page-component-title}_ Ticketer model is limited to the most common fields provided by all ticketing systems.
