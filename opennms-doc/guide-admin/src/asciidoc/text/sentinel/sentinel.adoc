...
This is required in order to have sentinel connect to the PostgreSQL database _{opennms-product-name}_.
...
In the previous chapter it is described on how to setup _{opennms-product-name}_, _Minion_ and _Sentinel_ in order to distribute the procession of flows.
...
See the previous _Flow Procession_ chapter for more details.
