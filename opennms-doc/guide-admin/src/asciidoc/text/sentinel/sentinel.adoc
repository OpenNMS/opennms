...
Each _Minion_ works as a Producer.
See TODO for more details on how to configure the _Minion_.
...
NOTE:   TODO MVR Add documentation on how to define the SINK_INITIAL_SLEEP_TIME as it must be a system property at the moment
