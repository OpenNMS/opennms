...
include::text/poller/PercMonitor.adoc[]
...
// Documentation for performance data collection
== Performance Data
include::text/data-collection/introduction.adoc[]

// Technology specific data collectors
=== Data Collectors
include::text/data-collection/snmp-data-collection.adoc[]
