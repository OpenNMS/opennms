...
include::text/performance-data-collection/global-config.adoc[]
...
include::text/performance-data-collection/collectors/snmp/introduction.adoc[]
include::text/performance-data-collection/collectors/snmp/configuration.adoc[]
