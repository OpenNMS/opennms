...
A various set of data elements are supported and interpreted by {opennms-product-name} while reading the GraphML file.
The following table explains the supported properties and for which element they may be used.
