...
| `perspectivepoller/{applicationId}`                      | Get the list of aggregated percentage availability per location for the application specified by _applicationId_.
| `perspectivepoller/{applicationId}/{monitoredServiceId}` | Get the list of aggregated percentage availability per location for an application service specified by _applicationId_ and _monitoredServiceId_.
|===
