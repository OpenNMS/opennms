...
public class AlarmRestServiceIT extends AbstractSpringJerseyRestTestCase {
    ...
    public void testAlarmClearAsAdmin() throws Exception {
        ...
        sendRequest(PUT, "/alarms/" + alarm.getId(), parseParamData("clear=true"), 200);
