 ...
 * License.
 */
package org.opennms.web.rest.v2.cm;
...
public class SnmpConfigRestCmJaxbConfigTestDao extends AbstractCmJaxbConfigDao<SnmpConfig>  {
    public static final String CONFIG_NAME = "snmp-config";

    public SnmpConfigRestCmJaxbConfigTestDao () {
