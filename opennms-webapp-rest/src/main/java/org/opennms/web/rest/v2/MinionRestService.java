            ...
            @ApiResponse(responseCode = "200", description = "One page of matching Minions.",
                    ...
                    content = {
                            ...
                            <minions count="1" offset="0" totalCount="1">
                              <minion id="00000000-0000-0000-0000-000000ddba11" label="minion-01" location="Default" type="Minion" date="2026-08-26T03:03:24.037-04:00" status="Started" version="36.0.5-SNAPSHOT">
                                <properties/>
                              </minion>
                            </minions>"""))
                    }),
            ...
            @ApiResponse(responseCode = "200", description = "The requested Minion.",
                    content = {
                            ...
                            @Content(mediaType = "application/xml", schema = @Schema(implementation = OnmsMinion.class),
                                    examples = @ExampleObject(value = """
                            <minion status="Started" version="36.0.5-SNAPSHOT" id="00000000-0000-0000-0000-000000ddba11" label="minion-01" location="Default" type="Minion" date="2026-08-26T03:03:24.037-04:00">
                              <properties/>
                            </minion>"""))
                    }),
