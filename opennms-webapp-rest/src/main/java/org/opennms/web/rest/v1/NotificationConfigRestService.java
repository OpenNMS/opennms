 ...
 * <li><b>GET/POST/PUT/DELETE /notification-config/destination-paths/{name}</b> CRUD for one destination path</li>
 * <li><b>GET /notification-config/commands</b> available notification commands (read-only)</li>
 * </ul>
 */
