...
class MBeansTree extends Tree implements Action.Handler {
	...
	public void handleAction(Action action, Object sender, Object target) {
		if (action == SELECT) {
			controller.handleSelectDeselect(container, container.getItem(target), target, true);
		}
		if (action == DESELECT) {
			controller.handleSelectDeselect(container, container.getItem(target), target, false);
		}
