...
public class ConfigurationManagerServiceMock implements ConfigurationManagerService {
    ...
    public <ENTITY> Optional<ENTITY> getConfiguration(String configName, String configId, Class<ENTITY> entityClass) throws IOException {
        ...
        try {
            InputStream in = DiscoveryConfigDetectorsTest.class.getResourceAsStream("/mock/etc/discovery-configuration.xml");
            ...
            ValidateUsingConverter<DiscoveryConfiguration> convert = new ValidateUsingConverter(DiscoveryConfiguration.class);
