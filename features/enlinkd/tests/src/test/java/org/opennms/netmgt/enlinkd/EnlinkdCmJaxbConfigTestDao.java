...
public class EnlinkdCmJaxbConfigDao extends AbstractCmJaxbConfigDao<EnlinkdConfiguration> {
    public static final String CONFIG_NAME = "enlinkd";
     ...
     */
    public EnlinkdCmJaxbConfigDao(Class<EnlinkdConfiguration> entityClass, String description) {
