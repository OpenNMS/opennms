...
public class EnlinkdConfiguration implements java.io.Serializable {
     ...
     * Max number of threads used for executing data collection.
     */
    @XmlAttribute(name = "scheduler-threads", required = true)
     ...
     */
    @XmlAttribute(name = "topology_updater_interval")
    ...
    public void setTopologyUpdaterInterval(Long topologyInterval) {
