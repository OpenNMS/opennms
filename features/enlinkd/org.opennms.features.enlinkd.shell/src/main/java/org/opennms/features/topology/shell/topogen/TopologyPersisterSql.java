...
public class TopologyPersisterSql implements TopologyPersister{
    ...
    private final static Logger LOG = LoggerFactory.getLogger(TopologyPersisterSql.class);

    private DataSource ds;

    public TopologyPersisterSql() throws IOException {
        setUpDatasource();
    }
