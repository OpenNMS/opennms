...
~~~~
karaf@root> features:addurl mvn:org.opennms.plugins/alarm-change-notifier/20.1.0/xml/features
karaf@root> features:install alarm-change-notifier

(or features:install alarm-change-notifier/20.1.0 for a specific version of the feature)
~~~~
