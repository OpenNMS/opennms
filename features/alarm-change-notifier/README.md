...
~~~~
karaf@root> feature:addurl mvn:org.opennms.plugins/alarm-change-notifier/21.0.4/xml/features
karaf@root> feature:install alarm-change-notifier

(or feature:install alarm-change-notifier/21.0.4 for a specific version of the feature)
~~~~
