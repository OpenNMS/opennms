...
~~~~
karaf@root> feature:addurl mvn:org.opennms.plugins/alarm-change-notifier/24.1.0/xml/features
karaf@root> feature:install alarm-change-notifier

(or feature:install alarm-change-notifier/24.1.0 for a specific version of the feature)
~~~~
