...
~~~~
karaf@root> features:addurl mvn:org.opennms.plugins/alarm-change-notifier/2017.1.5/xml/features
karaf@root> features:install alarm-change-notifier

(or features:install alarm-change-notifier/2017.1.5 for a specific version of the feature)
~~~~
