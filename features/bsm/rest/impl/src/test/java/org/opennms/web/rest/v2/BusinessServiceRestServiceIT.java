...
public class BusinessServiceRestServiceIT extends AbstractSpringJerseyRestTestCase {
    ...
    // TODO MVR move this to the BusinessServiceEntityBuilder
    private void addIpServiceEdge(BusinessServiceEntity bservice, OnmsMonitoredService ipservice) {
...
//        Assert.assertEquals(1, m_businessServiceDao.get(serviceId).getReductionKeys().size()); // TODO MVR fix this
