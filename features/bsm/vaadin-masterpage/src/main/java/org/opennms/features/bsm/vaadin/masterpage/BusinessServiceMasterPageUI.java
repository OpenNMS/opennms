...
public class BusinessServiceMasterPageUI extends UI {
	...
	public BusinessServiceMasterPageUI(TransactionOperations transactionOperations) {
	...
	public void setBusinessServiceManager(BusinessServiceManager businessServiceManager) {
		...
		this.businessServiceManager = new TransactionAwareBeanProxyFactory(transactionOperations).createProxy(businessServiceManager);
	}
}
