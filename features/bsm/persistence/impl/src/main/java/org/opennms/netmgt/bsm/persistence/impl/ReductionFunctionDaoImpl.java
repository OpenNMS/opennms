...
public class ReductionFunctionDaoImpl extends AbstractDaoHibernate<AbstractReductionFunction, Long> implements ReductionFunctionDao {

    public ReductionFunctionDaoImpl() {
        super(AbstractReductionFunction.class);
    }
}
