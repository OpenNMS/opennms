...
karaf@root> feature:addurl mvn:org.opennms.plugins/opennms-es-rest/2018.1.15/xml/features
karaf@root> feature:install opennms-es-rest

(or feature:install opennms-es-rest/2018.1.15 for a specific version of the feature)
~~~~
