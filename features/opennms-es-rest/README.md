...
karaf@root> features:addurl mvn:org.opennms.plugins/opennms-es-rest/20.1.0-SNAPSHOT/xml/features
karaf@root> features:install opennms-es-rest

(or features:install opennms-es-rest/20.1.0-SNAPSHOT for a specific version of the feature)
~~~~
