...
karaf@root> feature:addurl mvn:org.opennms.plugins/opennms-es-rest/21.0.3-SNAPSHOT/xml/features
karaf@root> feature:install opennms-es-rest

(or feature:install opennms-es-rest/21.0.3-SNAPSHOT for a specific version of the feature)
~~~~
