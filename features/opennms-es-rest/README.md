...
karaf@root> features:addurl mvn:org.opennms.plugins/opennms-es-rest/2017.1.14/xml/features
karaf@root> features:install opennms-es-rest

(or features:install opennms-es-rest/2017.1.14 for a specific version of the feature)
~~~~
