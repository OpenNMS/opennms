...
karaf@root> feature:addurl mvn:org.opennms.plugins/opennms-es-rest/21.0.2/xml/features
karaf@root> feature:install opennms-es-rest

(or feature:install opennms-es-rest/21.0.2 for a specific version of the feature)
~~~~
