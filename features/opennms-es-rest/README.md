...
karaf@root> features:addurl mvn:org.opennms.plugins/opennms-es-rest/2017.1.22-SNAPSHOT/xml/features
karaf@root> features:install opennms-es-rest

(or features:install opennms-es-rest/2017.1.22-SNAPSHOT for a specific version of the feature)
~~~~
