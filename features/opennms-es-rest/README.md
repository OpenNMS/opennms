...
karaf@root> feature:addurl mvn:org.opennms.plugins/opennms-es-rest/2018.1.14-SNAPSHOT/xml/features
karaf@root> feature:install opennms-es-rest

(or feature:install opennms-es-rest/2018.1.14-SNAPSHOT for a specific version of the feature)
~~~~
