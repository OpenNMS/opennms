 ...
 *
 * Both string and numeric attributes are persisted via {@link org.opennms.netmgt.collection.persistence.timescale.TimescalePersistOperationBuilder}.
 *
 */
public class TimescalePersister extends AbstractPersister {

    private final RrdRepository m_repository;
    private final TimescaleWriter m_newtsWriter;
    private final Context m_context;
    private TimescalePersistOperationBuilder m_builder;

    protected TimescalePersister(ServiceParameters params, RrdRepository repository, TimescaleWriter newtsWriter, Context context) {
    ...
    public void visitGroup(AttributeGroup group) {
        ...
        if (shouldPersist()) {
            ...
            m_builder = new TimescalePersistOperationBuilder(m_newtsWriter, m_context, m_repository, resource, group.getName());
