 ...
 */
public class TimescaleResourceDao implements ResourceDao, InitializingBean {

    private static final Logger LOG = LoggerFactory.getLogger(TimescaleResourceDao.class);
