 ...
 * @author jwhite
 */
public class TimescalePersisterFactory implements PersisterFactory {
    ...
    @Inject
    public TimescalePersisterFactory(Context context, TimescaleWriter newtsWriter) {
    ...
    public Persister createPersister(ServiceParameters params, RrdRepository repository, boolean dontPersistCounters,
        ...
        TimescalePersister persister =  new TimescalePersister(params, repository, m_newtsWriter, m_context);
