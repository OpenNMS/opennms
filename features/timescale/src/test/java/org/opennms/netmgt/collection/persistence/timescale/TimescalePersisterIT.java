...
@ContextConfiguration(locations={
        ...
        "classpath:/META-INF/opennms/applicationContext-timeseries-timescale.xml"
})
@JUnitConfigurationEnvironment(systemProperties={
        "org.opennms.timeseries.strategy=timescale"
})
public class TimescalePersisterIT {
    ...
    @Autowired
    private TimescalePersisterFactory m_persisterFactory;
