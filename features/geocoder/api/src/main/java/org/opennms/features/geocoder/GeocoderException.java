...
public class GeocoderException extends Exception {
    ...
    protected GeocoderException(final String message) {
        super(message);
    }

    protected GeocoderException(final Throwable t) {
        super(t);
    }

    protected GeocoderException(final String messages, final Throwable t) {
        super(messages, t);
    }
