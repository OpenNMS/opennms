...
/**
 * Used to pass context at mapping time to the generated MapStruct code.
 */
public interface MappingContext {
    HwEntityDao getHwEntityDao();

    EventConfDao getEventConfDao();

    LoadingCache<Long, OpennmsModelProtos.NodeCriteria> getNodeIdToCriteriaCache();

    default void setTimeIfNotNull(Date date, Consumer<Long> setter) {
        if (date != null) {
