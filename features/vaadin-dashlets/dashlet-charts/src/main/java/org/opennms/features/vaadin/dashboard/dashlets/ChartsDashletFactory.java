 ...
 */
public class ChartsDashletFactory extends AbstractDashletFactory {
    ...
    public Dashlet newDashletInstance(DashletSpec dashletSpec) {
        return new ChartsDashlet(getName(), dashletSpec);
    }
    ...
    public DashletConfigurationWindow configurationWindow(DashletSpec dashletSpec) {
        return new ChartsConfigurationWindow(dashletSpec);
    }
}
