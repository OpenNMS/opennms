...
public class AlarmControlImpl extends ControlImpl {
    public static native JSObject create(final AlarmControl context, final JSObject options) /*-{
        ...
        obj.onAdd = function(map) {
            return context.@org.opennms.features.vaadin.nodemaps.internal.gwt.client.controls.alarm.AlarmControl::doOnAdd(Lcom/google/gwt/core/client/JavaScriptObject;)(map);
        };
        obj.onRemove = function(map) {
            context.@org.opennms.features.vaadin.nodemaps.internal.gwt.client.controls.alarm.AlarmControl::doOnRemove(Lcom/google/gwt/core/client/JavaScriptObject;)(map);
        };
        return obj;
    }-*/;
