...
/**
 * Configuration options for the OutlierFilder filter.
 *
 ...
 * @author jwhite
 */
public class OutlierFilterConfig implements FilterConfig {
    ...
    protected OutlierFilterConfig() {}

    public OutlierFilterConfig(String inputColumn, double probability) {
