...
public class RedisResourceMetadataCache implements SearchableResourceMetadataCache {
    ...
    @Inject
    public RedisResourceMetadataCache(@Named("redis.hostname") String hostname, @Named("redis.port") Integer port, @Named("newts.writer_threads") Integer numWriterThreads, @Named("timeseriesMetricRegistry") MetricRegistry registry, ResourceIdSplitter resourceIdSplitter) {
