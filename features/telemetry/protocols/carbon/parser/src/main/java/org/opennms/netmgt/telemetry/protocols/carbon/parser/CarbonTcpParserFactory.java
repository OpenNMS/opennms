...
public class CarbonTcpParserFactory implements ParserFactory {

    private final TelemetryRegistry telemetryRegistry;

    public CarbonTcpParserFactory(final TelemetryRegistry telemetryRegistry) {
        this.telemetryRegistry = Objects.requireNonNull(telemetryRegistry);
    }

    @Override
    public Class<? extends Parser> getBeanClass() {
        return CarbonTcpParser.class;
    }
    ...
    public Parser createBean(ParserDefinition beanDefinition) {
        ...
        final CarbonTcpParser parser = new CarbonTcpParser(beanDefinition.getName(), dispatcher);
