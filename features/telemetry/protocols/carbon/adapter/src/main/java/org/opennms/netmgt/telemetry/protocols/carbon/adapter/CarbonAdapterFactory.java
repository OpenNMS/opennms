...
public class CarbonAdapterFactory extends AbstractCollectionAdapterFactory {

    public CarbonAdapterFactory() {
        super(null);
    }

    public CarbonAdapterFactory(BundleContext bundleContext) {
        super(bundleContext);
    }

    @Override
    public Class<? extends Adapter> getBeanClass() {
        return CarbonAdapter.class;
    }

    @Override
    public Adapter createBean(final AdapterDefinition adapterConfig) {
        final CarbonAdapter adapter = new CarbonAdapter();
