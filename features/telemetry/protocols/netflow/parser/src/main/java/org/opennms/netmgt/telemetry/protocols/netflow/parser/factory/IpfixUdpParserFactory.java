...
public class IpfixUdpParserFactory implements ParserFactory {
    ...
    public IpfixUdpParserFactory(final TelemetryRegistry telemetryRegistry, final EventForwarder eventForwarder, final Identity identity) {
