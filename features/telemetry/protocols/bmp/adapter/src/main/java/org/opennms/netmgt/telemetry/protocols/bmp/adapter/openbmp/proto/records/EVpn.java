...
public class EVpn extends Record {
    public String action;
    public long sequence;
    public String hash; // Hash of fields [ peer hash, mac, mac length, ip, ip length, ethernet segment id, rd admin id, rd number, path_id, 1 if has label(s) ]
    ...
    public int originatingRouterIpLen;
    public InetAddress originatingRouterIp;
    public String ethernetTagIdHex;
    public String ethernetSegmentIdentifier;
    public int macLen;
    public String mac;
    public int ipLen;
    public InetAddress ip;
    public int mplsLabel1;
    public int mplsLabel2;
    ...
    protected String[] fields() {
        return new String[]{
                ...
                Integer.toString(this.originatingRouterIpLen),
                InetAddressUtils.toIpAddrString(this.originatingRouterIp),
                this.ethernetTagIdHex,
                this.ethernetSegmentIdentifier,
                Integer.toString(this.macLen),
                this.mac,
                Integer.toString(this.ipLen),
                InetAddressUtils.toIpAddrString(this.ip),
                Integer.toString(this.mplsLabel1),
                Integer.toString(this.mplsLabel2),
