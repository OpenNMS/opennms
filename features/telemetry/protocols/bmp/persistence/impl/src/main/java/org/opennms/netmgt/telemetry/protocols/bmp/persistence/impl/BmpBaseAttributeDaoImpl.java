...
public class BmpBaseAttributeDaoImpl extends AbstractDaoHibernate<BmpBaseAttribute, Long> implements BmpBaseAttributeDao {
    public BmpBaseAttributeDaoImpl() {
        super(BmpBaseAttribute.class);
    }
}
