...
public class AttrSet implements Attribute {
    ...
    public AttrSet(final ByteBuf buffer, final PeerFlags flags) throws InvalidPacketException {
        ...
        this.pathAttributes = Collections.unmodifiableList(repeatRemaining(slice(buffer, uint16(buffer)), pathAttributeBuffer -> new UpdatePacket.PathAttribute(pathAttributeBuffer, flags)));
    }
