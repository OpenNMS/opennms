...
public class Utils {
    ...
    public static BigInteger getBigInteger(final int startIndex, final int endIndex, final ByteBuffer data, final int offset) {
        final byte[] bytes = getBytes(data, offset + startIndex, endIndex - startIndex + 1);
        return new BigInteger(1, bytes);
    }

    public static byte[] getBytes(final ByteBuffer data, final int offset, final int length) {
