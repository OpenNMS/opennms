...
public class Tcp implements Listener.Factory {

    @Override
    public Parser.Creator parser(final ParserDefinition parserDefinition) {
        return dispatcher -> Beans.buildParser(SimpleTcpParser.Factory.class,
                SimpleTcpParser.Factory::createTcpParser,
    ...
    public Listener create(final String name,
        ...
        final SimpleTcpListener listener = new SimpleTcpListener(name,
                (SimpleTcpParser) parsers.iterator().next());
