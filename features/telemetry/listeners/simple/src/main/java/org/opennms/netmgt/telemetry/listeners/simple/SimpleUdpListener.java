...
public class SimpleUdpListener implements Listener {
    private static final Logger LOG = LoggerFactory.getLogger(SimpleUdpListener.class);

    private final String name;

    private final SimpleUdpParser parser;
    ...
    public SimpleUdpListener(final String name,
                             final SimpleUdpParser parser) {
                        ...
                        ch.pipeline()
                                .addLast(new SimpleChannelInboundHandler<DatagramPacket>() {
                                    ...
                                    protected void channelRead0(final ChannelHandlerContext ctx,
                                        ...
                                        SimpleUdpListener.this.parser.parse(msg.content().nioBuffer(), msg.sender(), msg.recipient());
                                    }
                                })
