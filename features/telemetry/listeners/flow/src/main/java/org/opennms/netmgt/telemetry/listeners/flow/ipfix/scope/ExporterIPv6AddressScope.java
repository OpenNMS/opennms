...
public class ExporterIPv6AddressScope implements Predicate<DataRecord> {
    private final Inet6Address address;

    public ExporterIPv6AddressScope(final Inet6Address address) {
        this.address = Objects.requireNonNull(address);
    }

    @Override
    public boolean test(final DataRecord record) {
        // TODO fooker: Search record for exporterIPv6Address and prefer it
