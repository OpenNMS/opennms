...
public class TemplateIdScope implements Predicate<DataRecord> {
    private final long templateId;

    public TemplateIdScope(final long templateId) {
        this.templateId = templateId;
    }

    @Override
    public boolean test(final DataRecord record) {
        return record.set.header.setId == this.templateId;
    }
}
