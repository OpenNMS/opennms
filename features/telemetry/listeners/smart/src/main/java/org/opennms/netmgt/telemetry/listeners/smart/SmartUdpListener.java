...
public class SmartUdpListener implements Listener {
    private static final Logger LOG = LoggerFactory.getLogger(SmartUdpListener.class);

    private final String name;

    private final Set<SmartUdpParser> parsers;
    ...
    public SmartUdpListener(final String name,
                            final Set<SmartUdpParser> parsers) {
                        ...
                        ch.pipeline()
                                .addLast(new SimpleChannelInboundHandler<DatagramPacket>() {
                                    ...
                                    protected void channelRead0(final ChannelHandlerContext ctx,
                                        ...
                                        for (final SmartUdpParser parser : SmartUdpListener.this.parsers) {
