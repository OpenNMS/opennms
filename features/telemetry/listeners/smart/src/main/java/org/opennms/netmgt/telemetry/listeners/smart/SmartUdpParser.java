...
public interface SmartUdpParser extends SimpleUdpParser {
    boolean handles(final ByteBuffer buffer);

    interface Factory extends SimpleUdpParser.Factory {
        SmartUdpParser createUdpParser(final String name,
