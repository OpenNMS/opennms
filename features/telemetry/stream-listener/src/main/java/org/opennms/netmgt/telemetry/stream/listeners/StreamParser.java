...
/**
 * Stream parser that can connect to multiple streams.
 */

public interface StreamParser extends Parser {

    Connection connect(final int nodeId, final String ipAddress) throws Exception;

    void closeConnection(final int nodeId, final String ipAddress);
