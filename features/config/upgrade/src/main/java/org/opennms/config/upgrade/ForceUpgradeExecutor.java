...
public class ForceUpgradeExecutor implements InitializingBean {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(ForceUpgradeExecutor.class);
    ...
    public void afterPropertiesSet() throws Exception {
        LOG.debug("START FORCE EXECUTE LIQUIBASE FOR CM!!!!");
        LiquibaseUpgrader liqui = new LiquibaseUpgrader(cm);
        liqui.runChangelog("changelog-cm/changelog-cm.xml", dataSource.getConnection());
        LOG.debug("END FORCE EXECUTE LIQUIBASE FOR CM!!!!");
    }
}
