...
public class DefinitionTest extends CmConfigTest<Definition> {
    public DefinitionTest(Definition sampleObject, String sampleXml) {
        super(sampleObject, sampleXml, "discovery-configuration.xsd", "definition");
    }
