...
/**
 * Fake Config class for junit use only (TrapdConfiguration)
 *
...
public class FakeXsdForTest implements Serializable {
     ...
     */
    public FakeXsdForTest(int _snmpTrapPort, String snmpTrapAddress) {
        super();
    ...
    public boolean equals(final java.lang.Object obj) {
        ...
        if (obj instanceof FakeXsdForTest) {
            final FakeXsdForTest other = (FakeXsdForTest) obj;
