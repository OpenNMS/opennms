...
public class DiscoveryWithDefinitionTest extends CmConfigTest<DiscoveryConfiguration> {

    public DiscoveryWithDefinitionTest(DiscoveryConfiguration sampleObject, String sampleXml) {
