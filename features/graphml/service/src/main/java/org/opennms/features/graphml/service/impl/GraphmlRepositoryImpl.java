...
public class GraphmlRepositoryImpl implements GraphmlRepository {
    ...
    public GraphmlRepositoryImpl() {
        Preconditions.checkState(System.getProperty(OPENNMS_HOME) != null, "No opennms.home defined. Bailing out...");
    }
    ...
    public GraphmlType findByName(String name) throws IOException {
        ...
        return JaxbUtils.unmarshal(GraphmlType.class, new File(buildGraphmlFilepath(name)));
    }
    ...
    public void save(String name, String label, GraphmlType graphmlType) throws IOException {
        ...
        try (FileWriter writer = new FileWriter(topologyCfgFile)) {
            properties.store(writer, "Generated by " + getClass().getSimpleName() + ". DO NOT EDIT!");
        }

        // Create Cfg file for Graph Service
        properties = new Properties();
        properties.put(GRAPH_LOCATION, graphFile.toString());
        try (FileWriter writer = new FileWriter(graphServiceCfgFile)) {
            properties.store(writer, "Generated by " + getClass().getSimpleName() + ". DO NOT EDIT!");
        }
    }
    ...
    protected static String buildCfgFilepath(final String filename, final String cfgFilePrefix) {
        return Paths.get(System.getProperty(OPENNMS_HOME), "etc", cfgFilePrefix + "-" + filename + ".cfg").toString();
    }
    ...
    protected static String buildGraphmlFilepath(String filename) {
        return Paths.get(System.getProperty(OPENNMS_HOME), "etc", "graphml", filename + ".xml").toString();
    }
}
