...
import org.opennms.features.minion.cluster.api.Cluster;
...
public class HazelcastCluster implements Cluster {
    ...
    private final HazelcastLeader leader;
    private final HazelcastScheduler scheduler;

    public HazelcastCluster(final HazelcastInstance hazelcast) {
        this.hazelcast = Objects.requireNonNull(hazelcast);

        this.leader = new HazelcastLeader(this.hazelcast);
        this.scheduler = new HazelcastScheduler(this.hazelcast);
    }
