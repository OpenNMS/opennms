...
/**
 * Table strategy for polling access-points:
 * 1) Walks the table at the configured OID, uses the values as the AP MACs
 * 2) If the AP MAC is in the table, the AP is ONLINE.
 *
