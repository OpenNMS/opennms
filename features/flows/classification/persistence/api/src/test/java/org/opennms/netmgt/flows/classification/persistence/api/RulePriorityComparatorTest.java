...
public class RulePriorityComparatorTest {
    ...
    public void verifyRulePriorityComparator() {
        ...
        final Group group1 = new GroupBuilder().withName("group1").withPriority(1).build();
        ...
        final Group group2 = new GroupBuilder().withName("group2").withPriority(2).build();
    ...
    private Rule createAndAddRule(Group group, int position) {
        Rule rule = new RuleBuilder()
                ...
                .withName(String.format("rule%s_%s", group.getPriority(), position))
                .build();
        group.addRule(rule);
        return rule;
    }
