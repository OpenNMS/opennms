...
final class AggregatedFlow {
    ...
    final String groupedByKey;
    final long bytesIn;
    final long bytesOut;
    final boolean congestionEncountered;
    final boolean nonEcnCapableTransport;
    /** Resolved host name; only populated for {@link Dimension#HOST}. */
    final String hostname;

    AggregatedFlow(final long windowStartMs, final long windowEndMs, final int exporterNodeId, final int ifIndex,
