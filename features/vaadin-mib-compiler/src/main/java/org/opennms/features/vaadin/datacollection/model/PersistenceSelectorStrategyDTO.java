...
public class PersistenceSelectorStrategyDTO implements Serializable {
    ...
    /**
     * Instantiates a new Persistence Selector Strategy DTO.
     */
    public PersistenceSelectorStrategyDTO() {
        super();
