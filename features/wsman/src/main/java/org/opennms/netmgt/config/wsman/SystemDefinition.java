...
public class SystemDefinition {
    ...
    public void addRule(String rule) {
        getRule().add(Objects.requireNonNull(rule));
    }
    ...
    public void addIncludeGroup(String includeGroup) {
        getIncludeGroup().add(Objects.requireNonNull(includeGroup));
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(rule, includeGroup, name);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(this.rule, other.rule) &&
                Objects.equals(this.includeGroup, other.includeGroup) &&
