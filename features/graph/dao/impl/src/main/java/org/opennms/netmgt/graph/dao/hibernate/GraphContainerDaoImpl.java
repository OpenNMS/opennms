...
public class GraphContainerDaoImpl extends HibernateDaoSupport implements GraphContainerDao {
    ...
    public GraphContainerEntity findContainerById(String containerId) {
        final List<GraphContainerEntity> containers = (List<GraphContainerEntity>) getHibernateTemplate().findByNamedParam("Select ge from GraphContainerEntity ge where ge.namespace = :namespace", "namespace", containerId);
    ...
    public GraphContainerEntity findContainerInfoById(String containerId) {
        ...
        final List<GraphContainerEntity> graphContainerEntities = (List<GraphContainerEntity>) getHibernateTemplate()
                .findByNamedParam("select distinct ge from GraphContainerEntity ge join ge.properties join ge.graphs as graphs join graphs.properties where ge.namespace = :namespace", "namespace", containerId);
