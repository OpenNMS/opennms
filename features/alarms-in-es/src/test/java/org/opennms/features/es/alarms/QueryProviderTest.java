...
public class QueryProviderTest {
    ...
    public void canGenerateQueries() {
        ...
        validate(queryProvider.getAlarmsAt(1));
        validate(queryProvider.getAllAlarms());
        validate(queryProvider.getCurrentAlarms());
        validate(queryProvider.markAlarmAsDeleted(1,1));
        validate(queryProvider.markOtherAlarmsAsDeleted(Collections.singleton(1),1));
    }
