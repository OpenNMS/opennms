...
public class SnmpChunkProtocolCollectorTest {
    ...
    @Ignore
    @Test
    public void testCollectOneSingelOid() {
        ProtocolCollector protocolCollector = new SnmpChunkProtocolCollector();
        ...
        Assert.assertNotNull("Is the ProtocolCollector returnning a CollectionJob?", resultCollectionJob);
        Assert.assertNotNull("Are Metrics set insite the metrics map?", resultCollectionJob.getAllMetrics());
    ...
    @Ignore
    @Test
    public void testCollectManySingelValueOids() {
        ProtocolCollector protocolCollector = new SnmpChunkProtocolCollector();
        ...
        CollectionJob resultCollectionJob = protocolCollector.collect(snmpJob);
