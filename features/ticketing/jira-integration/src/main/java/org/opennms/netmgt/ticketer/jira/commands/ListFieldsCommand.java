 ...
 * </ul>
 */
@Command(scope = "opennms-jira", name = "list-fields", description="Uses the JIRA ReST API to list all fields available")
@org.apache.karaf.shell.commands.Command(scope = "opennms-jira", name = "list-fields", description="Uses the JIRA ReST API to list all fields available")
@Service
