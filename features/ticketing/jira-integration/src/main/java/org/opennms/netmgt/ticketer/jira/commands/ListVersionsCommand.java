 ...
 * </ul>
 */
@Command(scope = "opennms-jira", name = "list-versions", description="Uses the JIRA ReST API to list all versions")
@org.apache.karaf.shell.commands.Command(scope = "opennms-jira", name = "list-versions", description="Uses the JIRA ReST API to list all versions")
@Service
