 ...
 * </ul>
 */
@Command(scope = "opennms-jira", name = "list-issue-types", description="Uses the JIRA ReST API to list all issue types")
@org.apache.karaf.shell.commands.Command(scope = "opennms-jira", name = "list-issue-types", description="Uses the JIRA ReST API to list all issue types")
@Service
