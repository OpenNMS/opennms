...
public class PriorityFieldMapper extends AbstractModifyableOptionKeyFieldMapper {
    public PriorityFieldMapper(Supplier<Map<String, String>> optionKeySupplier) {
        super(optionKeySupplier);
    }

    @Override
    public boolean matches(FieldSchema schema) {
        return "priority".equals(schema.getSystem()) && schema.getCustom() == null;
    }
