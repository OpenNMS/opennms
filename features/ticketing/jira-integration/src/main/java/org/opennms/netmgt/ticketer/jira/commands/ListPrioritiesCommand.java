 ...
 * </ul>
 */
@Command(scope = "opennms-jira", name = "list-priorities", description="Uses the JIRA ReST API to list all priorities")
@org.apache.karaf.shell.commands.Command(scope = "opennms-jira", name = "list-priorities", description="Uses the JIRA ReST API to list all priorities")
@Service
