...
//
//		snmp4JV1cTrapPdu.add(new VariableBinding(new OID(oid), new OctetString("Trap Msg v1")));
//		snmp4JV1cTrapPdu.setType(PDU.NOTIFICATION);
//
//		TrapNotification snmp4JV1cTrap = new Snmp4JTrapNotifier.Snmp4JV1TrapInformation(
//				InetAddressUtils.ONE_TWENTY_SEVEN, "public",
//				snmp4JV1cTrapPdu, new BasicTrapProcessor());
//		
//		TrapdKafkaEncoder encoder = new TrapdKafkaEncoder();
//		byte[] testArray = encoder.toBytes(snmp4JV1cTrap);
//
//		System.out.println("testArray is : "+testArray);
//		
//		TrapdKafkaDecoder decoder = new TrapdKafkaDecoder();
//		TrapNotification snmp4JV1cTrap1 = (TrapNotification) decoder.fromBytes(testArray);
//		System.out.println("snmp4JV1cTrap1 is : "+snmp4JV1cTrap1);
//		System.out.println("snmp4JV1cTrap1.toString() is : "+snmp4JV1cTrap1.toString());
//	}
