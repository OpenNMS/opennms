...
/**
 * <p>{@link EventSubscriptionService} that satisfies the interface
 * but does not manage any {@link EventListener} instances.</p>
 * 
 * @author Seth
 */
public class NullEventSubscriptionService implements EventSubscriptionService {
