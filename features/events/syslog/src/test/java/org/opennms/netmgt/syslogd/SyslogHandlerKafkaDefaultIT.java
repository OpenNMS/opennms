...
public class SyslogHandlerKafkaDefaultIT extends CamelBlueprintTestSupport {
	...
	public void testSyslogd() throws Exception {
		...
		syslogd.addRoutes(new RouteBuilder(){
		  ...
		  public void configure() throws Exception {
              ...
              }).to("kafka:localhost:9092?topic=syslog");
		  }
		...
		syslogd.addRoutes(new RouteBuilder() {
			...
			public void configure() throws Exception {
				...
				from("kafka:localhost?topic=syslog;groupId=testing;zookeeperHost=localhost&amp;zookeeperPort=2181")
