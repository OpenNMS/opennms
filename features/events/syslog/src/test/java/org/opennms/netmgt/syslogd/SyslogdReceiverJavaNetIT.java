...
public class SyslogdReceiverJavaNetIT extends CamelBlueprintTestSupport {

	private static final Logger LOG = LoggerFactory.getLogger(SyslogdReceiverJavaNetIT.class);
	...
	protected String getBlueprintDescriptor() {
		return "file:blueprint-syslog-listener-javanet.xml,file:src/test/resources/blueprint-empty-camel-context.xml";
	}
