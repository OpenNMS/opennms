...
public class SyslogdHandlerMinionIT extends CamelBlueprintTestSupport {
	...
	public void testSyslogd() throws Exception {
		//MockEndpoint amqBroker = getMockEndpoint("mock:activemq:tcp://127.0.0.1:61716");
		//MockEndpoint handleMessage = getMockEndpoint("mock:seda:handleMessage");

		// Expect one syslog event to be broadcast on the event channel
