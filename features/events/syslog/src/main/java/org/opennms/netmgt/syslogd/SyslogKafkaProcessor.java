...
import org.opennms.netmgt.syslogd.kafka.KafkaProducerImpl;

public class SyslogKafkaProcessor implements Processor{
...
//        ProducerRecord<String, String> rec = new ProducerRecord<String, String>(kafkaTopic, syslogMessage);
//        producer.send(rec);
//        producer.close();
	}
