...
public class QueuingTcpOutputStrategy implements TcpOutputStrategy {
    private static final long SLEEP_TIME = SystemPropertiesUtils.getLong("org.opennms.netmgt.persistence.tcp.queuingTcpSleepTime", 1000);
    private static final long OFFER_WAIT_TIME = SystemPropertiesUtils.getLong("org.opennms.netmgt.persistence.tcp.queuingTcpOfferWaitTime", 500);
    private static final boolean LOGGING = Boolean.getBoolean("org.opennms.netmgt.persistence.tcp.queuingTcpLogging");
    private static final long LOGGING_INTERVAL = SystemPropertiesUtils.getLong("org.opennms.netmgt.persistence.tcp.queuingTcpLoggingInterval", 300000);
