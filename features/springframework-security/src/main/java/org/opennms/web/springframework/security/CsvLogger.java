...
public class CsvLogger {
    ...
    private static final String OPEN_NMS_CSV_FILE_PATH = OPENNMS_HOME +"/etc/login_logs.csv";
    private static final String[] HEADER = {"Username", "IP Address", "Timestamp"};
    private static final DateTimeFormatter TIMESTAMP_FORMATTER = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");

    public static void logToCsv(String username, String ipAddress) {
        try {
            ...
            try (FileWriter writer = new FileWriter(csvFile, true)) {
                ...
                String logEntry = String.join(",", username, ipAddress, timestamp);
    ...
    private static void cleanupStaleData() {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(csvFile))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                LocalDateTime entryTimestamp = LocalDateTime.parse(parts[2].trim(), TIMESTAMP_FORMATTER);
