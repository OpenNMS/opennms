 ...
 * </ul>
 */
@Command(scope = "opennms-datachoices", name = "reset-system-id", description="Regenerate the system id.")
@org.apache.karaf.shell.commands.Command(scope = "opennms-datachoices", name = "reset-system-id", description="Regenerate the system id.")
@Service
