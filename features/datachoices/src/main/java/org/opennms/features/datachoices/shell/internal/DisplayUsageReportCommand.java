 ...
 * </ul>
 */
@Command(scope = "opennms-datachoices", name = "display-usage-report", description="Displays the usage statistics report.")
@org.apache.karaf.shell.commands.Command(scope = "opennms-datachoices", name = "display-usage-report", description="Displays the usage statistics report.")
@Service
