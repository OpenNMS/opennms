 ...
 * </ul>
 */
@Command(scope = "opennms-datachoices", name = "send-usage-report", description="Generate and upload the usage statistics report.")
@org.apache.karaf.shell.commands.Command(scope = "opennms-datachoices", name = "send-usage-report", description="Generate and upload the usage statistics report.")
@Service
