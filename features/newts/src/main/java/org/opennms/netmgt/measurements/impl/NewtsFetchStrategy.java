...
public class NewtsFetchStrategy implements MeasurementFetchStrategy {
    ...
    public static final long MIN_STEP_MS = SystemPropertiesUtils.getLong("org.opennms.newts.query.minimum_step", 5L * 60L * 1000L);

    public static final int INTERVAL_DIVIDER = SystemPropertiesUtils.getInteger("org.opennms.newts.query.interval_divider", 2);

    public static final long DEFAULT_HEARTBEAT_MS = SystemPropertiesUtils.getLong("org.opennms.newts.query.heartbeat", 450L * 1000L);

    public static final int PARALLELISM = SystemPropertiesUtils.getInteger("org.opennms.newts.query.parallelism", Runtime.getRuntime().availableProcessors());
