...
/**
 * The Class AbstractJaxbConfigDao.
 *
...
public abstract class AbstractJaxbConfigDao<K, V> implements InitializingBean {
    ...
    /** The file reload container. */
    private FileReloadContainer<V> m_container;

    /** The JAXB reload callback. */
    ...
    /**
     * Instantiates a new abstract JAXB configuration DAO.
     *
     ...
     *
     * @param jaxbConfig the JAXB configuration
     * @return the v
     */
    ...
    /**
     * Creates the loaded log message.
     *
     * @param translatedConfig the translated configuration
     ...
     *
     * @param configResource the new configuration resource
     */
    ...
    public class JaxbReloadCallback implements FileReloadCallback<V> {
        ...
        /* (non-Javadoc)
         * @see org.opennms.netmgt.dao.support.FileReloadCallback#reload(java.lang.Object, org.springframework.core.io.Resource)
         */
