...
public class PageSequenceMonitorEnhancedTest {
    ...
    public void testHttpsWithoutHostValidation() throws Exception {
        ...
        m_params.put("page-sequence", ""
                + "<?xml version=\"1.0\"?>"
                + "<page-sequence>\n"
                + "  <page scheme=\"https\" path=\"/ws/eBayISAPI.dll\" query=\"RegisterEnterInfo\" port=\"443\" user-agent=\"Mozilla/4.0 (compatible; MSIE 5.5; Windows NT 5.0)\" successMatch=\"ebaystatic.com/\" virtual-host=\"scgi.ebay.com\" disable-ssl-verification=\"true\"/>\n"
                + "</page-sequence>\n");
    ...
    @Test
    @JUnitHttpServer(port = 10342, webapps =
            @Webapp(context = "/opennms", path = "src/test/resources/loginTestWar"))
