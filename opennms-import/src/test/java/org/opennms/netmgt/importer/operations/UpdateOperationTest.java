...
public class UpdateOperationTest extends TestCase {
	 ...
	 */
	public final void testScanForSnmpDataNoNonIpIfs() throws MarshalException, ValidationException, IOException {
		...
		AbstractSaveOrUpdateOperation op = new UpdateOperation(new Integer(1), "imported:", "1", "node1", "theoffice", "pittsboro", false, "N");		
