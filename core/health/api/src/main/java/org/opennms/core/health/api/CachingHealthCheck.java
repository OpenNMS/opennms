...
/**
 * A health check that caches responses and can be informed about healthiness from the outside.
 */
public interface CachingHealthCheck extends HealthCheck {

    /**
     * Sets the cached response for {@link HealthCheck#perform(Context)} calls.
     * <p>
     * A {@code CachingHealthCheck} saves the current time as the timestamp of the given response.
