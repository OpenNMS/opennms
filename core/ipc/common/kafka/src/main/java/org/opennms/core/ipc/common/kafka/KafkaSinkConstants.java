...
public interface KafkaSinkConstants {
    ...
    public static final int DEFAULT_MAX_BUFFER_SIZE = 921600;

    // Configurable messageId cache config to specify number of messages and time to expire.
    public static final String MESSAGEID_CACHE_CONFIG = "messageId.cache.config";
    // Default to 1000 messages (large) in 10 minute interval.
    public static final String DEFAULT_MESSAGEID_CONFIG = "maximumSize=1000,expireAfterWrite=10m";
}
