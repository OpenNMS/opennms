...
public class CamelMessageConsumerManager extends AbstractMessageConsumerManager {
    ...
    @Override
    public synchronized void startConsumingForModule(SinkModule<?, Message> module) throws Exception {
    ...
    @Override
    public synchronized void stopConsumingForModule(SinkModule<?, Message> module) throws Exception {
        if (routeIdsByModule.containsKey(module)) {
