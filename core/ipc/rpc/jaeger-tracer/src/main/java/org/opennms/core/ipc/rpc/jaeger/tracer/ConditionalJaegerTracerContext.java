...
package org.opennms.core.ipc.rpc.jaeger.tracer;
...
@ImportResource("/META-INF/opennms/applicationContext-rpc-jaeger-tracer.xml")
public class ConditionalJaegerTracerContext {

    public static final String RPC_TRACER = "org.opennms.core.ipc.rpc.tracer";
    ...
    static class Condition implements ConfigurationCondition {
        ...
        public boolean matches(ConditionContext context, AnnotatedTypeMetadata metadata) {
            String tracerProperty = System.getProperty(RPC_TRACER, GLOBAL_TRACER);
