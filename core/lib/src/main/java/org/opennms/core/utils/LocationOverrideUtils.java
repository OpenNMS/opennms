...
/**
 * Used to optionally override the default location.
 *
 * @author jwhite
 */
public class LocationOverrideUtils {

    public static String LOCATION_OVERRIDE_KEY = "org.opennms.location.override";
