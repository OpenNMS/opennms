...
/**
 * In-process MessageDispatcherFactory for standalone daemon containers.
 *
 * Dispatched messages are delivered directly to the {@link LocalMessageConsumerManager}
...
public class LocalMessageDispatcherFactory extends AbstractMessageDispatcherFactory<Void>
    ...
    public LocalMessageDispatcherFactory(LocalMessageConsumerManager consumerManager) {
