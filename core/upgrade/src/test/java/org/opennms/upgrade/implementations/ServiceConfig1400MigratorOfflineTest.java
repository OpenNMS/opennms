...
/**
 * The Test Class for ServiceConfig1400MigratorOffline.
 * 
 * @author Alejandro Galue <agalue@opennms.org>
 */
public class ServiceConfig1400MigratorOfflineTest {
    ...
    public void testFixingConfig() throws Exception {
        ServiceConfig1400MigratorOffline migrator = new ServiceConfig1400MigratorOffline();
        migrator.execute();
