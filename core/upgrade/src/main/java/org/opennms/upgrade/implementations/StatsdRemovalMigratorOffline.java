 ...
 * its service-configuration.xml entry goes away and the statsd and trend
 * configuration files move to etc_archive.
 */
public class StatsdRemovalMigratorOffline extends AbstractOnmsUpgrade {
    ...
    static final List<String> RETIRED_FILES = List.of("statsd-configuration.xml", "trend-configuration.xml");
    ...
    public String getDescription() {
        return "Removes the retired Statsd daemon from service-configuration.xml and archives its configuration files: NMS-20313";
    }
