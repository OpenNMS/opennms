...
/**
 * Migrates all foreign sources into the database.
 *
 * @author mvrueden
 */
public class ForeignSourceLocationsMigrator extends AbstractOnmsUpgrade {
     ...
     */
    public ForeignSourceLocationsMigrator() throws OnmsUpgradeException {
//        try {
