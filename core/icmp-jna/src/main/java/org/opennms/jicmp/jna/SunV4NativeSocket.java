...
public class SunV4NativeSocket extends SunNativeSocket {
    ...
    public SunV4NativeSocket(final int family, final int type, final int protocol, final int listenPort) throws Exception {
