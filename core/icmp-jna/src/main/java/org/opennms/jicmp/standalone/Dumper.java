...
public class Dumper {
    ...
    public void dump() throws Exception {
        NativeDatagramSocket m_pingSocket =  NativeDatagramSocket.create(NativeDatagramSocket.PF_INET6, AbstractPinger.getSocketType(), NativeDatagramSocket.IPPROTO_ICMPV6, 1234);
