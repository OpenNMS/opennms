...
public class UnixV6NativeSocket extends UnixNativeSocket {
    ...
    public UnixV6NativeSocket(final int family, final int type, final int protocol, final int listenPort) throws Exception {
