...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (82, 14, 'uei.opennms.org/internal/topology/linkDown', 'OpenNMS-defined topology event: linkDown', '<p>node: %nodeid% with ifindex: %ifindex% is down </p>', true, '<event xmlns=""http://xmlns.opennms.org/xsd/eventconf"">
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (54, 12, 'uei.opennms.org/internal/translator/hypericAlert', 'OpenNMS-defined event: An event received from Hyperic has been translated', 'This is a translated Hyperic Alert to associate with OpenNMS entity..<p>

            <p>Alert reason: %parm[action.shortReason]% </p>
            <p>Alert reason: %parm[action.longReason]% </p>
            <p><a href=""%parm[resource.url]%"" > %parm[resource.name]% </a></p>', true, '<event xmlns=""http://xmlns.opennms.org/xsd/eventconf"">
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (55, 13, 'uei.opennms.org/internal/interfaceManaged', 'OpenNMS-defined internal event: interfaceManaged', '<p>The interface %interface% is being
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (56, 13, 'uei.opennms.org/internal/interfaceUnmanaged', 'OpenNMS-defined internal event: interfaceUnmanaged', '<p>The interface %interface% is being forcibly
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (57, 13, 'uei.opennms.org/internal/notificationWithoutUsers', 'OpenNMS-defined internal event: notificationWithoutUsers', '<p>A destination path in a notification has not been
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (58, 13, 'uei.opennms.org/internal/notificationsTurnedOff', 'OpenNMS-defined internal event: notificationsTurnedOff', '<p>Notifications have been disabled.</p>
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (59, 13, 'uei.opennms.org/internal/notificationsTurnedOn', 'OpenNMS-defined internal event: notificationsTurnedOn', '<p>Notifications have been enabled.</p>
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (61, 13, 'uei.opennms.org/internal/rtc/subscribe', 'OpenNMS-defined internal event: rtc subscribe', '<p>This event is generated to RTC by any process that
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (62, 13, 'uei.opennms.org/internal/rtc/unsubscribe', 'OpenNMS-defined internal event: rtc unsubscribe', '<p>This event is generated to RTC by any subscribed
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (63, 13, 'uei.opennms.org/internal/serviceManaged', 'OpenNMS-defined internal event: serviceManaged', '<p>The service %service% on interface %interface% is
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (64, 13, 'uei.opennms.org/internal/schedOutagesChanged', 'OpenNMS-defined internal event: scehduled outage configuration changed', 'This event is sent by the WebUI or the user when scheduled outage configuration has changed and should be
            reloaded', true, '<event xmlns=""http://xmlns.opennms.org/xsd/eventconf"">
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (65, 13, 'uei.opennms.org/internal/promoteQueueData', 'OpenNMS-defined event: A request has been made promote data from the RRD Queue', 'This event is generated to invoke the promotion data of the Queueing RRD Strategy.', true, '<event xmlns=""http://xmlns.opennms.org/xsd/eventconf"">
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (68, 13, 'uei.opennms.org/internal/authentication/loggedOut', 'OpenNMS-defined internal event: a user logged out of the web UI', 'This event is sent by the WebUI when a user logs out of the WebUI.', true, '<event xmlns=""http://xmlns.opennms.org/xsd/eventconf"">
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (69, 13, 'uei.opennms.org/internal/authentication/sessionRemoved', 'OpenNMS-defined internal event: a user''s session was removed from the WebUI', 'This event is sent by the WebUI when a user''s session is removed for any
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (70, 13, 'uei.opennms.org/internal/kscReportUpdated', 'OpenNMS-defined internal event: KSC report updated', '<p>The KSC Report ''%parm[reportTitle]%'' has been updated (remaining graphs: %parm[graphCount]%).</p>
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (71, 13, 'uei.opennms.org/services/passiveServiceStatus', 'OpenNMS-defined service event: passiveServiceStatus', '<p>Status information for service %parm[passiveServiceName]% has been updated. <br/>
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (73, 13, 'uei.opennms.org/internal/monitoringSystemAdded', 'Monitoring system Added', 'A new monitoring system has been added', true, '<event xmlns=""http://xmlns.opennms.org/xsd/eventconf"">
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (74, 13, 'uei.opennms.org/internal/monitoringSystemLocationChanged', 'Monitoring system Location Changed', 'Monitoring system location changed', true, '<event xmlns=""http://xmlns.opennms.org/xsd/eventconf"">
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (75, 13, 'uei.opennms.org/internal/monitoringSystemDeleted', 'Monitoring system Deleted', 'Monitoring system Deleted', true, '<event xmlns=""http://xmlns.opennms.org/xsd/eventconf"">
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (77, 13, 'uei.opennms.org/translator/telemetry/clockSkewDetected', 'Clock Skew detected', 'Clock skew (%parm[delta]% ms) detected for flow exporter (maxClockSkew = %parm[maxClockSkew]% secs)', true, '<event xmlns=""http://xmlns.opennms.org/xsd/eventconf"">
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (78, 13, 'uei.opennms.org/internal/applicationDeleted', 'OpenNMS-defined application event: applicationDeleted', 'Application ''%parm[applicationName]%'' with ID ''%parm[applicationId]%'' has been deleted.', true, '<event xmlns=""http://xmlns.opennms.org/xsd/eventconf"">
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (79, 13, 'uei.opennms.org/internal/applicationChanged', 'OpenNMS-defined node event: applicationChanged', 'The application ''%parm[applicationName]%'' with ID ''%parm[applicationId]%'' has been changed.', true, '<event xmlns=""http://xmlns.opennms.org/xsd/eventconf"">
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (80, 13, 'uei.opennms.org/internal/applicationCreated', 'OpenNMS-defined node event: applicationCreated', 'The application ''%parm[applicationName]%'' with ID ''%parm[applicationId]%'' has been created.', true, '<event xmlns=""http://xmlns.opennms.org/xsd/eventconf"">
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (81, 13, 'uei.opennms.org/internal/telemetry/illegalFlowDetected', 'Illegal flow detected', 'A flow was dropped due to the following reason: ''%parm[cause]%''', true, '<event xmlns=""http://xmlns.opennms.org/xsd/eventconf"">
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (84, 15, 'uei.opennms.org/traps/eventTrap', 'OPENNMS-MIB defined trap event: eventTrap', '<p>This is the definition of the generic OpenNMS trap sent from the
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (85, 15, 'uei.opennms.org/traps/tl1AutonomousMessageTrap', 'OPENNMS-MIB defined trap event: tl1AutonomousMessageTrap', '<p>This trap is used to convey the contents of a TL1 autonomous message
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (86, 15, 'uei.opennms.org/traps/alarmTrap', 'OPENNMS-MIB defined trap event: alarmTrap', '<p>The OpenNMS alarm SNMP Trap</p><table>
            <tr><td><b>
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (87, 15, 'uei.opennms.org/traps/heartbeatTrap', 'OPENNMS-MIB defined trap event: heartbeatTrap', '<p>Trap sent periodically by OpenNMS to keep alive external SNMP Manager</p><table></table>', true, '<event xmlns=""http://xmlns.opennms.org/xsd/eventconf"">
   <mask>
      <maskelement>
         <mename>id</mename>
         <mevalue>.1.3.6.1.4.1.5813.1</mevalue>
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (88, 15, 'uei.opennms.org/traps/startSyncTrap', 'OPENNMS-MIB defined trap event: startSyncTrap', '<p>OpenNMS Synchronization Process is starting</p><table></table>', true, '<event xmlns=""http://xmlns.opennms.org/xsd/eventconf"">
   <mask>
      <maskelement>
         <mename>id</mename>
         <mevalue>.1.3.6.1.4.1.5813.1</mevalue>
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (150, 22, 'uei.opennms.org/troubleTicket/update', 'OpenNMS-defined trouble ticket event: A request has been made to update a trouble ticket', 'This event is generated to invoke the asynchronous Trouble Ticket API in OpenNMS
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (89, 15, 'uei.opennms.org/traps/endSyncTrap', 'OPENNMS-MIB defined trap event: endSyncTrap', '<p>OpenNMS Synchronization Process is successfully ended</p><table></table>', true, '<event xmlns=""http://xmlns.opennms.org/xsd/eventconf"">
   <mask>
      <maskelement>
         <mename>id</mename>
         <mevalue>.1.3.6.1.4.1.5813.1</mevalue>
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (91, 16, 'uei.opennms.org/internal/poller/outageCreated', 'OpenNMS-defined node event: outageCreated', '<p>A %service% outage was created on interface
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (92, 16, 'uei.opennms.org/internal/poller/outageResolved', 'OpenNMS-defined node event: outageResolved', '<p>The %service% service outage on interface %interface%
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (93, 16, 'uei.opennms.org/internal/poller/suspendPollingService', 'OpenNMS-defined poller event: suspendPollingService', '<p>A forced rescan has identified the %service% service
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (94, 16, 'uei.opennms.org/internal/poller/resumePollingService', 'OpenNMS-defined poller event: resumePollingService', '<p>A forced rescan has identified the %service% service
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (95, 16, 'uei.opennms.org/nodes/serviceUnmanaged', 'OpenNMS-defined internal event: serviceUnmanaged', '<p>The service %service% on interface %interface% is
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (101, 16, 'uei.opennms.org/nodes/snmp/interfaceOperTesting', 'OpenNMS-defined node event: snmp interface Oper Status Testing', '<p>The operational status of interface is testing
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (96, 16, 'uei.opennms.org/nodes/deleteService', 'OpenNMS-defined node event: deleteService', '<p>Due to excessive downtime, the %service% service on
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (97, 16, 'uei.opennms.org/nodes/duplicateNodeDeleted', 'OpenNMS-defined node event: duplicateNodeDeleted', '<p>Node :%nodeid% labled: %nodelabel%; was determined to be a
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (98, 16, 'uei.opennms.org/nodes/interfaceDeleted', 'OpenNMS-defined node event: interfaceDeleted', '<p>Interface %interface% deleted from node #<a
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (99, 16, 'uei.opennms.org/nodes/interfaceDown', 'OpenNMS-defined node event: interfaceDown', '<p>All services are down on interface %interface%
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (100, 16, 'uei.opennms.org/nodes/snmp/interfaceOperDown', 'OpenNMS-defined node event: snmp interface Oper Status Down', '<p>The operational status of interface is down
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (114, 16, 'uei.opennms.org/nodes/nodeCategoryMembershipChanged', 'OpenNMS-defined node event: nodeCategoryMembershipChanged', '<p>Node (%parm[nodelabel]%) has changed its Category
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (102, 16, 'uei.opennms.org/nodes/snmp/interfaceOperUnknown', 'OpenNMS-defined node event: snmp interface Oper Status Unknown', '<p>The operational status of interface is unknown
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (103, 16, 'uei.opennms.org/nodes/snmp/interfaceOperDormant', 'OpenNMS-defined node event: snmp interface Oper Status Dormant', '<p>The operational status of interface is dormant
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (104, 16, 'uei.opennms.org/nodes/snmp/interfaceOperNotPresent', 'OpenNMS-defined node event: snmp interface Oper Status Not Present', '<p>The operational status of interface is not present
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (105, 16, 'uei.opennms.org/nodes/snmp/interfaceOperLowerLayerDown', 'OpenNMS-defined node event: snmp interface Oper Status Lower Layer Down', '<p>The operational status of interface is lower layer down
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (106, 16, 'uei.opennms.org/nodes/snmp/interfaceAdminDown', 'OpenNMS-defined node event: snmp interface Admin Status Down', '<p>The administration status of interface is down
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (107, 16, 'uei.opennms.org/nodes/interfaceReparented', 'OpenNMS-defined node event: interfaceReparented', '<p>Interface %interface% has been reparented under
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (108, 16, 'uei.opennms.org/nodes/interfaceUp', 'OpenNMS-defined node event: interfaceUp', '<p>The interface %interface% which was previously down
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (109, 16, 'uei.opennms.org/nodes/snmp/interfaceOperUp', 'OpenNMS-defined node event: snmp interface Oper Status Up', '<p>The operational status of interface is up
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (110, 16, 'uei.opennms.org/nodes/snmp/interfaceAdminUp', 'OpenNMS-defined node event: snmp interface Admin Status Up', '<p>The administration status of interface is down
            </p> <p>This event is generated when an snmp poll on interface find the administration status
            up.
            </p>
            <p>Params %parm[all]% </p>', true, '<event xmlns=""http://xmlns.opennms.org/xsd/eventconf"">
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (111, 16, 'uei.opennms.org/nodes/nodeAdded', 'OpenNMS-defined node event: nodeAdded', 'The node ""%parm[nodelabel]%"" was added and is now being monitored.', true, '<event xmlns=""http://xmlns.opennms.org/xsd/eventconf"">
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (112, 16, 'uei.opennms.org/nodes/nodeUpdated', 'OpenNMS-defined node event: nodeUpdated', '<p>A currently provisioned node (%parm[nodelabel]%) was updated by
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (113, 16, 'uei.opennms.org/nodes/nodeLocationChanged', 'OpenNMS-defined node event: nodeLocationChanged', '<p>A currently provisioned node (%parm[nodelabel]%) changed its
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (115, 16, 'uei.opennms.org/nodes/nodeDeleted', 'OpenNMS-defined node event: nodeDeleted', '<p>%parm[nodelabel]% (%parm[foreignSource]%:%parm[foreignId]%) in location %parm[location]% was deleted from requisition %parm[foreignSource]%.</p>
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (116, 16, 'uei.opennms.org/nodes/nodeDown', 'OpenNMS-defined node event: nodeDown', '<p>All interfaces on node %parm[nodelabel]% are
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (117, 16, 'uei.opennms.org/nodes/pathOutage', 'OpenNMS-defined node event: pathOutage', '<p>The state of node %parm[nodelabel]% is unknown
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (118, 16, 'uei.opennms.org/nodes/nodeGainedInterface', 'OpenNMS-defined node event: nodeGainedInterface', '<p>Interface %interface% has been associated with Node
            #<a
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (119, 16, 'uei.opennms.org/nodes/nodeGainedService', 'OpenNMS-defined node event: nodeGainedService', '<p>A service scan has identified the %service% service
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (120, 16, 'uei.opennms.org/nodes/nodeInfoChanged', 'OpenNMS-defined node event: nodeInfoChanged', '<p>Node information has changed for node
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (127, 16, 'uei.opennms.org/nodes/serviceResponsive', 'OpenNMS-defined node event: serviceResponsive', '<p>The %service% service which was previously unresponsive
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (121, 16, 'uei.opennms.org/nodes/nodeLabelChanged', 'OpenNMS-defined node event: nodeLabelChanged', '<p>Node #<a
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (122, 16, 'uei.opennms.org/nodes/nodeLostService', 'OpenNMS-defined node event: nodeLostService', '<p>A %service% outage was identified on interface
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (123, 16, 'uei.opennms.org/nodes/nodeRegainedService', 'OpenNMS-defined node event: nodeRegainedService', '<p>The %service% service on interface %interface% was
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (124, 16, 'uei.opennms.org/nodes/nodeUp', 'OpenNMS-defined node event: nodeUp', '<p>Node %parm[nodelabel]% which was previously down is
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (125, 16, 'uei.opennms.org/nodes/primarySnmpInterfaceChanged', 'OpenNMS-defined node event: primarySnmpInterfaceChanged', '<p>This event indicates that the interface selected
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (126, 16, 'uei.opennms.org/nodes/reinitializePrimarySnmpInterface', 'OpenNMS-defined node event: reinitializePrimarySnmpInterface', '<p>A change in configuration on this node has been
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (128, 16, 'uei.opennms.org/nodes/serviceDeleted', 'OpenNMS-defined node event: serviceDeleted', '<p>Service %service% was deleted from interface
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (129, 16, 'uei.opennms.org/nodes/serviceUnresponsive', 'OpenNMS-defined node event: serviceUnresponsive', '<p>The %service% service is up but was unresponsive
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (130, 16, 'uei.opennms.org/nodes/assetInfoChanged', 'OpenNMS-defined node event: assetInfoChanged', '<p>The Asset info for node %nodeid% (%nodelabel%)
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (131, 16, 'uei.opennms.org/deviceconfig/configBackupStarted', 'OpenNMS-defined node event: configBackupStarted', '<p>Config backup started on %service%
            during the last poll on interface %interface%.</p>', true, '<event xmlns=""http://xmlns.opennms.org/xsd/eventconf"">
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (132, 16, 'uei.opennms.org/deviceconfig/configBackupFailed', 'OpenNMS-defined node event: configBackupFailed', '<p>Failed to backup config associated with %service%
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (133, 16, 'uei.opennms.org/deviceconfig/configBackupSucceeded', 'OpenNMS-defined node event: configBackupSucceeded', '<p>Config backup succeeded on %service%
            during the last poll on interface %interface%.</p>', true, '<event xmlns=""http://xmlns.opennms.org/xsd/eventconf"">
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (134, 17, 'uei.opennms.org/provisioner/provisioningAdapterFailed', 'OpenNMS-defined Provisioning Adapter Failed message', 'A provisioning adapter failed for host %host% with the following condition: %parm[reason]%.<p>', true, '<event xmlns=""http://xmlns.opennms.org/xsd/eventconf"">
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (135, 17, 'uei.opennms.org/internal/provisiond/scheduledNodeScanStarted', 'OpenNMS-defined Provisiond Event: scheduledNodeScanStarted', 'A message from the Provisiond NodeScan lifecycle that a scheduled NodeScan has started:
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (136, 17, 'uei.opennms.org/internal/provisiond/nodeScanCompleted', 'OpenNMS-defined Provisiond Event: nodeScanCompleted', 'A message from the Provisiond NodeScan lifecycle that a NodeScan has completed:
            <p>The Node with Id: %nodeid%; ForeignSource: %parm[foreignSource]%; ForeignId:%parm[foreignId]% has
            completed.</p>
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (137, 17, 'uei.opennms.org/internal/provisiond/nodeScanAborted', 'OpenNMS-defined Provisiond Event: nodeScanAborted', 'A message from the Provisiond NodeScan lifecycle that a NodeScan has Aborted:
            <p>The Node with Id: %nodeid%; ForeignSource: %parm[foreignSource]%; ForeignId:%parm[foreignId]% has
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (138, 17, 'uei.opennms.org/internal/importer/reloadImport', 'OpenNMS-defined internal event: importer reloadImport', '<p>This event will cause the importer to run the model-import process.
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (140, 17, 'uei.opennms.org/internal/importer/importSuccessful', 'OpenNMS-defined internal event: importer process successfully completed', '<p>This event indicates the model-importer process has completed successfully. There
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (141, 17, 'uei.opennms.org/internal/importer/importFailed', 'OpenNMS-defined internal event: importer process failed.', '<p>This event indicates the model-importer process has failed. There is 1 parameter
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (143, 18, 'uei.opennms.org/circuitBreaker/stateChange', 'OpenNMS-defined event: Circuit breaker has changed state', 'A cirtcuit breaker named %parm[name]% on %dpname% has changed state from %parm[fromState]% to %parm[toState]%.', true, '<event xmlns=""http://xmlns.opennms.org/xsd/eventconf"">
   <mask>
      <maskelement>
         <mename>parm[toState]</mename>
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (144, 19, 'uei.opennms.org/perspective/nodes/nodeLostService', 'OpenNMS-defined perspective poller event: A perspective poller detected a node lost service', '<p>A %service% outage was identified on interface %interface% from location: %parm[perspective]%.</p>', true, '<event xmlns=""http://xmlns.opennms.org/xsd/eventconf"">
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (146, 20, 'uei.opennms.org/reportd/reportRunFailed', 'OpenNMS-defined Reportd Event: reportRunFailed', 'A message from the Reportd reporting service that a report has failed to run:
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (147, 20, 'uei.opennms.org/reportd/reportDeliveryFailed', 'OpenNMS-defined Reportd Event: reportDeliveryFailed', 'A message from the Reportd delivery service that a report could not be delivered:
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (148, 21, 'DISCARD-MATCHING-MESSAGES', 'OpenNMS-defined DISCARD-MATCHING-MESSAGES', 'DISCARD-MATCHING-MESSAGES is used in the syslogd to generate events that
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (152, 22, 'uei.opennms.org/troubleTicket/cancel', 'OpenNMS-defined trouble ticket event: A request has been made to cancel a trouble ticket', 'This event is generated to invoke the asynchronous Trouble Ticket API in OpenNMS
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (153, 22, 'uei.opennms.org/troubleTicket/communicationError', 'OpenNMS-defined trouble ticket event: A communication error occurred', 'This event is generated when OpenNMS is unable to retrive, save or update a ticket
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (154, 23, 'uei.opennms.org/api/tl1d/message/autonomous', 'OpenNMS-defined Autonomous TL1 message', 'This is a TL1 autonomous message delivered for host: %host%.<p>
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (155, 24, 'MATCH-ANY-UEI', 'OpenNMS-defined event: MATCH-ANY-UEI', '<p>This UEI will never be generated, but exists
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (156, 24, 'uei.opennms.org/default/trap', 'OpenNMS-defined default event: trap', '<p>An SNMP Trap (%snmp%) with no matching configuration was received from interface %interface%.</p>
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (157, 24, 'uei.opennms.org/default/event', 'OpenNMS-defined default event: event', '<p>An event with no matching configuration was received from interface %interface%. This event
...
INSERT INTO eventconf_events(id, source_id, uei, event_label, description, enabled, xml_content, created_time, last_modified, modified_by) VALUES (158, 24, 'uei.opennms.org/generic/traps/EnterpriseDefault', 'OpenNMS-defined trap event: EnterpriseDefault', '<p>This is the default event format used when an enterprise specific event (trap) is received for
...
ALTER SEQUENCE eventconf_events_id_seq RESTART WITH 159;
