...
/**
 * Represents a writable AbstractCastorConfigDao
 *
 * @author brozow
 * @author djgregor
 */
public abstract class AbstractWritableCastorConfigDao<K, V> extends AbstractCastorConfigDao<K, V> {
    ...
    public AbstractWritableCastorConfigDao(final Class<K> entityClass, final String description) {
