...
/**
 * Filter for adding the defined namespace to all elements of a xml document. We
 * have many xmls without namespace but want to validation all of them against
 * said namespace.
 */
public class SimpleNamespaceFilter extends XMLFilterImpl {
	...
	public void startElement(final String uri, final String localName, final String qName, final Attributes attributes) throws SAXException {
		if (m_addNamespace) {
			if (LogUtils.isTraceEnabled(this))
				LogUtils.tracef(this, "start: uri = %s, new uri = %s, localName = %s, qName = %s, attributes = %s", uri, m_namespaceUri, localName, qName, attributes);
			...
			if (LogUtils.isTraceEnabled(this))
				LogUtils.tracef(this, "start: uri = %s, new uri = %s, localName = %s, qName = %s, attributes = %s", uri, uri, localName, qName, attributes);
	...
	public void endElement(final String uri, final String localName, final String qName) throws SAXException {
		if (m_addNamespace) {
			if (LogUtils.isTraceEnabled(this))
				LogUtils.tracef(this, "end:   uri = %s, new uri = %s, localName = %s, qName = %s", uri, m_namespaceUri, localName, qName);
			super.endElement(m_namespaceUri, localName, qName);
		} else {
			if (LogUtils.isTraceEnabled(this))
				LogUtils.tracef(this, "end:   uri = %s, new uri = %s, localName = %s, qName = %s", uri, uri, localName, qName);
	...
	public void startPrefixMapping(final String prefix, final String url) throws SAXException {
		if (LogUtils.isTraceEnabled(this))
			LogUtils.tracef(this, "startPrefixMapping: prefix = %s, url = %s", prefix, url);
		if (m_addNamespace) {
