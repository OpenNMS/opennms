...
public interface SnmpStrategy {
    ...
    void registerForTraps(TrapNotificationListener listener, TrapProcessorFactory processorFactory, int snmpTrapPort, List<SnmpV3User> snmpv3Users) throws IOException;
