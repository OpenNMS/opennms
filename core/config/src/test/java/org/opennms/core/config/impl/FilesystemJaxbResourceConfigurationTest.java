...
public class FilesystemJaxbResourceConfigurationTest {
    ...
    public void testFileSystemResourceExists() throws ConfigurationResourceException, IOException {
        ...
        final ConfigurationResource<CollectdConfiguration> collectd = new FilesystemJaxbResourceConfiguration<CollectdConfiguration>(CollectdConfiguration.class, configFile.toPath());
