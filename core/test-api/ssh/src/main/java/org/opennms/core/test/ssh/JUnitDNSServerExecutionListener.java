...
import org.opennms.core.test.ssh.annotations.DNSEntry;
import org.opennms.core.test.ssh.annotations.DNSZone;
...
/**
 * This {@link TestExecutionListener} looks for the {@link JUnitSSHServer} annotation
...
public class JUnitDNSServerExecutionListener extends OpenNMSAbstractTestExecutionListener {
    ...
    public void beforeTestMethod(final TestContext testContext) throws Exception {
        ...
        final JUnitSSHServer config = findTestAnnotation(JUnitSSHServer.class, testContext);
