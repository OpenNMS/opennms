...
/**
 * TODO why is this part of the main code base?
 * <p>
 * CorrelationExample class.</p>
 *
...
public abstract class CorrelationExample {
    ...
    public static class Simulation {
        ...
        public static class SimItem {
            ...
            public void simulate(final KieSession kieSession) {
                sleep(m_delay);
                System.out.println("Start simulation of " + this);
                kieSession.insert(m_event);
        ...
        final Map<Integer, Node> m_nodes = new HashMap<>();
        ...
        public void simulate(final KieSession kieSession) {
            for (final SimItem item : m_eventSequence) {
                item.simulate(kieSession);
                System.out.println("Memory Size = " + kieSession.getFactCount());
            }
        }
    }
